...
- Good understanding of Janssen Server installation process in general is a prerequisite. Here we are just highlighting steps without a lot of details. Visit [installation](https://docs.jans.io/head/janssen-server/install/index.md) documentation for complete understanding.
