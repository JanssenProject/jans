...
|                              | **[Unsigned flow](https://docs.jans.io/head/cedarling/integrations/terraform-authz/index.md)** | **[JWT flow](https://docs.jans.io/head/cedarling/integrations/terraform-authz-jwt/index.md)**  |
| ---------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
...
- The **[Cedarling-OPA plugin](https://docs.jans.io/head/cedarling/integrations/cedarling-opa/index.md)** — a custom OPA plugin that embeds Cedarling as a built-in function.
...
- **[Unsigned Terraform authorization guide](https://docs.jans.io/head/cedarling/integrations/terraform-authz/index.md)** — role-based access control for human operators using `authorize_unsigned`.
- **[JWT Terraform authorization guide](https://docs.jans.io/head/cedarling/integrations/terraform-authz-jwt/index.md)** — cryptographic identity for CI/CD pipelines using `authorize_multi_issuer` with GitHub Actions OIDC tokens.
