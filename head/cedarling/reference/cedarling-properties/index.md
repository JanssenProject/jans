...
For native platforms, the Cedarling now supports a directory-based policy store format with human-readable Cedar files. See [Policy Store Formats](https://docs.jans.io/head/cedarling/reference/cedarling-policy-store/#policy-store-formats) for details.
