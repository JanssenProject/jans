...
Go bindings support all native policy store source types. See [Cedarling Properties](https://docs.jans.io/head/cedarling/reference/cedarling-properties/index.md) for the full list of configuration options.
...
- [Multi-Issuer Authorization Details](https://docs.jans.io/head/cedarling/reference/cedarling-authz/index.md)
