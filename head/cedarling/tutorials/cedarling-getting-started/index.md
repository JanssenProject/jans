...
Cedarling provides two authorization methods. Not sure which to use? See the [quick start decision guide](https://docs.jans.io/head/cedarling/reference/cedarling-authz/#which-authorization-method-should-i-use).
