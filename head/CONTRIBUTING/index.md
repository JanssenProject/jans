...
Janssen project has a [Code of Conduct](https://docs.jans.io/head/CODE_OF_CONDUCT/index.md) to which all contributors must adhere, please read it before interacting with the repository or the community in any way.
...
Here is how we [continously triage](https://docs.jans.io/head/governance/triage/index.md) new issues and PRs so that contributors can contribute faster and better.
...
The current version of CLA can be found [here](https://docs.jans.io/head/governance/cla/index.md). This is just for your reference. This same CLA will be signed digitally by following the steps below:
...
We often need to reference release numbers in the documentation. For example, [Ubuntu package installation guide](https://docs.jans.io/head/janssen-server/install/vm-install/ubuntu/index.md). In this guide, the following command is documented:
