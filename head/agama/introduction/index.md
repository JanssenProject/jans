...
Find the complete Agama DSL reference [here](https://docs.jans.io/head/agama/language-reference/index.md).
...
More information on execution rules can be found [here](https://docs.jans.io/head/agama/execution-rules/index.md).

## `.gama` file format

Check [this](https://docs.jans.io/head/agama/gama-format/index.md) page for more information.
