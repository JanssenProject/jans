...
| `description`    |                                                                                                                                                                                                                                                 | *string*      |
| `configs`        | Object containing exemplifying [configuration properties](https://docs.jans.io/head/agama/language-reference/#header-basics) for flows that may need them. The keys of this field, if any, are qualified flow names already part of the project | *json object* |
