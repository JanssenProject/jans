...
- [Super Gluu interception script](https://docs.jans.io/head/script-catalog/person_authentication/super-gluu-external-authenticator/SuperGluuExternalAuthenticator.py) is included in the default Janssen Server distribution
...
See the [SCIM documentation](https://docs.jans.io/head/janssen-server/usermgmt/usermgmt-scim/#fido-2-devices) on how to manage Super Gluu devices, using the SCIM [protocol].
