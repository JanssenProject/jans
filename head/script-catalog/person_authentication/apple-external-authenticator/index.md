...
- The [Sign-in with Apple authentication script](https://docs.jans.io/head/script-catalog/person_authentication/apple-external-authenticator/AppleExternalAuthenticator.py) (included in the default Jans-auth Server distribution);
