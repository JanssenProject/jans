...
To install WWPass support in Gluu server refer to [INSTALLATION.md](https://docs.jans.io/head/script-catalog/person_authentication/other/wwpass/INSTALLATION/index.md).
