...
1. Use a different URL for each IDP, like `https://customer1.saas.com` or `https://saas.com/customer2`. Based on which URL the person hits, you know where to send them.
1. Prompt the person to enter something identifying, like their email address. You can use this to look up their home IDP.
1. Use contextual information, like network address, geolocation, or browser data.
