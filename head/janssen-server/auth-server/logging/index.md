...
Use [log levels](https://docs.jans.io/head/janssen-server/auth-server/logging/log-levels/index.md) to control noise of logs in [standard logs](https://docs.jans.io/head/janssen-server/auth-server/logging/standard-logs/index.md).

Following AS configuration properties can be used to customize AS logging:

- `loggingLevel` - Specify the [log levels](https://docs.jans.io/head/janssen-server/auth-server/logging/log-levels/index.md) of loggers
...
AS has pre-defined set of [standard logs](https://docs.jans.io/head/janssen-server/auth-server/logging/standard-logs/index.md) which can be overwritten by own [log4j2 xml](https://docs.jans.io/head/janssen-server/auth-server/logging/custom-logs/index.md).
...
AS support [audit logs](https://docs.jans.io/head/janssen-server/auth-server/logging/audit-logs/index.md).
