...
1. `jans-auth_script.log`: - contains [custom interception scripts](https://docs.jans.io/head/janssen-server/developer/scripts/index.md) related log messages. Use `scriptLogger` inside custom script to log messages to this log file.
