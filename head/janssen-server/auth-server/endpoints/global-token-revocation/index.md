...
The URL for the Global Token Revocation endpoint is specified in the Janssen Server's well-known [configuration endpoint](https://docs.jans.io/head/janssen-server/auth-server/endpoints/configuration/index.md) response:
...
For more details, see [End Session](https://docs.jans.io/head/janssen-server/auth-server/endpoints/end-session/index.md).
