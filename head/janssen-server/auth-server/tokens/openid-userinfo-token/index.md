...
If you need to call an API to render scopes or scope values on the fly, you should see the [Dynamic Scopes](https://docs.jans.io/head/script-catalog/dynamic_scope/dynamic-scope/index.md) interception script.
