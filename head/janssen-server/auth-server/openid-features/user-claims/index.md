...
Refer to [claims configuration document](https://docs.jans.io/head/janssen-server/config-guide/auth-server-config/attribute-configuration/index.md) for more details on custom claims configuration.
