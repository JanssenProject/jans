...
- [MySQL](https://docs.jans.io/head/janssen-server/reference/database/mysql-config/index.md)
- [PostgreSQL](https://docs.jans.io/head/janssen-server/reference/database/pgsql-config/index.md)
- [Hybrid](https://docs.jans.io/head/janssen-server/reference/database/pgsql-config/index.md). This is virtual DB layer which allows to combine few DB types based on record type.
