...
An administrator can enable or disable feature flags using [TUI](https://docs.jans.io/head/janssen-server/config-guide/config-tools/jans-tui/index.md). New value of the feature flag will be dynamically loaded at an interval of 30 seconds.

### Updating Feature Flags Using TUI

1. Open TUI as instructed [here](https://docs.jans.io/head/janssen-server/config-guide/config-tools/jans-tui/index.md)
