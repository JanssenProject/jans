...
- [Fido2 Extension — script catalog reference](https://docs.jans.io/head/script-catalog/fido2_extension/fido2-extension/index.md) — full interface, objects, and Java sample
- [Passkeys Implementation Guide](https://docs.jans.io/head/janssen-server/recipes/passkey-impl-guide/index.md) — the end-to-end passkey deployment
- [Custom Scripts overview](https://docs.jans.io/head/janssen-server/developer/scripts/index.md) — how Jans custom scripts work
