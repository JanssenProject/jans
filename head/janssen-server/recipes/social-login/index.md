...
1. Facebook
1. [Google](https://docs.jans.io/head/script-catalog/person_authentication/google-external-authenticator/index.md)
1. [Apple](https://docs.jans.io/head/script-catalog/person_authentication/apple-external-authenticator/index.md)
