...
As mentioned in the overview we recommend using the same Kubernetes cluster as planned in production. More guides to install on different clouds can be found [here](https://docs.jans.io/head/janssen-server/install/helm-install/index.md).
...
1. Download or build [config-cli-tui](https://docs.jans.io/head/janssen-server/config-guide/config-tools/jans-tui/index.md) and run:
