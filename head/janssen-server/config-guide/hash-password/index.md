...
Support additional hashing methods can be added with [Persistence Extension](https://docs.jans.io/head/script-catalog/persistence_extension/persistence/#persistence-script) script.
