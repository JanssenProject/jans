...
Application log can be verified if application is started properly. [Refer here](https://docs.jans.io/head/janssen-server/config-guide/config-tools/config-api/logs/index.md) for more details.
