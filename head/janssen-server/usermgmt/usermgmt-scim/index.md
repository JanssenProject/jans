...
You can refer to [here](https://docs.jans.io/head/janssen-server/config-guide/scim-config/user-config/#get-scim-client) for this topic

### Get Access token

You can refer to [here](https://docs.jans.io/head/janssen-server/config-guide/scim-config/user-config/#get-access-token) for this topic

### Retrieve existing User

You can refer to [here](https://docs.jans.io/head/janssen-server/config-guide/scim-config/user-config/#retrieve-existing-user) for this topic

## Creating Resource

### Create a User

You can refer to [here](https://docs.jans.io/head/janssen-server/config-guide/scim-config/user-config/#create-an-user) for this topic

### Updating a User(PUT)

You can refer to [here](https://docs.jans.io/head/janssen-server/config-guide/scim-config/user-config/#updating-a-userput) for this topic

### Updating a User (PATCH)

You can refer to [here](https://docs.jans.io/head/janssen-server/config-guide/scim-config/user-config/#updating-a-user-patch) for this topic

### Deleting Users

You can refer to [here](https://docs.jans.io/head/janssen-server/config-guide/scim-config/user-config/#deleting-users) for this topic

## How is SCIM data stored?

You can refer to [here](https://docs.jans.io/head/janssen-server/scim/monitoring/#how-is-scim-data-stored) for this topic

## FIDO Devices

You can refer to [here](https://docs.jans.io/head/janssen-server/scim/monitoring/#fido-devices) for this topic.

## FIDO2 devices

You can refer to [here](https://docs.jans.io/head/janssen-server/scim/monitoring/#fido2-devices) for this topic.
