...
- Agama [DSL](https://docs.jans.io/head/agama/introduction/#dsl) and `.gama` [format](https://docs.jans.io/head/agama/gama-format/index.md)
- Agama projects [deployment](https://docs.jans.io/head/janssen-server/config-guide/auth-server-config/agama-project-configuration/index.md) in the Janssen Server
- [Execution rules](https://docs.jans.io/head/agama/execution-rules/index.md) in the Jans Agama [engine](https://docs.jans.io/head/janssen-server/developer/agama/jans-agama-engine/index.md)
...
The [RRF](https://docs.jans.io/head/agama/language-reference/#rrf) (render-reply-fetch) Agama instruction is of paramount importance in flows. In a regular web setting, it involves three steps:
...
In this section, we stick to the terminology found [here](https://docs.jans.io/head/agama/execution-rules/#flows-lifecycle).
...
If the initial request references a non-existent flow or one that has been flagged as [not launchable directly](https://docs.jans.io/head/agama/gama-format/#metadata) by clients.
