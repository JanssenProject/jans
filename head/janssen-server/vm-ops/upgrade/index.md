...
1. [Install](https://docs.jans.io/head/janssen-server/install/vm-install/index.md) on a separate VM the target new Jans installation, i.e. `vreplace-janssen-version`.
...
1. Use our Terraform [docs](https://docs.jans.io/head/janssen-server/terraform/index.md) on the new installation, i.e. `vreplace-janssen-version` to:
