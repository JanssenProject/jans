...
Regardless of the customization required, it is desirable to get acquaintance with Agama [framework](https://docs.jans.io/head/agama/introduction/index.md). This is a good time to go through the Agama developer guide pages found in the Administration section of Jans Server docs. Specifically, several of the Agama [advanced usages](https://docs.jans.io/head/janssen-server/developer/agama/advanced-usages/#advanced-usages) will help you materialize your requirements.
...
In some cases, the original look-and-feel may be satisfying but it's the text content what you would like to change. Agama engine supports localization and internationalization as explained [here](https://docs.jans.io/head/janssen-server/developer/agama/advanced-usages/#localization-and-internationalization) so you can supply translated messages in your own project and make templates use those. Note Casa is only bundled with a set of "default" labels out-of-the box and thus pages don't change content regardless of browser's language or location. By overriding templates and providing labels in several languages, you can achieve full localization/internationalization in the authentication UI.

### Support more authentication methods

This is probably the most common requirement. Visit this [page](https://docs.jans.io/head/casa/developer/add-authn-methods/index.md) to learn more.

### Other forms of customization

Most forms of customization can be tackled using flow cancellation. Through cancellation, a flow can be aborted while running and the control returned to one of its callers. Learn more about this topic [here](https://docs.jans.io/head/janssen-server/developer/agama/advanced-usages/#cancellation).
