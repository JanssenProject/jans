...
1. Apply changes as needed - this is covered in a separate doc page [here](https://docs.jans.io/head/casa/plugins/accts-linking/accts-linking-agama/index.md). Note you can add or remove sections in the file at will, and that providers can also be disabled so they are not listed in the login page or in Casa app
