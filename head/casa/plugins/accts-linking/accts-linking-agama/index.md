...
The tables shown in [this](https://docs.jans.io/head/agama-catalog/jans/inboundID/#supply-configurations) page list all possible properties to configure a provider. Particularly, two properties deserve the most detail:
...
An introduction to attribute mapping can be found [here](https://docs.jans.io/head/agama-catalog/jans/inboundID/#attribute-mappings). Unless an elaborated processing of attributes is required, a basic knowledge of Java language suffices to write a useful mapping.
