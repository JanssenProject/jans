...
- Display a login page as the above including the configured identity providers, if any, in case the [accounts linking](https://docs.jans.io/head/casa/plugins/accts-linking/account-linking-index/index.md) plugin is installed
...
Yes. There is a simple demonstrative [tutorial](https://docs.jans.io/head/casa/plugins/cert-authn-tutorial/index.md) available.
