...
You can tailor different aspects of 2FA behavior in Casa using the [plugin](https://docs.jans.io/head/casa/plugins/2fa-settings/index.md) developed for this purpose.
