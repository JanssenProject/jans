...
1. Wait for around 1 minute (so the server picks the script changes), then restart Casa and Apache services. Use this [page](https://docs.jans.io/head/janssen-server/vm-ops/restarting-services/index.md) as a guide
