...
We have a dedicated page covering the topic of custom branding [here](https://docs.jans.io/head/casa/administration/custom-branding/index.md).
...
If you have logged in using an administrative account and cannot find any admin features in the UI ensure you have gone through these [steps](https://docs.jans.io/head/casa/administration/quick-start/#finish-configuration).
...
In the administration console you can specify the minimum number of enrolled credentials needed to enable second factor authentication for users. Please check the [2FA Settings plugin](https://docs.jans.io/head/casa/plugins/2fa-settings/index.md) for more details.
