...
func (c *Client) GetAttributes(ctx context.Context) ([]Attribute, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/api/v1/attributes", token, scope, &resp, map[string]string{
                "limit": "5",
        }); err != nil {
...
func (c *Client) GetAttribute(ctx context.Context, inum string) (*Attribute, error) {
        ...
        err = c.get(ctx, "/jans-config-api/api/v1/attributes/"+inum, token, scope, ret)
...
func (c *Client) CreateAttribute(ctx context.Context, attr *Attribute) (*Attribute, error) {
        ...
        if err := c.post(ctx, "/jans-config-api/api/v1/attributes/", token, scope, attr, ret); err != nil {
...
func (c *Client) UpdateAttribute(ctx context.Context, attr *Attribute) (*Attribute, error) {
        ...
        if err := c.put(ctx, "/jans-config-api/api/v1/attributes/", token, scope, attr, ret); err != nil {
...
func (c *Client) DeleteAttribute(ctx context.Context, inum string) error {
        ...
        if err := c.delete(ctx, "/jans-config-api/api/v1/attributes/"+inum, token, scope); err != nil {
