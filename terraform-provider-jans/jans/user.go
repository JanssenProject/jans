...
func (c *Client) GetUsers(ctx context.Context) ([]User, error) {
        ...
        if err := c.get(ctx, "/jans-scim/restv1/v2/Users", token, scope, &ret); err != nil {
...
func (c *Client) GetUser(ctx context.Context, id string) (*User, error) {
        ...
        if err := c.get(ctx, "/jans-scim/restv1/v2/Users/"+id, token, scope, ret); err != nil {
                return nil, fmt.Errorf("get request failed: %w", err)
        }
...
func (c *Client) CreateUser(ctx context.Context, user *User) (*User, error) {
        ...
        if err := c.post(ctx, "/jans-scim/restv1/v2/Users", token, scope, user, ret); err != nil {
...
func (c *Client) UpdateUser(ctx context.Context, user *User) (*User, error) {
        ...
        if err := c.put(ctx, "/jans-scim/restv1/v2/Users/"+user.ID, token, scope, user, ret); err != nil {
...
func (c *Client) DeleteUser(ctx context.Context, id string) error {
        ...
        if err := c.delete(ctx, "/jans-scim/restv1/v2/Users/"+id, token, scope); err != nil {
