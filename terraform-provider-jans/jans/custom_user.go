...
func (c *Client) GetCustomUsers(ctx context.Context) ([]CustomUser, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/mgt/configuser", token, scope, &ret, map[string]string{
                "limit": "5",
        }); err != nil {
...
func (c *Client) GetCustomUser(ctx context.Context, inum string) (*CustomUser, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/mgt/configuser/"+inum, token, scope, ret); err != nil {
                return nil, fmt.Errorf("get request failed: %w", err)
        }
...
func (c *Client) CreateCustomUser(ctx context.Context, user *CustomUser) (*CustomUser, error) {
        ...
        if err := c.post(ctx, "/jans-config-api/mgt/configuser", token, scope, user, ret); err != nil {
...
func (c *Client) UpdateCustomUser(ctx context.Context, user *CustomUser) (*CustomUser, error) {
        ...
        if err := c.put(ctx, "/jans-config-api/mgt/configuser", token, scope, user, ret); err != nil {
...
func (c *Client) DeleteCustomUser(ctx context.Context, inum string) error {
        ...
        if err := c.delete(ctx, "/jans-config-api/mgt/configuser/"+inum, token, scope); err != nil {
