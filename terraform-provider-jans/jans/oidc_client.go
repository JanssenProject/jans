...
type OidcClient struct {
	...
	LastLogonTime                              string               `schema:"last_logon_time" json:"lastLogonTime,omitempty"`
...
func (c *Client) GetOidcClients(ctx context.Context) ([]OidcClient, error) {
	...
	if err := c.get(ctx, "/jans-config-api/api/v1/openid/clients", token, scope, &ret, map[string]string{
		"limit": "5",
	}); err != nil {
...
func (c *Client) GetOidcClient(ctx context.Context, inum string) (*OidcClient, error) {
	...
	if err := c.get(ctx, "/jans-config-api/api/v1/openid/clients/"+inum, token, scope, ret); err != nil {
		return nil, fmt.Errorf("get request failed: %w", err)
	}
...
func (c *Client) CreateOidcClient(ctx context.Context, client *OidcClient) (*OidcClient, error) {
	...
	if err := c.post(ctx, "/jans-config-api/api/v1/openid/clients", token, scope, client, ret); err != nil {
...
func (c *Client) UpdateOidcClient(ctx context.Context, client *OidcClient) (*OidcClient, error) {
	...
	if err := c.put(ctx, "/jans-config-api/api/v1/openid/clients", token, scope, client, ret); err != nil {
...
func (c *Client) DeleteOidcClient(ctx context.Context, inum string) error {
	...
	if err := c.delete(ctx, "/jans-config-api/api/v1/openid/clients/"+inum, token, scope); err != nil {
