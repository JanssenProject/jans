...
type AppConfiguration struct {
	...
	CimdSchemeAllowlist                                       []string                              `schema:"cimd_scheme_allowlist" json:"cimdSchemeAllowlist"`
	CimdDomainAllowlist                                       []string                              `schema:"cimd_domain_allowlist" json:"cimdDomainAllowlist"`
	CimdDomainBlocklist                                       []string                              `schema:"cimd_domain_blocklist" json:"cimdDomainBlocklist"`
	CimdBlockPrivateIp                                        bool                                  `schema:"cimd_block_private_ip" json:"cimdBlockPrivateIp"`
	CimdMaxResponseSize                                       int                                   `schema:"cimd_max_response_size" json:"cimdMaxResponseSize"`
	CimdConnectTimeoutMs                                      int                                   `schema:"cimd_connect_timeout_ms" json:"cimdConnectTimeoutMs"`
...
func (c *Client) GetAppConfiguration(ctx context.Context) (*AppConfiguration, error) {
	...
	if err := c.get(ctx, "/jans-config-api/api/v1/jans-auth-server/config", token, scope, ret); err != nil {
...
func (c *Client) PatchAppConfiguration(ctx context.Context, patches []PatchRequest) (*AppConfiguration, error) {
	...
	if err := c.patch(ctx, "/jans-config-api/api/v1/jans-auth-server/config", token, scope, updates); err != nil {
