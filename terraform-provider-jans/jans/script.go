...
type Script struct {
        ...
        LocationPath            string                         `schema:"location_path" json:"locationPath,omitempty"`
...
func (c *Client) GetScripts(ctx context.Context) ([]Script, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/api/v1/config/scripts", token, scope, &ret, map[string]string{
                "limit": "5",
        }); err != nil {
...
func (c *Client) GetScript(ctx context.Context, inum string) (*Script, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/api/v1/config/scripts/inum/"+inum, token, scope, ret); err != nil {
                return nil, fmt.Errorf("get request failed: %w", err)
        }
...
func (c *Client) CreateScript(ctx context.Context, script *Script) (*Script, error) {
        ...
        if err := c.post(ctx, "/jans-config-api/api/v1/config/scripts", token, scope, script, ret); err != nil {
...
func (c *Client) UpdateScript(ctx context.Context, script *Script) (*Script, error) {
        ...
        if err := c.put(ctx, "/jans-config-api/api/v1/config/scripts/", token, scope, script, ret); err != nil {
...
func (c *Client) DeleteScript(ctx context.Context, inum string) error {
        ...
        if err := c.delete(ctx, "/jans-config-api/api/v1/config/scripts/"+inum, token, scope); err != nil {
...
func (c *Client) GetScriptTypes(ctx context.Context) ([]string, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/api/v1/config/scripts/types", token, scope, &ret); err != nil {
                return nil, fmt.Errorf("get request failed: %w", err)
        }
