...
func (c *Client) GetWebKeysConfiguration(ctx context.Context) (*WebKeysConfiguration, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/api/v1/config/jwks", token, scope, ret); err != nil {
...
func (c *Client) GetJsonWebKey(ctx context.Context, kid string) (*JsonWebKey, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/api/v1/config/jwks/"+kid, token, scope, ret); err != nil {
                return nil, fmt.Errorf("get request failed: %w", err)
        }
...
func (c *Client) CreateJsonWebKey(ctx context.Context, jwk *JsonWebKey) (*JsonWebKey, error) {
        ...
        if err := c.post(ctx, "/jans-config-api/api/v1/config/jwks/key", token, scope, jwk, ret); err != nil {
...
func (c *Client) UpdateJsonWebKey(ctx context.Context, jwk *JsonWebKey) (*JsonWebKey, error) {
        ...
        if err := c.patch(ctx, "/jans-config-api/api/v1/config/jwks/"+jwk.Kid, token, scope, patches); err != nil {
...
func (c *Client) DeleteJsonWebKey(ctx context.Context, kid string) error {
        ...
        if err := c.delete(ctx, "/jans-config-api/api/v1/config/jwks/"+kid, token, scope); err != nil {
