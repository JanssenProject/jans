...
func (c *Client) GetUMAResources(ctx context.Context) ([]UMAResource, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/api/v1/uma/resources", token, scope, &ret, map[string]string{
                "limit": "5",
        }); err != nil {
...
func (c *Client) GetUMAResource(ctx context.Context, id string) (*UMAResource, error) {
        ...
        if err := c.get(ctx, "/jans-config-api/api/v1/uma/resources/"+id, token, scope, ret); err != nil {
                return nil, fmt.Errorf("get request failed: %w", err)
        }
...
func (c *Client) CreateUMAResource(ctx context.Context, resource *UMAResource) (*UMAResource, error) {
        ...
        if err := c.post(ctx, "/jans-config-api/api/v1/uma/resources", token, scope, resource, ret); err != nil {
...
func (c *Client) UpdateUMAResource(ctx context.Context, resource *UMAResource) (*UMAResource, error) {
        ...
        if err := c.put(ctx, "/jans-config-api/api/v1/uma/resources", token, scope, resource, ret); err != nil {
...
func (c *Client) DeleteUMAResource(ctx context.Context, id string) error {
        ...
        if err := c.delete(ctx, "/jans-config-api/api/v1/uma/resources/"+id, token, scope); err != nil {
