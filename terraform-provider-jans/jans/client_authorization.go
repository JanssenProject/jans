...
func (c *Client) GetClientAuthorizations(ctx context.Context) ([]ClientAuthorization, error) {
        ...
        if err := c.get(ctx, "/api/v1/clients/authorizations", token, scope, &authorizations); err != nil {
...
func (c *Client) CreateClientAuthorization(ctx context.Context, auth *ClientAuthorization) (*ClientAuthorization, error) {
        scope := "https://jans.io/oauth/client/authorizations.write"
        token, err := c.ensureToken(ctx, scope)
        if err != nil {
                return nil, fmt.Errorf("failed to get token: %w", err)
        }
        ...
        if err := c.post(ctx, "/api/v1/clients/authorizations", token, scope, auth, &createdAuth); err != nil {
...
func (c *Client) UpdateClientAuthorization(ctx context.Context, auth *ClientAuthorization) (*ClientAuthorization, error) {
        ...
        if err := c.put(ctx, path, token, scope, auth, &updatedAuth); err != nil {
