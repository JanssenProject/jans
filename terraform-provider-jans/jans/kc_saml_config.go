...
func (c *Client) CreateKCSAMLConfiguration(ctx context.Context, config *KCSAMLConfiguration) (*KCSAMLConfiguration, error) {
        ...
        scope := "https://jans.io/oauth/config/saml-config.write"
        ...
        if err := c.put(ctx, "/jans-config-api/kc/samlConfig", token, scope, config, ret); err != nil {
...
func (c *Client) GetKCSAMLConfiguration(ctx context.Context) (*KCSAMLConfiguration, error) {
        scope := "https://jans.io/oauth/config/saml-config.readonly"
        token, err := c.ensureToken(ctx, scope)
        if err != nil {
                return nil, fmt.Errorf("failed to get token: %w", err)
        }
        ...
        if err := c.get(ctx, "/jans-config-api/kc/samlConfig", token, scope, ret); err != nil {
...
func (c *Client) PatchKCSAMLConfiguration(ctx context.Context, patches []PatchRequest) (*KCSAMLConfiguration, error) {
        ...
        if err := c.patch(ctx, "/jans-config-api/kc/samlConfig", token, scope, updates); err != nil {
                return nil, fmt.Errorf("put request failed: %w", err)
        }
