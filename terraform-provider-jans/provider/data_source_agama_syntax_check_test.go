                ...
                Steps: []resource.TestStep{
                        {
                                ...
                                Check: resource.ComposeTestCheckFunc(
                                        resource.TestCheckResourceAttr("data.jans_agama_syntax_check.test", "valid", "true"),
                                        resource.TestCheckResourceAttr("data.jans_agama_syntax_check.test", "flow_name", "test_flow"),
