...
public final class CertUtil {
    ...
    public static Pair<ValidationStatus, X509Certificate> validate(String certPEM, String certChainPEM) {
        ...
        if (valid) {
            p.first(ValidationStatus.VALID);
            p.setSecond(certificate);
        } else {
            p.first(ValidationStatus.NOT_VALID);
        }
    ...
    public static EnrollmentStatus enroll(String uid, X509Certificate certificate, String fingerPrint) {
        ...
        try {
            ...
            if (ownerUid == null) {
                ...
                List<String> extUids = Optional.ofNullable(user.getExternalUid())
    ...
    public static String register(X509Certificate certificate, String classField)
        ...
        Class<?> clazz = AttributeMappgins.class;
        ...
        Map<String, String> certAttributes = getDNAttributes(certificate.getSubjectX500Principal().getName());
    ...
    private static Map<String, String> getDNAttributes(String dn) {
