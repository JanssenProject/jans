...
public abstract class ExternalScriptService implements Serializable {
	...
	private Map<String, CustomScriptConfiguration> buildExternalConfigurationsNameMap(
			List<CustomScriptConfiguration> customScriptConfigurations) {
		...
		for (CustomScriptConfiguration customScriptConfiguration : customScriptConfigurations) {
			reloadedExternalConfigurations.put(StringHelper.toLowerCase(customScriptConfiguration.getName()),
	...
	public List<CustomScriptConfiguration> getCustomScriptConfigurationsByDns(List<String> dns) {
		if (dns == null || dns.isEmpty() || customScriptConfigurations == null
				|| customScriptConfigurations.isEmpty()) {
