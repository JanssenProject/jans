 ...
 */
public class AuthorizationResponseModeFragmentJwtResponseTypeTokenIdTokenSignedHttpTest extends BaseTest {
    ...
    public void authorizationRequestObjectRS256(
        ...
        request.setResponseMode(ResponseMode.FRAGMENT_JWT);
