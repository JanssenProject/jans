 ...
 */
public class AuthorizationResponseModeQueryJwtResponseTypeCodeEncryptedHttpTest extends BaseTest {
    ...
    public void authorizationRequestObjectAlgRSA15EncA128CBCPLUSHS256(
        ...
        String serverKeyId = JSONWebKeySet.fromJSONObject(jwks).getKeyId(Algorithm.RSA1_5);
    ...
    public void authorizationRequestObjectAlgRSAOAEPEncA256GCM(
        ...
        // 2. Choose encryption key
        JSONObject jwks = JwtUtil.getJSONWebKeys(jwksUri);
        String serverKeyId = JSONWebKeySet.fromJSONObject(jwks).getKeyId(Algorithm.RSA_OAEP);
