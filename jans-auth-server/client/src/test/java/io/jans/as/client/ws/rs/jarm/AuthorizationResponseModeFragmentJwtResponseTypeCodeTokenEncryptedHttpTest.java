 ...
 */
public class AuthorizationResponseModeFragmentJwtResponseTypeCodeTokenEncryptedHttpTest extends BaseTest {
    ...
    public void authorizationRequestObjectAlgRSAOAEPEncA256GCM(
        ...
        JSONObject jwks = JwtUtil.getJSONWebKeys(jwksUri);
        AuthCryptoProvider cryptoProvider = cryptoContext.getCryptoProvider();
        privateKey = cryptoProvider.getPrivateKey(cryptoContext.getKeyId(Algorithm.RSA_OAEP));
