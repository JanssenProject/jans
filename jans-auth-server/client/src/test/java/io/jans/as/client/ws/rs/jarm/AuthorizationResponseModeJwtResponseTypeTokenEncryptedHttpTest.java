 ...
 */
public class AuthorizationResponseModeJwtResponseTypeTokenEncryptedHttpTest extends BaseTest {
    ...
    public void authorizationRequestObjectAlgRSA15EncA128CBCPLUSHS256(
        ...
        privateKey = cryptoProvider.getPrivateKey(cryptoContext.getKeyId(Algorithm.RSA1_5));
