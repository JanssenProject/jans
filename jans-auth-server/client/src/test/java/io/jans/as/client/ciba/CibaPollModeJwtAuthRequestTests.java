...
public class CibaPollModeJwtAuthRequestTests extends BaseTest {
    ...
    @Parameters({"userId"})
    @Test
    public void pollFlowPS256HappyFlow(final String userId) throws Exception {
        showTitle("pollFlowPS256HappyFlow");
        registerPollClient(BackchannelTokenDeliveryMode.POLL, AsymmetricSignatureAlgorithm.PS256);
    ...
    @Parameters({"userId"})
    @Test
    public void pollFlowPS384HappyFlow(final String userId) throws Exception {
        showTitle("pollFlowPS384HappyFlow");
        registerPollClient(BackchannelTokenDeliveryMode.POLL, AsymmetricSignatureAlgorithm.PS384);
    ...
    @Parameters({"userId"})
    @Test
    public void pollFlowPS512HappyFlow(final String userId) throws Exception {
        showTitle("pollFlowPS512HappyFlow");
        registerPollClient(BackchannelTokenDeliveryMode.POLL, AsymmetricSignatureAlgorithm.PS512);
    ...
    @Parameters({"userId"})
    @Test
    public void pollFlowES256HappyFlow(final String userId) throws Exception {
        showTitle("pollFlowES256HappyFlow");
        registerPollClient(BackchannelTokenDeliveryMode.POLL, AsymmetricSignatureAlgorithm.ES256);
    ...
    @Parameters({"userId"})
    @Test
    public void pollFlowES384HappyFlow(final String userId) throws Exception {
        showTitle("pollFlowES384HappyFlow");
        registerPollClient(BackchannelTokenDeliveryMode.POLL, AsymmetricSignatureAlgorithm.ES384);
    ...
    @Parameters({"userId"})
    @Test
    public void pollFlowES512HappyFlow(final String userId) throws Exception {
        showTitle("pollFlowES512HappyFlow");
        registerPollClient(BackchannelTokenDeliveryMode.POLL, AsymmetricSignatureAlgorithm.ES512);
    ...
    @Parameters({"userId"})
    @Test
    public void cibaPollJWTRequestDataValidations(final String userId) throws Exception {
    ...
    public void cibaPollJWTRequestIdTokenHint(final String userId) throws Exception {
    ...
    @Parameters({"userId"})
    @Test
    public void cibaPollJWTRequestWrongSigning(final String userId) throws Exception {
     ...
     */
    private void registerPollClient(BackchannelTokenDeliveryMode mode, AsymmetricSignatureAlgorithm algorithm) {
