 ...
 */
public class AuthorizationResponseModeJwtResponseTypeCodeIdTokenEncryptedHttpTest extends BaseTest {
    ...
    public void testAlgA128KWEncA128GCM(
        ...
        authorizationRequest(responseTypes, ResponseMode.JWT, ResponseMode.QUERY_JWT, clientId, scopes, redirectUri, nonce,
    ...
    public void testAlgRSA15EncA128CBCPLUSHS256(
        ...
        privateKey = cryptoContext.getCryptoProvider().getPrivateKey(keyId);
    ...
    public void authorizationRequestObjectAlgRSA15EncA256CBCPLUSHS512(
        ...
        TestCryptoContext cryptoContext = TestCryptoContext.getInstance();
        privateKey = cryptoContext.getCryptoProvider().getPrivateKey(cryptoContext.getKeyId(Algorithm.RSA1_5));
    ...
    public void authorizationRequestObjectAlgRSAOAEPEncA256GCM(
        ...
        TestCryptoContext cryptoContext = TestCryptoContext.getInstance();
        privateKey = cryptoContext.getCryptoProvider().getPrivateKey(cryptoContext.getKeyId(Algorithm.RSA_OAEP));
