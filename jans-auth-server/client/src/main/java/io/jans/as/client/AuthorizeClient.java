...
public class AuthorizeClient extends BaseClient<AuthorizationRequest, AuthorizationResponse> {
    ...
    private AuthorizationResponse exec_() throws Exception {
        ...
        addReqParam(AuthorizeRequestParam.DPOP_JKT, getRequest().getDpopJkt());
        ...
        if (getRequest().isRequestSessionJwt()) {
            addReqParam(AuthorizeRequestParam.SESSION_JWT, Boolean.toString(getRequest().isRequestSessionJwt()));
        }
