...
public class EDDSAPrivateKey extends PrivateKey {
    ...
    /**
     * Returns original array (decoded) of the public key (ED25519 - 32 bytes);
     * 
     * @return original array (decoded) of the public key (ED25519 - 32 bytes);
     * @throws IOException
     */
    ...
    /**
     * Returns original array (decoded) of the public key (EDDSA/Ed25519 - 32 bytes);
     * 
     * @return original array (decoded) of the public key (EDDSA/Ed25519 - 32 bytes);
     */
