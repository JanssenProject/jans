...
public class RegisterJsonService {
    ...
    public JSONObject getJSONObject(Client client) throws JSONException, StringEncrypter.EncryptionException {
        ...
        Util.addToJSONObjectIfNotNull(responseJsonObject, AUTHORIZATION_DETAILS_TYPES.toString(), client.getAttributes().getAuthorizationDetailsTypes());
        ...
        Util.addToJSONObjectIfNotNull(responseJsonObject, SESSION_JWT_SIGNED_RESPONSE_ALG.toString(), client.getAttributes().getSessionJwtSignedResponseAlg());
        ...
        Util.addToJSONObjectIfNotNull(responseJsonObject, REQUIRE_PKCE.toString(), client.getAttributes().getRequirePkce());
