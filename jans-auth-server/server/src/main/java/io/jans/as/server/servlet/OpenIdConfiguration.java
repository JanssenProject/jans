...
public class OpenIdConfiguration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest servletRequest, HttpServletResponse httpResponse) throws IOException {
        ...
        try (PrintWriter out = httpResponse.getWriter()) {
            ...
            jsonObj.put(AUTHORIZATION_CHALLENGE_REQUEST_ENDPOINT, appConfiguration.getAuthorizationChallengeEndpoint());
    ...
    private void addMtlsAliases(JSONObject jsonObj) {
        ...
        if (StringUtils.isNotBlank(appConfiguration.getMtlsAuthorizationChallengeEndpoint()))
            aliases.put(AUTHORIZATION_CHALLENGE_REQUEST_ENDPOINT, appConfiguration.getMtlsAuthorizationChallengeEndpoint());
