...
public class RegisterRestWebServiceImpl implements RegisterRestWebService {
    ...
    private void updateClientFromRequestObject(Client client, RegisterRequest requestObject, boolean update) throws JSONException {
    ...
    private JSONObject getJSONObject(Client client) throws JSONException, StringEncrypter.EncryptionException {
        ...
        Util.addToJSONObjectIfNotNullOrEmpty(responseJsonObject, RESPONSE_TYPES.toString(), ResponseType.toStringArray(client.getResponseTypes()));
        Util.addToJSONObjectIfNotNullOrEmpty(responseJsonObject, GRANT_TYPES.toString(), GrantType.toStringArray(client.getGrantTypes()));
        ...
        for (String attr : attrList) {
            if (requestObject.has(attr)) {
                ...
                final List<String> parameterValues = parameterValuesJsonArray != null ?
                        ...
                        Arrays.asList(requestObject.getString(attr));
