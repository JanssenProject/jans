...
public class TestServerCryptoContext {
    public static final String DEFAULT_DN_NAME = "CN=Jans Auth CA Certificates";
    ...
    private TestServerCryptoContext(AuthCryptoProvider cryptoProvider, String keyStoreFile,
    ...
    private static class Holder {
        private static final TestServerCryptoContext INSTANCE;
    ...
    public static TestServerCryptoContext getInstance() {
     ...
     */
    private static TestServerCryptoContext create() throws Exception {
     ...
     */
    public static TestServerCryptoContext create(List<Algorithm> algorithms) throws Exception {
        ...
        AuthCryptoProvider cryptoProvider = new AuthCryptoProvider(
                keyStoreFile, DEFAULT_SECRET, DEFAULT_DN_NAME);
        ...
        TestServerCryptoContext context = new TestServerCryptoContext(
                cryptoProvider, keyStoreFile, DEFAULT_SECRET, DEFAULT_DN_NAME, jwks);
