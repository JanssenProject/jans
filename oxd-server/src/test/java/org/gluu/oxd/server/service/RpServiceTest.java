...
public class RpServiceTest {
    ...
    public void testNullFieldsAreSkipped() throws IOException {
        Rp rp = newRp();
        String expectedJson = "{\"oxd_id\":\"" + rp.getOxdId() + "\",\"op_host\":\"test.gluu.org\",\"response_types\":[\"code\"],\"scope\":[\"openid\",\"profile\",\"email\"],\"ui_locales\":[\"en\"],\"claims_locales\":[\"en\"],\"acr_values\":[\"\"],\"access_token_as_jwt\":false,\"rpt_as_jwt\":false,\"front_channel_logout_session_required\":false,\"run_introspection_script_beforeaccess_token_as_jwt_creation_and_include_claims\":false,\"require_auth_time\":false,\"allow_spontaneous_scopes\":false,\"sync_client_from_op\":false,\"sync_client_period_in_seconds\":3600}";
