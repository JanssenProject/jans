...
public class UpdateRegisteredClientService {

    private static final Logger LOG = LoggerFactory.getLogger(UpdateRegisteredClientService.class);

    private final HttpService httpService;

    @Inject
    public UpdateRegisteredClientService(HttpService httpService) {
        this.httpService = httpService;
    }

    public void updateRegisteredClient(Rp rp, UpdateSiteParams params) {
        ...
        registerClient.setExecutor(httpService.getClientExecutor());
