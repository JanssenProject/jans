...
The application is now runnable using `java -jar target/jans-config-api-5.0.0-SNAPSHOT-runner.jar`.
...
You can then execute your native executable with: `./target/oxauth-config-api-5.0.0-SNAPSHOT-runner`
