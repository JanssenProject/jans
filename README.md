...
| **[Jans LDAP Link](jans-link)**              | a group of components that provide synchronization services to update the Janssen User Store from an external authoritative LDAP data sources                                                                                               | ![Sunsetting](https://img.shields.io/badge/Sunsetting-%23b02a37) |
| **[Jans Keycloak Link](jans-keycloak-link)** | a group of components that provide synchronization services to update the Janssen User Store from an external authoritative Keycloak data sources                                                                                           | ![Sunsetting](https://img.shields.io/badge/Sunsetting-%23b02a37) |
