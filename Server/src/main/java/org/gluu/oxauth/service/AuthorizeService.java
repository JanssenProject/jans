...
import org.gluu.oxauth.persistence.model.Scope;
...
public class AuthorizeService {
    ...
    public List<org.gluu.oxauth.persistence.model.Scope> getScopes() {
    ...
    public List<Scope> getScopes(String scopes) {
        ...
        if (scopes != null && !scopes.isEmpty()) {
            ...
            for (String scopeName : scopesName) {
                org.gluu.oxauth.persistence.model.Scope s = scopeService.getScopeByDisplayName(scopeName);
