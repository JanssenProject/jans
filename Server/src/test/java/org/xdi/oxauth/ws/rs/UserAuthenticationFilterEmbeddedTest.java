...
public class UserAuthenticationFilterEmbeddedTest extends BaseTest {
	...
	public void requestAccessTokenCustomAuthStep3(final String validateTokenPath, final String accessToken)
			throws Exception {
		...
		showResponse("requestAccessTokenCustomAuthStep3", response, entity);

		assertEquals(response.getStatus(), 200, "Unexpescted response code. " + entity);
		assertTrue(
				response.getHeaderString("Cache-Control") != null
