...
public class AuthorizationCodeFlowEmbeddedTest extends BaseTest {
	...
	public void completeFlowStep3(final String tokenPath, final String validateTokenPath, final String accessToken,
			final String refreshToken) throws Exception {
		ValidateTokenRequest validateTokenRequest = new ValidateTokenRequest();
		validateTokenRequest.setAccessToken(accessToken);

		Builder request = ResteasyClientBuilder.newClient()
				.target(url.toString() + validateTokenPath + "?" + validateTokenRequest.getQueryString()).request();
	...
	public void completeFlowStep4(final String tokenPath, final String refreshToken) throws Exception {
		...
		showResponse("completeFlowStep4", response, entity);
	...
	public void completeFlowWithOptionalNonceStep4(final String tokenPath, final String refreshToken) throws Exception {
		...
		showResponse("completeFlowWithOptionalNonceStep4", response, entity);
