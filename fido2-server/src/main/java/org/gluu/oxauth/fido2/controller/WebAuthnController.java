...
//
//
//    @PostMapping(value = {"/register","/attestation/options"}, produces = {"application/json"}, consumes = {"application/json"})
//    JsonNode register(@RequestBody JsonNode params) {
//        return attestationService.register();
//    }
//
//    @PostMapping(value = {"/attestation/result"}, produces = {"application/json"}, consumes = {"application/json"})
...
//
//        log.info("userId  {} challenge {} {} {}", userId,challenge,clientDataChallenge,clientDataOrigin);
