...
- [Client Registration script](https://github.com/JanssenProject/jans/blob/v2.4.0/jans-linux-setup/jans_setup/openbanking/static/extension/client_registration/Registration.py) - included in the default Janssen OpenBanking distribution
...
1. jans-cli in command-line argument mode is more conducive to scripting and automation. To display the available operations for custom scripts, use config-cli.py --info CustomScripts. See the [docs](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/jans-cli/index.md) for more info.
1. To use `curl` see these [docs](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/curl-guide/index.md)
