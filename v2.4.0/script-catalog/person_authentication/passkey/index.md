...
This document explains how to use the Janssen Auth Server's built-in [Passkey Interception Script](https://github.com/JanssenProject/jans/blob/v2.4.0/docs/script-catalog/person_authentication/passkey/PasskeyInterceptionScript.py) to implement a two-step, two-factor authentication (2FA) with username / password as the first step, and any FIDO2 device as the second step.

## Prerequisites

- A Janssen Server ([installation instructions](https://github.com/JanssenProject/jans#installation))
- [Passkey Interception Script](https://github.com/JanssenProject/jans/blob/v2.4.0/docs/script-catalog/person_authentication/passkey/PasskeyInterceptionScript.py) (included in the default Janssen Server distribution);
...
Use this [link](https://github.com/JanssenProject/jans-cli-tui/blob/v2.4.0/docs/cli/cli-default-authentication-method.md) as a reference. Follow the steps below to enable FIDO2 authentication:
...
The design is being rendered from the [FIDO2 xhtml page](https://github.com/JanssenProject/jans/blob/v2.4.0/jans-auth-server/server/src/main/webapp/auth/fido2/login.xhtml). To customize the look and feel of this page, follow the [customization guide](https://docs.jans.io/v2.4.0/admin/developer/customization/customize-web-pages/).
