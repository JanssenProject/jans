...
- [Restart](https://docs.jans.io/v2.4.0/janssen-server/vm-ops/restarting-services/#restart) the `jans-auth` service
...
1. [Update the custom script](https://github.com/JanssenProject/jans-cli/blob/v2.4.0/docs/cli/cli-custom-scripts.md#update-an-existing-custom-script) and change the `enabled` attribute to `true`
...
Use this [link](https://github.com/JanssenProject/jans-cli-tui/blob/v2.4.0/docs/cli/cli-default-authentication-method.md) as a reference. Follow the steps below to enable `twilio_sms` authentication:
