...
- [Super Gluu interception script](https://docs.jans.io/v2.4.0/script-catalog/person_authentication/super-gluu-external-authenticator/SuperGluuExternalAuthenticator.py) is included in the default Janssen Server distribution
...
Use this [link](https://github.com/JanssenProject/jans-cli-tui/blob/v2.4.0/docs/cli/cli-default-authentication-method.md) as a reference.
...
The Gluu Server includes a [default public-facing pages for Super Gluu](https://github.com/JanssenProject/jans/blob/v2.4.0/jans-auth-server/server/src/main/webapp/auth/super-gluu/login.xhtml) for enrollment and authentication.

To customize the look and feel of the pages, follow the [customization guide](https://github.com/JanssenProject/jans/blob/v2.4.0/docs/admin/developer/customization/customize-web-pages.md).
...
See the [SCIM documentation](https://docs.jans.io/v2.4.0/janssen-server/usermgmt/usermgmt-scim/#fido-2-devices) on how to manage Super Gluu devices, using the SCIM [protocol].
