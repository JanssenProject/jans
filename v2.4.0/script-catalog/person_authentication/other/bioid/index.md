...
- A Janssen Server
- [BioID interception script](https://docs.jans.io/v2.4.0/script-catalog/person_authentication/other/bioid/BioIDExternalAuthenticator.py).
...
Download this [file](https://docs.jans.io/v2.4.0/script-catalog/person_authentication/other/bioid/BioIDExternalAuthenticator.py) and copy its contents in the `Script` form field.
