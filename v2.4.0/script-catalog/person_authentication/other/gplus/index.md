...
6. gplus_client_configuration_attribute - Specify client entry attribute name which can override gplus_client_secrets_file file content. It's optional property. It can be used in cases when all clients should use separate gplus_client_secrets.json configuration.
