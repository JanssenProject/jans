...
1. User is shown a form asking for password only (username field is not editable)
1. User is taken to a page where he is challenged to present a second factor (strong credential) for completion of authentication
...
name: acr_attribute value: oxPreferredMethod
