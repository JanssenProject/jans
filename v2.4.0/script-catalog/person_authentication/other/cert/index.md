...
For testing purposes there is archive with CA/Intermidiate/User certs in [archive](https://docs.jans.io/v2.4.0/script-catalog/person_authentication/other/cert/sample/generated_certs.zip).
