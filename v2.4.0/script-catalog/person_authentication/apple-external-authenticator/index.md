...
- The [Sign-in with Apple authentication script](https://docs.jans.io/v2.4.0/script-catalog/person_authentication/apple-external-authenticator/AppleExternalAuthenticator.py) (included in the default Jans-auth Server distribution);
...
To update this setting in Jans persistence, follow this [link](https://github.com/JanssenProject/jans-cli-tui/blob/v2.4.0/docs/cli/cli-custom-scripts.md#update-an-existing-custom-script)
