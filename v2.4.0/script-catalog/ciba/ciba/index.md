...
> For the CIBA feature itself — server properties, per-client metadata, endpoints, and recommendations — see [auth-server / OpenID features / CIBA](https://docs.jans.io/v2.4.0/janssen-server/auth-server/openid-features/ciba/index.md). This page documents only the notification script.
