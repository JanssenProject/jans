...
Apart from using the Cedarling binding [using the package manager](https://docs.jans.io/v2.4.0/cedarling/tutorials/java/#using-the-package-manager), you can also build it from source.
...
- The following java [Update Token](https://docs.jans.io/v2.4.0/cedarling/uniffi/cedarling-sample-inputs/#sample_cedarling_update_tokenjava) script has been created for calling Cedarling authorization. Enable the script with following Custom Properties:
