...
Not sure which to choose? See the [decision guide](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-authz/#which-authorization-method-should-i-use).

To see Cedarling authorization in action, we need 3 things:

1. A [policy store](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-policy-store/index.md)
