...
For complete configuration documentation, see [Configuration Properties](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-properties/index.md).
...
- Explore [Cedar Policy Language](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-policy-store/index.md) for writing authorization policies
- Learn about [Multi-Issuer Authorization](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-multi-issuer/index.md) for JWT-based authorization
- Review [Configuration Properties](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-properties/index.md) for all available options
