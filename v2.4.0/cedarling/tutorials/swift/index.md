...
Refer to the [iOS build guide](https://docs.jans.io/v2.4.0/cedarling/developer/mobile-apps/cedarling-ios/#manually-built-ios-assets) for steps to build the XCFramework from source using Rust and Xcode.
...
- [Using Pre-Built iOS Release Assets](https://docs.jans.io/v2.4.0/cedarling/developer/mobile-apps/cedarling-ios/#using-pre-built-ios-release-assets)
