...
Python bindings support all policy store source types. See [Cedarling Properties](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-properties/index.md) for the full list of configuration options.
...
- [Cedarling Unsigned quickstart](https://docs.jans.io/v2.4.0/cedarling/quick-start/cedarling-quick-start/#step-1-create-the-cedar-policy-and-schema)
- [Cedarling Sidecar Tutorial](https://docs.jans.io/v2.4.0/cedarling/developer/sidecar/cedarling-sidecar-tutorial/index.md)
- [Multi-Issuer Authorization Details](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-authz/#multi-issuer-authorization-authorize_multi_issuer-recommended)
