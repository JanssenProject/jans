...
- [C](https://docs.jans.io/v2.4.0/cedarling/tutorials/c/index.md)
- [JavaScript](https://docs.jans.io/v2.4.0/cedarling/tutorials/javascript/index.md)
- [Python](https://docs.jans.io/v2.4.0/cedarling/tutorials/python/index.md)
- [Rust](https://docs.jans.io/v2.4.0/cedarling/tutorials/rust/index.md)
- [Kotlin](https://docs.jans.io/v2.4.0/cedarling/tutorials/kotlin/index.md)
- [Swift](https://docs.jans.io/v2.4.0/cedarling/tutorials/swift/index.md)
- [Golang](https://docs.jans.io/v2.4.0/cedarling/tutorials/go/index.md)
- [Java](https://docs.jans.io/v2.4.0/cedarling/tutorials/java/index.md)

Alternatively, you can use the [Cedarling Sidecar](https://docs.jans.io/v2.4.0/cedarling/developer/sidecar/cedarling-sidecar-overview/index.md) for a drop-in deployment.
...
- Learn more in the [bootstrap properties guide](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-properties/index.md).
...
- Learn more in the [policy store guide](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-policy-store/index.md).
...
When using Cedarling, **Action** and **Resource** are typically defined in the [policy store](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-policy-store/index.md), while **Principal** and **Context** are supplied at runtime via the `authz` interface.

Cedarling provides two authorization methods. Not sure which to use? See the [quick start decision guide](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-authz/#which-authorization-method-should-i-use).
...
[More information](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-multi-issuer/index.md)
...
- [Kotlin](https://docs.jans.io/v2.4.0/cedarling/tutorials/kotlin/index.md)
- [Swift](https://docs.jans.io/v2.4.0/cedarling/tutorials/swift/index.md)
- [Go](https://docs.jans.io/v2.4.0/cedarling/tutorials/go/index.md)
- [Java](https://docs.jans.io/v2.4.0/cedarling/tutorials/java/index.md)
...
Cedarling supports logging of both **decision** and **system** events, useful for auditing and troubleshooting. Logging is optional and can be configured (or disabled) via the [bootstrap properties](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-properties/index.md).
...
- See how you can use [RBAC with Cedarling using signed tokens (TBAC)](https://docs.jans.io/v2.4.0/cedarling/quick-start/cedarling-quick-start/#implement-rbac-using-signed-tokens-tbac) — the recommended starting point.
- Explore how to use [Cedarling's Unsigned interface](https://docs.jans.io/v2.4.0/cedarling/quick-start/cedarling-quick-start/#implement-rbac-using-application-asserted-identity) for custom auth flows or testing.
- Use the [Cedarling Sidecar](https://docs.jans.io/v2.4.0/cedarling/developer/sidecar/cedarling-sidecar-overview/index.md) for a quick, zero-code deployment.
- Learn more about [why Cedarling exists](https://docs.jans.io/v2.4.0/cedarling/#why-zero-trust-needs-cedarlings) and the problems it solves.
