...
- Any [default entities](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-policy-store/#default-entities) defined in the policy store
- Any data pushed via the [Context Data API](https://docs.jans.io/v2.4.0/cedarling/tutorials/cedarling-getting-started/#context-data-api) under `context.data`
...
See the [Interfaces](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-interfaces/#policy-introspection) reference for full API details and examples.
...
See the [Interfaces](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-interfaces/#annotation-lookup) reference for signatures and examples.
