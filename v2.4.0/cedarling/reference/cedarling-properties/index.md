...
Not sure which authorization method to use? See the [decision guide](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-authz/#which-authorization-method-should-i-use).
...
For native platforms, the Cedarling now supports a directory-based policy store format with human-readable Cedar files. See [Policy Store Formats](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-policy-store/#policy-store-formats) for details.
...
- **`CEDARLING_LOG_LEVEL`** : System Log Level [See here](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-logs/index.md). Default to `WARN`
