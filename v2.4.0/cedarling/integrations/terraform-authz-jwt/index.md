...
`Destroy` is permanently off-limits for CI. A human operator using the [unsigned wrapper](https://docs.jans.io/v2.4.0/cedarling/integrations/terraform-authz/index.md) with Admin-role membership is required to destroy infrastructure.
...
|                           | [Unsigned demo](https://docs.jans.io/v2.4.0/cedarling/integrations/terraform-authz/index.md) | JWT demo (this page)                                                              |
| ------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
