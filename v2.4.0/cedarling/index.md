...
The `log` interface enables developers to retrieve decision and system logs from the Cedarling's in-memory cache. See the Cedarling [log](https://docs.jans.io/v2.4.0/cedarling/reference/cedarling-logs/index.md) documentation for more information.
