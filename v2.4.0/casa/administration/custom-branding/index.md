...
This page covers customizations available through the [custom branding plugin](https://docs.jans.io/v2.4.0/casa/plugins/custom-branding/index.md). It is assumed you have already added it to your Casa installation.
