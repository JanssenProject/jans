...
To add more authentication methods, please check the developer [guide](https://docs.jans.io/v2.4.0/casa/developer/add-authn-methods/index.md).
...
Most organizations will want to custom brand Jans Casa. Follow our guide to learn more about [custom branding Casa](https://docs.jans.io/v2.4.0/casa/administration/custom-branding/index.md).
...
This feature is only if the [2FA settings plugin](https://docs.jans.io/v2.4.0/casa/plugins/2fa-settings/index.md) is installed
...
The default policy is to enforce 2FA for every login attempt. If the admin opts to allow users to manager their own policy, a new widget will appear in the user-facing dashboard as described in the [user guide](https://docs.jans.io/v2.4.0/casa/user-guide/#2fa-settings-and-trusted-devices).
