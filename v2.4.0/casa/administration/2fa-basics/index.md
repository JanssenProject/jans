...
You can tailor different aspects of 2FA behavior in Casa using the [plugin](https://docs.jans.io/v2.4.0/casa/plugins/2fa-settings/index.md) developed for this purpose.
