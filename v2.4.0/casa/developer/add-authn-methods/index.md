...
Acquaintance with Agama [framework](https://docs.jans.io/v2.4.0/agama/introduction/index.md) and Agama project [management](https://docs.jans.io/v2.4.0/janssen-server/config-guide/auth-server-config/agama-project-configuration/index.md) is required
...
Alternatively, a pointer to a localized message can be used instead of `text`. This is the recommended practice if [localization/internationalization](https://docs.jans.io/v2.4.0/janssen-server/developer/agama/advanced-usages/#localization-and-internationalization) is relevant. In this case, something like the below will work:
...
Ensure to go through [this](https://docs.jans.io/v2.4.0/janssen-server/developer/agama/agama-best-practices/index.md) page before proceeding
...
Coding a Casa plugin is mainly a Java development task. You can use the "Sample credential" [plugin](https://github.com/JanssenProject/jans/tree/v2.4.0/jans-casa/plugins/samples/sample-cred#readme) as a template to start the work. Ensure you have:
