...
1. [Download the plugin](https://github.com/JanssenProject/jans/releases/download/v2.4.0/authorized-clients-2.4.0-jar-with-dependencies.jar)
...
For information on how to use the plugin, see the [User Guide](https://docs.jans.io/v2.4.0/casa/user-guide/index.md)
