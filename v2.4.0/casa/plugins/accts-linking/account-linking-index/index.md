...
1. Download the plugin jar file `https://github.com/JanssenProject/jans/releases/download/v2.4.0/acct-linking-2.4.0-jar-with-dependencies.jar` and copy to your server's `/opt/jans/jetty/jans-casa/plugins`

1. Download the utility jar file `https://github.com/JanssenProject/jans/releases/download/v2.4.0/agama-inbound-2.4.0.jar` and copy to your server's `/opt/jans/jetty/jans-auth/custom/libs`
...
1. Download the Casa accounts linking Agama project `https://github.com/JanssenProject/jans/releases/download/v2.4.0/acct-linking-agama-2.4.0-project.zip`
...
1. Apply changes as needed - this is covered in a separate doc page [here](https://docs.jans.io/v2.4.0/casa/plugins/accts-linking/accts-linking-agama/index.md). Note you can add or remove sections in the file at will, and that providers can also be disabled so they are not listed in the login page or in Casa app
