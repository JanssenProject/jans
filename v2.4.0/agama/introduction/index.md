...
Find the complete Agama DSL reference [here](https://docs.jans.io/v2.4.0/agama/language-reference/index.md).
...
More information on execution rules can be found [here](https://docs.jans.io/v2.4.0/agama/execution-rules/index.md).

## `.gama` file format

Check [this](https://docs.jans.io/v2.4.0/agama/gama-format/index.md) page for more information.
