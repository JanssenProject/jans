...
- Good understanding of Janssen Server installation process in general is a prerequisite. Here we are just highlighting steps without a lot of details. Visit [installation](https://docs.jans.io/v2.4.0/janssen-server/install/index.md) documentation for complete understanding.
...
```
wget https://raw.githubusercontent.com/JanssenProject/jans/v2.4.0/jans-linux-setup/jans_setup/install.py -O install.py
```
