...
As mentioned in the overview we recommend using the same Kubernetes cluster as planned in production. More guides to install on different clouds can be found [here](https://docs.jans.io/v2.4.0/janssen-server/install/helm-install/index.md).
...
1. Prepare your [override.yaml](https://docs.jans.io/v2.4.0/janssen-server/install/helm-install/index.md). Copy the below into a file named override.yaml. At the time of writing this we are using image tags `2.4.0_dev` which are the bleeding edge images for release `2.4.0`. Stable images such as `2.4.0-1` should be used.
...
1. Copy the following [yaml](https://github.com/JanssenProject/jans/blob/v2.4.0/demos/benchmarking/docker-jans-loadtesting-jmeter/yaml/load-users/load_users_rdbms_job.yaml) into the folder under the name `load_users.yaml`.
...
1. Create the client json file
   ...
   3. Copy the following [yaml](https://github.com/JanssenProject/jans/blob/v2.4.0/demos/benchmarking/docker-jans-loadtesting-jmeter/yaml/load-test/load_test_auth_code.yaml) into the folder. You may run the soak auth code test by copying the [soak_test_auth_code.yaml](https://github.com/JanssenProject/jans/blob/v2.4.0/demos/benchmarking/docker-jans-loadtesting-jmeter/yaml/load-test/soak_test_auth_code.yaml) instead.

1. Download or build [config-cli-tui](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/jans-tui/index.md) and run:
...
1. Copy the following [yaml](https://github.com/JanssenProject/jans/blob/v2.4.0/demos/benchmarking/docker-jans-loadtesting-jmeter/yaml/load-test/load_test_ropc.yaml) into the folder.
...
1. Copy the following [yaml](https://github.com/JanssenProject/jans/blob/v2.4.0/demos/benchmarking/docker-jans-loadtesting-jmeter/yaml/load-test/load_test_dcr.yaml) into the folder.
