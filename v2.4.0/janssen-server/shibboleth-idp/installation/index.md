...
See the [Helm Deployment Guide](https://docs.jans.io/v2.4.0/janssen-server/shibboleth-idp/helm-deployment/index.md) for detailed Kubernetes installation instructions.
...
See the [Configuration Guide](https://docs.jans.io/v2.4.0/janssen-server/shibboleth-idp/configuration/index.md) for detailed configuration instructions.
