...
See the [TUI for Kubernetes](https://docs.jans.io/v2.4.0/janssen-server/kubernetes-ops/tui-k8s/index.md) guide for detailed instructions.
...
- [Kubernetes Operations](https://docs.jans.io/v2.4.0/janssen-server/kubernetes-ops/index.md) - Day-2 operations
- [Config API](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/config-api/index.md) - REST API configuration
- [Monitoring](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/config-api/monitoring/index.md) - Set up monitoring
