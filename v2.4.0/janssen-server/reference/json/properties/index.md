...
An administrator can set properties using [TUI](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/jans-tui/index.md). Each module has its own property configuration section in TUI.
