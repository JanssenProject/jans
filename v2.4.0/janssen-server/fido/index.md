...
1. **Casa**: [Casa](https://docs.jans.io/v2.4.0/casa/index.md) is a self-service user credentials management portal, providing an interface for end-users to register, view, and delete their own security keys and passkeys.

For details on the technical architecture of the FIDO ecosystem, see the [FIDO2 server design documentation](https://docs.jans.io/v2.4.0/contribute/implementation-design/jans-fido2-design/index.md).

## Feature Highlights

### Passkeys Support

Janssen provides native, out-of-the-box support for passkeys, offering users seamless cross-device synchronization and platform-level biometrics. To get started with passkey deployment, refer to the [Passkeys Implementation Guide](https://docs.jans.io/v2.4.0/janssen-server/recipes/passkey-impl-guide/index.md).

### FIDO Metric API

Janssen server provides [FIDO Metric API](https://gluu.org/swagger-ui/?url=https://raw.githubusercontent.com/JanssenProject/jans/v2.4.0/jans-fido2/docs/jansFido2Swagger.yaml). These APIs enable collection of vital operational metrics such as:

- Number of active registrations
- Registration requests
- Assertion completions

This information helps system administrators to monitor the health and adoption rate of MFA methods. See [Passkey Telemetry & Metrics](https://docs.jans.io/v2.4.0/janssen-server/fido/passkey-telemetry/index.md) for what is collected, how aggregation and retention work, and how to consume the data.
...
- **[Passkey Interception Script](https://docs.jans.io/v2.4.0/script-catalog/person_authentication/passkey/index.md)**: Custom authentication interception logic for MFA and passwordless flows.
- **[FIDO2 Extension Script](https://docs.jans.io/v2.4.0/script-catalog/fido2_extension/fido2-extension/index.md)**: Customize WebAuthn registration/authentication assertions directly within server cycles.

### Fido Metadata Service (MDS)

Janssen FIDO2 server uses [Metadata Service (MDS)](https://fidoalliance.org/metadata/) to dynamically fetch, verify, and cache attestation statements for certified authenticators. This allows organizations to enforce policies (e.g., rejecting uncertified devices or locking down authentication to FIPS-compliant security keys). See [FIDO Vendor Metadata Management](https://docs.jans.io/v2.4.0/janssen-server/fido/vendor-metadata/index.md) for more details.

## Related Documentation

- **[FIDO2 Server Configuration](https://docs.jans.io/v2.4.0/janssen-server/fido/fido2-server-properties-config/index.md)**: Dynamic and static configuration reference schema.
- **[Conditional UI & Fallback Strategies](https://docs.jans.io/v2.4.0/janssen-server/fido/conditional-ui-and-fallback/index.md)**: Implementing usernameless autofill passkeys and handling exceptions gracefully.
