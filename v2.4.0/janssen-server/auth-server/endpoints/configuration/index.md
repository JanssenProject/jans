...
If you want to customize the configuration response, you can use the [OpenID Config Interception Script](https://docs.jans.io/v2.4.0/script-catalog/discovery/discovery/index.md), which enables you to filter the results, modify claim values, or add claims.
