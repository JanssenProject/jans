...
URL to access authorization challenge endpoint on Janssen Server is listed in the response of Janssen Server's well-known [configuration endpoint](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/configuration/index.md) given below.
...
More information about request and response of the authorization challenge endpoint can be found in the OpenAPI specification of [jans-auth-server module](https://gluu.org/swagger-ui/?url=https://raw.githubusercontent.com/JanssenProject/jans/v2.4.0/jans-auth-server/docs/swagger.yaml#/authorize-challenge).
...
More details in [Authorization Challenge Custom Script Page](https://docs.jans.io/v2.4.0/script-catalog/authorization_challenge/authorization-challenge/index.md)

Full sample script can be found [here](https://docs.jans.io/v2.4.0/script-catalog/authorization_challenge/AuthorizationChallenge.java)
...
Full multi-step sample script can be found [here](https://docs.jans.io/v2.4.0/script-catalog/authorization_challenge/multi_step/AuthorizationChallenge.java)
