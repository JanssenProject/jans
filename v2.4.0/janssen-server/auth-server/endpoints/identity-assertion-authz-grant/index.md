...
When the feature flag is enabled, the following fields appear in the [OpenID Configuration](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/configuration/index.md) (`/.well-known/openid-configuration`):
...
- [Token endpoint](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/token/index.md)
- [Feature flags](https://docs.jans.io/v2.4.0/janssen-server/reference/json/feature-flags/janssenauthserver-feature-flags/index.md)
- [OAuth transaction tokens](https://docs.jans.io/v2.4.0/janssen-server/auth-server/tokens/oauth-tx-tokens/index.md)
