...
URL to access archived jwks endpoint on Janssen Server is listed in the response of Janssen Server's well-known [configuration endpoint](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/configuration/index.md) given below.
...
Archived JWKs endpoint can be further configured using Janssen Server configuration properties listed below. When using [Janssen Text-based UI(TUI)](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/jans-tui/index.md) to configure the properties, navigate via `Auth Server`->`Properties`.

- [archivedJwksUri](https://docs.jans.io/v2.4.0/janssen-server/reference/json/properties/janssenauthserver-properties/#jwksuri)
- [archivedJwkLifetimeInSeconds](https://docs.jans.io/v2.4.0/janssen-server/reference/json/properties/janssenauthserver-properties/#archivedjwklifetimeinseconds)
