...
URL to access jwks endpoint on Janssen Server is listed in the response of Janssen Server's well-known [configuration endpoint](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/configuration/index.md) given below.
...
- [jwksUri](https://docs.jans.io/v2.4.0/janssen-server/reference/json/properties/janssenauthserver-properties/#jwksuri)
- [jwksAlgorithmsSupported](https://docs.jans.io/v2.4.0/janssen-server/reference/json/properties/janssenauthserver-properties/#jwksalgorithmssupported)
- [mtlsJwksUri](https://docs.jans.io/v2.4.0/janssen-server/reference/json/properties/janssenauthserver-properties/#mtlsjwksuri)
