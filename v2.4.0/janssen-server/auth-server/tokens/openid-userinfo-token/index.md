...
If you need to call an API to render scopes or scope values on the fly, you should see the [Dynamic Scopes](https://docs.jans.io/v2.4.0/script-catalog/dynamic_scope/dynamic-scope/index.md) interception script.
