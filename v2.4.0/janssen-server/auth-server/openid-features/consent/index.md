...
- Authorization endpoint behavior in Janssen: [Authorization Endpoint](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/authorization/index.md)
...
Casa's [consent management plugin](https://docs.jans.io/v2.4.0/casa/plugins/consent-management/index.md) gives end-users the ability to view and revoke previously granted authorizations provided to applications accessed with their account in a Janssen Server.
...
- [Consent Gathering (planning context)](https://docs.jans.io/v2.4.0/janssen-server/planning/use-cases/index.md)
- [Config API overview](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/config-api/index.md)
...
Refer to [Consent Gathering](https://docs.jans.io/v2.4.0/script-catalog/consent_gathering/consent-gathering/index.md) for implementation details and examples.
...
- [Prompt Parameter](https://docs.jans.io/v2.4.0/janssen-server/auth-server/openid-features/prompt-parameter/index.md)
