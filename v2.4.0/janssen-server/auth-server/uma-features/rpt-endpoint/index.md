...
For more information about RPT usage, permission upgrades, and UMA-related configuration properties, see the [UMA RPT Token](https://docs.jans.io/v2.4.0/janssen-server/auth-server/tokens/uma-rpt-token/index.md).
