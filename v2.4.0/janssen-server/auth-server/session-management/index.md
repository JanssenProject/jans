...
The [End Session endpoint](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/end-session/index.md) (`/end_session`) is where the user can end their own session. See [OpenID Logout](https://docs.jans.io/v2.4.0/janssen-server/auth-server/openid-features/logout/index.md) for more information.

To end another person's session, Jans Auth Server supports [Global Token Revocation Endpoint](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/global-token-revocation/index.md) (`/global-token-revocation`').
...
Follow [this link](https://docs.jans.io/v2.4.0/janssen-server/config-guide/auth-server-config/session-management/index.md) for session management with configuration tools.
