...
For more information and implementation details please check [PAR Endpoint documentation](https://docs.jans.io/v2.4.0/janssen-server/auth-server/endpoints/par/index.md)
