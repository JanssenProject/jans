...
> For SPIFFE-workload client certificates (X.509-SVIDs), see [SPIFFE-Based Client Authentication](https://docs.jans.io/v2.4.0/janssen-server/auth-server/oauth-features/spiffe-client-auth/index.md), which builds on the `tls_client_auth` setup described below.
