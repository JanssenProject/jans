...
Main structure of which defines [standard logs](https://docs.jans.io/v2.4.0/janssen-server/auth-server/logging/standard-logs/index.md) and which can be overwritten by specifying own custom [log4j2.xml](https://docs.jans.io/v2.4.0/janssen-server/auth-server/logging/custom-logs/index.md).
