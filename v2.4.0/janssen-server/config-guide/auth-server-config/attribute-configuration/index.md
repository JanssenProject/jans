...
[Restart](https://docs.jans.io/v2.4.0/janssen-server/vm-ops/jans-command/#restart) the Janssen services below in order to make this change effective:
...
Close and reopen the TUI. The new custom user claim can now be added to any user from [user management](https://docs.jans.io/v2.4.0/janssen-server/usermgmt/usermgmt-cli-tui/index.md).
...
Janssen Server Configuration REST API exposes relevant endpoints for managing and configuring the user claim. Endpoint details are published in the [Swagger document](https://docs.jans.io/v2.4.0/janssen-server/reference/openapi/index.md).
