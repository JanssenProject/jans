...
Navigate to **Auth - Session Management** for other endpoints of managing sessions in config-api [swagger file](https://raw.githubusercontent.com/JanssenProject/jans/v2.4.0/jans-config-api/docs/jans-config-api-swagger.yaml).
