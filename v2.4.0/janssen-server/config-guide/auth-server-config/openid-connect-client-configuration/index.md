...
Janssen Server Configuration REST API exposes relevant endpoints for managing and configuring the OpenID Connect Client. Endpoint details are published in the [Swagger document](https://docs.jans.io/v2.4.0/janssen-server/reference/openapi/index.md).
