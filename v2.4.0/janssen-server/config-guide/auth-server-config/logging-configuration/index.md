...
Janssen Server Configuration REST API exposes relevant endpoints for managing and configuring logging. Endpoint details are published in the [Swagger document](https://docs.jans.io/v2.4.0/janssen-server/reference/openapi/index.md).
...
Logging configuration for a cloud-native deployment is [detailed here](https://docs.jans.io/v2.4.0/janssen-server/kubernetes-ops/logs/index.md)
