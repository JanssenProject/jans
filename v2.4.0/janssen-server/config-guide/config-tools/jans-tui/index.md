...
By using this line, you can create user via `jans-config.py`, [see for example](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/jans-tui/using-command-line-log/index.md)
