...
Janssen Config API has [REST endpoints](https://gluu.org/swagger-ui/?url=https://raw.githubusercontent.com/JanssenProject/jans/v2.4.0/jans-config-api/docs/jans-config-api-swagger.yaml) and can be invoked using curl.
...
- Refer to [API documentation](https://gluu.org/swagger-ui/?url=https://raw.githubusercontent.com/JanssenProject/jans/v2.4.0/jans-config-api/docs/jans-config-api-swagger.yaml) to know the endpoint path and required OAuth scopes to access that endpoint. Example: Attribute Endpoint.
