...
Application log can be verified if application is started properly. [Refer here](https://docs.jans.io/v2.4.0/janssen-server/config-guide/config-tools/config-api/logs/index.md) for more details.
