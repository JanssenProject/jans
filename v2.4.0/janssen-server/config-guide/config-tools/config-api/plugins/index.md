...
[Jans Config Api](https://github.com/JanssenProject/jans/tree/v2.4.0/jans-config-api) is a REST application that is developed using Weld 4.x (JSR-365) and JAX-RS. Its endpoint can be used to manage configuration and other properties of [Jans Auth Server](https://github.com/JanssenProject/jans/tree/v2.4.0/jans-auth-server).
