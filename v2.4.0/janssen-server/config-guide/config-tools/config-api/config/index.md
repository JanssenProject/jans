...
Janssen Server Configuration REST API exposes relevant endpoints for managing and configuring the Config-API Configuration. Endpoint details are published in the [Swagger document](https://docs.jans.io/v2.4.0/janssen-server/reference/openapi/index.md), see endpoint `/api/v1/api-config`
