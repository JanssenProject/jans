...
Support additional hashing methods can be added with [Persistence Extension](https://docs.jans.io/v2.4.0/script-catalog/persistence_extension/persistence/#persistence-script) script.
