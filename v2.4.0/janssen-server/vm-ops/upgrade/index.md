...
Let's assume we are upgrading Jans VM installation from `current version` to `v2.4.0`

1. Keep the old VM installation running.

1. [Install](https://docs.jans.io/v2.4.0/janssen-server/install/vm-install/index.md) on a separate VM the target new Jans installation, i.e. `v2.4.0`.
...
1. Use our Terraform [docs](https://docs.jans.io/v2.4.0/janssen-server/terraform/index.md) on the new installation, i.e. `v2.4.0` to:
...
1. At this point there should be two versions up, `old version` and `v2.4.0`.
