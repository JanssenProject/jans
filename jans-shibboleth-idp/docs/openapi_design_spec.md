...
- [ ] **Set SAML2 Artifact Resolution profile** — `PUT /trust-relationships/{id}/profiles/saml2-artifact-resolution` — `updateSaml2ArtifactResolutionProfileConfiguration`.
- [ ] **Set SAML2 ECP profile** — `PUT /trust-relationships/{id}/profiles/saml2-ecp` — `updateSaml2EcpProfileConfiguration`.
- [ ] **Set SAML2 Logout profile** — `PUT /trust-relationships/{id}/profiles/saml2-logout` — `updateSaml2LogoutProfileConfiguration`.
