...
/**
 * Read view of a trust relationship's SAML2 SSO profile configuration.
 */
public class Saml2SsoProfileConfigurationView {
    ...
    public Saml2SsoProfileConfigurationView() {
    }
