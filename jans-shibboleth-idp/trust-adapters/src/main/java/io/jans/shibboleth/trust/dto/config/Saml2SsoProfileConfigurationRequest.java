...
/**
 * Partial update of a trust relationship's SAML2 SSO profile configuration — the fullest profile.
 * Every field is optional; only the fields present in the request are changed, the rest keep their
 * current values. {@code max_authentication_age}, {@code assertion_lifetime} and
 * {@code maximum_sp_session_lifetime} are ISO-8601 duration strings. A dumb data holder — unknown
 * properties are rejected.
 */
@JsonIgnoreProperties(ignoreUnknown = false)
public class Saml2SsoProfileConfigurationRequest {
    ...
    public Saml2SsoProfileConfigurationRequest() {
    }
    ...
    public boolean equals(Object o) {
        ...
        Saml2SsoProfileConfigurationRequest that = (Saml2SsoProfileConfigurationRequest) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(status, inboundFlows, outboundFlows, postAuthenticationFlows,
            ...
            assertionEncryptionPolicy, attributeEncryptionPolicy, maximumSpSessionLifetime,
            endpointValidationPolicy, attributeStatementPolicy, friendlyNameRandomizationPolicy,
            nameIdFormatPrecedence, requestSigningRequirement);
    }

    @Override
    public String toString() {

        return "Saml2SsoProfileConfigurationRequest{status=" + status
