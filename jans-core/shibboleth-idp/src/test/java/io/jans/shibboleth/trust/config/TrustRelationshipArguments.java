 ...
 * Referenced from {@code @MethodSource("io.jans.shibboleth.trust.config.TrustRelationshipArguments#...")}.
 */
public final class TrustRelationshipArguments {
    ...
    public static Stream<Arguments> creationParametersWithValidValues() {
        ...
        var individualTrDisplayName = io.jans.shibboleth.trust.config.DisplayName.of("IndividualTR").getValue();
        var aggregateTrDisplayName  = io.jans.shibboleth.trust.config.DisplayName.of("AggregateTR").getValue();
    ...
    public static Stream<Arguments> creationParametersWithNullValuesAndMissingFieldNames() {
        ...
        var displayName = io.jans.shibboleth.trust.config.DisplayName.of("SomeTR").getValue();
