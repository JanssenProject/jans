...
public class WorkItemStateMachineTests {
    ...
    @ParameterizedTest
    @MethodSource("io.jans.shibboleth.activation.model.WorkItemStateMachineTests#terminalWorkItems")
    ...
    @ParameterizedTest
    @MethodSource("io.jans.shibboleth.activation.model.WorkItemStateMachineTests#nonAssignedWorkItems")
    ...
    @ParameterizedTest
    @MethodSource("io.jans.shibboleth.activation.model.WorkItemStateMachineTests#allStateWorkItems")
