...
public class LeaseTests {
    ...
    private static final WorkerId WORKER = WorkerId.of(Origin.of("instance@host"));
    ...
    public void shouldExposeHolderAndWindow_whenLeaseGranted() {
        ...
        Lease lease = Lease.granted(WORKER, GRANTED_AT, EXPIRES_AT);
    ...
    public void shouldReturnNewLeaseAndLeaveOriginalUnchanged_whenRenewed() {
        ...
        Lease original = Lease.granted(WORKER, GRANTED_AT, EXPIRES_AT);
        Instant laterExpiry = EXPIRES_AT.plusSeconds(30);

        Lease renewed = original.renew(laterExpiry);
