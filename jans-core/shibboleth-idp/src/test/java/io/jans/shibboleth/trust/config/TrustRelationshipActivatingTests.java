...
public class TrustRelationshipActivatingTests {
    ...
    @ParameterizedTest
    @MethodSource("io.jans.shibboleth.trust.config.TrustRelationshipArguments#aggregateTrustRelationshipsNotInActivatingState")
    @DisplayName(
    ...
    @ParameterizedTest
    @MethodSource("io.jans.shibboleth.trust.config.TrustRelationshipArguments#individualTrustRelationshipsInMultipleStates")
    @DisplayName(
    ...
    @ParameterizedTest
    @MethodSource("io.jans.shibboleth.trust.config.TrustRelationshipArguments#activatingTrustRelationshipsOfAllNaturesWithSupportedMetadataSources")
    @DisplayName(
        "GIVEN an ACTIVATING TrustRelationship " + 
    ...
    @ParameterizedTest
    @MethodSource("io.jans.shibboleth.trust.config.TrustRelationshipArguments#activatingTrustRelationshipsWithProfileConfigurations")
    @DisplayName(
        "GIVEN an ACTIVATING TrustRelationship " +
    ...
    @ParameterizedTest
    @MethodSource("io.jans.shibboleth.trust.config.TrustRelationshipArguments#trustRelationshipsOfAllNaturesNotInActivatingState")
    @DisplayName(
    ...
    @Test
    @MethodSource("io.jans.shibboleth.trust.config.TrustRelationshipFixtures#sampleActivatingIndividualTrustRelationship")
    @DisplayName(
