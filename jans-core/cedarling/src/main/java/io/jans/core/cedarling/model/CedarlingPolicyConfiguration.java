...
import io.jans.core.cedarling.model.Configuration;
import io.swagger.v3.oas.annotations.media.Schema;
import jakarta.enterprise.inject.Vetoed;

/**
 * Janssen Project Policy configuration
 *
...
public class CedarlingPolicyConfiguration implements Configuration {
	...
	@DocProperty(description = "Cedarling policy store")
	@Schema(description = "Cedarling policy store")
