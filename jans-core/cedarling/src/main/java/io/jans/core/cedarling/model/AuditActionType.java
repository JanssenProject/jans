...
public enum AuditActionType {
    ...
    GRPC_AUTHZ_FILTER("GRPC_AUTHZ_FILTER"),
    ...
    TRACE_RECORD_READ("TRACE_RECORD_READ"),
    TRACE_EXECUTION_READ("TRACE_EXECUTION_READ"),
    TRACE_ADMIN_KEY_WRITE("TRACE_ADMIN_KEY_WRITE"),
    TRACE_ADMIN_KEY_READ("TRACE_ADMIN_KEY_READ"),
    TRACE_ADMIN_CHAIN_WRITE("TRACE_ADMIN_CHAIN_WRITE"),
    TRACE_ADMIN_CHAIN_READ("TRACE_ADMIN_CHAIN_READ")
    ;
