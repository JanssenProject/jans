...
class ConfigApiInstaller(JettyInstaller):
    ...
    source_files = [
                ...
                (os.path.join(Config.dist_jans_dir, 'saml-plugin.jar'), os.path.join(base.current_app.app_info['JANS_MAVEN'], 'maven/io/jans/jans-config-api/plugins/saml-plugin/{0}/saml-plugin-{0}-distribution.jar').format(base.current_app.app_info['ox_version'])),
                ]
