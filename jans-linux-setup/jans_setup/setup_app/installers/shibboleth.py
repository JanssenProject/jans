...
class ShibbolethInstaller(JettyInstaller):
    ...
    def jetty_app_configuration(self):
        return {
            self.service_name: {
                'memory': {'max_allowed_mb': 1024, 'metaspace_mb': 128, 'jvm_heap_ration': 0.7, 'min_jvm_heap_mem': 256},
                'jetty': {'modules': 'server,deploy,webapp,http,resources,http-forwarded,console-capture,ee10-webapp,ee10-deploy'},
                'installed': False,
