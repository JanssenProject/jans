...
public class CouchbaseFilterConverterTest {
	...
	public void checkEqFilters() throws SearchException {
		...
		assertEquals(queryEq4, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE ( ( added = \"2020-12-16T14:58:18.398Z\" ) OR ( \"2020-12-16T14:58:18.398Z\" IN added ) )");
	}
	...
	public void checkMultivaluedEqFilters() throws SearchException {
		...
		assertEquals(queryEq4, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE ANY added_ IN added SATISFIES added_ = \"2020-12-16T14:58:18.398Z\" END");
	}
	...
	public void checkSinglevaluedEqFilters() throws SearchException {
		...
		assertEquals(queryEq4, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE added = \"2020-12-16T14:58:18.398Z\"");
	}
	...
	public void checkLeFilters() throws SearchException {
		...
		assertEquals(queryLe4, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE added <= \"2020-12-16T14:58:18.398Z\"");
	}
	...
	public void checkMultivaluedLeFilters() throws SearchException {
		...
		assertEquals(queryLe4, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE ANY added_ IN added SATISFIES added_ <= \"2020-12-16T14:58:18.398Z\" END");
		...
		assertEquals(queryLe5, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE ANY added_ IN added SATISFIES added_ <= \"2020-12-16T14:58:18.398Z\" END");
	}
	...
	public void checkGeFilters() throws SearchException {
		...
		assertEquals(queryGe4, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE added >= \"2020-12-16T14:58:18.398Z\"");
	}
	...
	public void checkMultivaluedGeFilters() throws SearchException {
		...
		assertEquals(queryGe4, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE ANY added_ IN added SATISFIES added_ >= \"2020-12-16T14:58:18.398Z\" END");
		...
		assertEquals(queryGe5, "SELECT jans_doc.* FROM `jans` AS jans_doc WHERE ANY added_ IN added SATISFIES added_ >= \"2020-12-16T14:58:18.398Z\" END");
	}
	...
	private String toSelectSQL(ConvertedExpression convertedExpression) {
		String select = String.format("SELECT jans_doc.* FROM `jans` AS jans_doc WHERE %s", convertedExpression.expression());
