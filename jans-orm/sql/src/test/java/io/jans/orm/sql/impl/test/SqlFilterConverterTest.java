...
//		this.sqlTemplates = MySQLTemplates.builder().printSchema().build();
	...
	public void checkMultivaluedEqFilters() throws SearchException {
		...
		String queryEq2 = toSelectSQL(expressionEq2);
		assertEquals(queryEq2, "select doc.`*` from `table` as doc where JSON_CONTAINS(doc.age->>'$', CAST('[23]' AS JSON))");
		...
		String queryEq3 = toSelectSQL(expressionEq3);
		assertEquals(queryEq3, "select doc.`*` from `table` as doc where JSON_CONTAINS(doc.age->>'$', CAST('[23]' AS JSON))");
		...
		String queryEq4 = toSelectSQL(expressionEq4);
		assertEquals(queryEq4, "select doc.`*` from `table` as doc where JSON_CONTAINS(doc.added->>'$', CAST('[\"2020-12-16T14:58:18.398\"]' AS JSON))");
	}
	...
	public void checkMultivaluedLeFilters() throws SearchException {
		...
		String queryLe2 = toSelectSQL(expressionLe2);
		assertEquals(queryLe2, "select doc.`*` from `table` as doc where doc.age->>'$[0]' <= 23");
		...
		String queryLe3 = toSelectSQL(expressionLe3);
		assertEquals(queryLe3, "select doc.`*` from `table` as doc where doc.age->>'$[0]' <= 23");
		...
		String queryLe4 = toSelectSQL(expressionLe4);
		assertEquals(queryLe4, "select doc.`*` from `table` as doc where doc.added->>'$[0]' <= (timestamp '2020-12-16 14:58:18')");
		...
		assertEquals(queryLe5, "select doc.`*` from `table` as doc where doc.added->>'$[0]' <= (timestamp '2020-12-16 14:58:18') or doc.added->>'$[1]' <= (timestamp '2020-12-16 14:58:18') or doc.added->>'$[2]' <= (timestamp '2020-12-16 14:58:18')");
	}
	...
	public void checkMultivaluedGeFilters() throws SearchException {
		...
		String queryGe2 = toSelectSQL(expressionGe2);
		assertEquals(queryGe2, "select doc.`*` from `table` as doc where doc.age->>'$[0]' >= 23");
		...
		String queryGe3 = toSelectSQL(expressionGe3);
		assertEquals(queryGe3, "select doc.`*` from `table` as doc where doc.age->>'$[0]' >= 23");
		...
		String queryGe4 = toSelectSQL(expressionGe4);
		assertEquals(queryGe4, "select doc.`*` from `table` as doc where doc.added->>'$[0]' >= (timestamp '2020-12-16 14:58:18')");
		...
		assertEquals(queryGe5, "select doc.`*` from `table` as doc where doc.added->>'$[0]' >= (timestamp '2020-12-16 14:58:18') or doc.added->>'$[1]' >= (timestamp '2020-12-16 14:58:18') or doc.added->>'$[2]' >= (timestamp '2020-12-16 14:58:18')");
	}
	...
	public void checkMultivaluedPresenceFilters() throws SearchException {
		...
		assertEquals(queryPresence2, "select doc.`*` from `table` as doc where doc.uid->>'$[0]' is not null or doc.uid->>'$[1]' is not null or doc.uid->>'$[2]' is not null");
	}
	...
	public void checkMultivaluedSubFilters() throws SearchException {
		...
		String querySub2 = toSelectSQL(expressionSub2);
		assertEquals(querySub2, "select doc.`*` from `table` as doc where doc.uid->>'$[0]' like 'a%test%'");

		Filter filterSub3 = Filter.createSubstringFilter("uid", null, new String[] { "test" }, "z").multiValued();
		ConvertedExpression expressionSub3 = simpleConverter.convertToSqlFilter(null, filterSub3, null);

		String querySub3 = toSelectSQL(expressionSub3);
		assertEquals(querySub3, "select doc.`*` from `table` as doc where doc.uid->>'$[0]' like '%test%z'");
		...
		assertEquals(querySub4, "select doc.`*` from `table` as doc where doc.uid->>'$[0]' like '%test%z' or doc.uid->>'$[1]' like '%test%z' or doc.uid->>'$[2]' like '%test%z'");
	}
	...
	public void checkMultivaluedSubWithLowerFilters() throws SearchException {
		...
		String querySub1 = toSelectSQL(expressionSub1);
		assertEquals(querySub1, "select doc.`*` from `table` as doc where lower(doc.uid)->>'$[0]' like '%test%'");

		Filter filterSub2 = Filter.createSubstringFilter(Filter.createLowercaseFilter("uid"), "a", new String[] { "test" }, null).multiValued();
		ConvertedExpression expressionSub2 = simpleConverter.convertToSqlFilter(null, filterSub2, null);

		String querySub2 = toSelectSQL(expressionSub2);
		assertEquals(querySub2, "select doc.`*` from `table` as doc where lower(doc.uid)->>'$[0]' like 'a%test%'");

		Filter filterSub3 = Filter.createSubstringFilter(Filter.createLowercaseFilter("uid"), null, new String[] { "test" }, "z").multiValued();
		ConvertedExpression expressionSub3 = simpleConverter.convertToSqlFilter(null, filterSub3, null);

		String querySub3 = toSelectSQL(expressionSub3);
		assertEquals(querySub3, "select doc.`*` from `table` as doc where lower(doc.uid)->>'$[0]' like '%test%z'");

		Filter filterSub4 = Filter.createSubstringFilter(Filter.createLowercaseFilter("uid"), null, new String[] { "test" }, "z").multiValued(3);
		ConvertedExpression expressionSub4 = simpleConverter.convertToSqlFilter(null, filterSub4, null);

		String querySub4 = toSelectSQL(expressionSub4);
		assertEquals(querySub4, "select doc.`*` from `table` as doc where lower(doc.uid)->>'$[0]' like '%test%z' or lower(doc.uid)->>'$[1]' like '%test%z' or lower(doc.uid)->>'$[2]' like '%test%z'");
	}
