...
public final @Data class ApplicationConfiguration implements Serializable {
	...
	public void setSchemaAddObjectClassWithoutAttributeTypesDefinition(String schemaAddObjectClassWithoutAttributeTypesDefinition) {
	...
	public void setSchemaAddObjectClassWithAttributeTypesDefinition(String schemaAddObjectClassWithAttributeTypesDefinition) {
	...
	public void setSchemaAddAttributeDefinition(String schemaAddAttributeDefinition) {
	...
	public void setShibboleth2FederationRootDir(String shibboleth2FederationRootDir) {
