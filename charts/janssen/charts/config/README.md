...
![Version: 1.0.5-dev](https://img.shields.io/badge/Version-1.0.5--dev-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.5-dev](https://img.shields.io/badge/AppVersion-1.0.5--dev-informational?style=flat-square)
...
| image.tag | string | `"1.0.5_dev"` | Image  tag to use for deploying. |
