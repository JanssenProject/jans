...
{{/*
    Common labels
*/}}
{{- define "cache-refresh.labels" -}}
app: {{ .Release.Name }}-{{ include "cache-refresh.name" . }}
helm.sh/chart: {{ include "cache-refresh.chart" . }}
...
*/}}
{{- define "cache-refresh.usr-secret-envs"}}
...
*/}}
{{- define "cache-refresh.topology-spread-constraints"}}
