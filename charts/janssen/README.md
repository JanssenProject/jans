...
![Version: 1.0.21-dev](https://img.shields.io/badge/Version-1.0.21--dev-informational?style=flat-square) ![AppVersion: 1.0.21-dev](https://img.shields.io/badge/AppVersion-1.0.21--dev-informational?style=flat-square)
...
|------------|------|---------|
|  | auth-server | 1.0.21-dev |
|  | auth-server-key-rotation | 1.0.21-dev |
|  | casa | 1.0.21-dev |
|  | config | 1.0.21-dev |
|  | config-api | 1.0.21-dev |
|  | fido2 | 1.0.21-dev |
|  | link | 1.0.21-dev |
|  | nginx-ingress | 1.0.21-dev |
|  | opendj | 1.0.21-dev |
|  | persistence | 1.0.21-dev |
|  | scim | 1.0.21-dev |
...
| link.image.tag | string | `"1.0.21_dev"` | Image  tag to use for deploying. |
