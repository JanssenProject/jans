...
| auth-server-key-rotation.image.tag | string | `"1.0.1_dev"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.0.1_dev"` | Image  tag to use for deploying. |
...
| client-api.image.tag | string | `"1.0.1_dev"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.1_dev"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.0.1_dev"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.1_dev"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"janssenproject/persistence-loader","tag":"1.0.1_dev"},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and intial config for Janssen Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.1_dev"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.1_dev"` | Image  tag to use for deploying. |
