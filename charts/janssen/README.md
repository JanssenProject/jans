...
| global.auth-server.appLoggers.lockLogTarget | string | `"FILE"` | jans-lock.log target |
...
| global.auth-server.ingress.lockAuditEnabled | bool | `false` | Enabled endpoint /io.jans.lock.audit.AuditService |
