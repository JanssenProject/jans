...
![Version: 1.0.5](https://img.shields.io/badge/Version-1.0.5-informational?style=flat-square) ![AppVersion: 1.0.5-dev](https://img.shields.io/badge/AppVersion-1.0.5--dev-informational?style=flat-square)
...
|------------|------|---------|
|  | auth-server | 1.0.5 |
|  | auth-server-key-rotation | 1.0.5 |
|  | config | 1.0.5 |
|  | config-api | 1.0.5 |
|  | fido2 | 1.0.5 |
|  | nginx-ingress | 1.0.5 |
