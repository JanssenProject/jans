...
|------------|------|---------|
|  | auth-server | 2.4.0 |
|  | auth-server-key-rotation | 2.4.0 |
|  | casa | 2.4.0 |
|  | cleanup | 2.4.0 |
|  | cn-istio-ingress | 2.4.0 |
|  | config | 2.4.0 |
|  | config-api | 2.4.0 |
|  | fido2 | 2.4.0 |
|  | gateway-api | 2.4.0 |
...
| auth-server-key-rotation.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"2.4.0"},"interval":60,"lifecycle":{},"limit":1000,"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| cleanup.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| gateway-api.additionalConfig.nginx | object | `{"enableAuditGrpcRewriteSnippets":false}` | Configuration for NGINX Fabric. |
...
| global.config-api.plugins | string | `"fido2,scim,user-mgt"` | Comma-separated values of enabled plugins (supported plugins are "admin-ui","fido2","scim","user-mgt") |
...
| global.gateway-api.enabled | bool | `false` | Boolean flag to enable/disable the Kubernetes Gateway API support (if enabled, make sure the ingress is disabled). |
...
| global.shibboleth-idp.appLoggers | object | `{"enableStdoutLogPrefix":"true","shibbolethLogLevel":"INFO","shibbolethLogTarget":"STDOUT"}` | App loggers for Shibboleth IDP |
| global.shibboleth-idp.customAnnotations | object | `{"deployment":{},"destinationRule":{},"horizontalPodAutoscaler":{},"pod":{},"podDisruptionBudget":{},"secret":{},"service":{},"virtualService":{}}` | Custom annotations for kubernetes resources for the service |
| global.shibboleth-idp.enabled | bool | `false` | Boolean flag to enable/disable the Shibboleth IDP chart. |
| global.shibboleth-idp.ingress | object | `{"shibbolethIdpAdditionalAnnotations":{},"shibbolethIdpEnabled":true,"shibbolethIdpLabels":{}}` | Enable Shibboleth IDP ingress |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"2.4.0"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Janssen Server persistence layer. |
...
| persistence.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"2.4.0"` | Image  tag to use for deploying. |
...
| shibboleth-idp | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","hpa":{"behavior":{},"enabled":false,"maxReplicas":10,"metrics":[],"minReplicas":1,"targetCPUUtilizationPercentage":80},"image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/shibboleth","tag":"2.4.0"},"lifecycle":{},"livenessProbe":{"httpGet":{"path":"/idp/status","port":8080},"initialDelaySeconds":60,"periodSeconds":30,"timeoutSeconds":5},"nodeSelector":{},"pdb":{"enabled":true,"maxUnavailable":"90%"},"readinessProbe":{"httpGet":{"path":"/idp/status","port":8080},"initialDelaySeconds":30,"periodSeconds":10,"timeoutSeconds":5},"replicaCount":1,"resources":{"limits":{"cpu":"2000m","memory":"1024Mi"},"requests":{"cpu":"500m","memory":"512Mi"}},"shibboleth":{"encryptionKeyAlias":"idp-encryption","entityId":"","jansAuth":{"clientId":"","enabled":true,"redirectUri":"","scopes":"openid,profile,email"},"scope":"","signingKeyAlias":"idp-signing"},"tolerations":[],"topologySpreadConstraints":{},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Shibboleth Identity Provider 5.1.6 for SAML SSO |
| shibboleth-idp.additionalAnnotations | object | `{}` | Additional annotations |
| shibboleth-idp.additionalLabels | object | `{}` | Additional labels |
| shibboleth-idp.customCommand | list | `[]` | Add custom command override |
| shibboleth-idp.customScripts | list | `[]` | Add custom scripts that run before the entrypoint |
| shibboleth-idp.dnsConfig | object | `{}` | Add custom dns config |
| shibboleth-idp.dnsPolicy | string | `""` | Add custom dns policy |
| shibboleth-idp.hpa | object | `{"behavior":{},"enabled":false,"maxReplicas":10,"metrics":[],"minReplicas":1,"targetCPUUtilizationPercentage":80}` | Configure the HorizontalPodAutoscaler |
| shibboleth-idp.image.pullPolicy | string | `"IfNotPresent"` | Image pullPolicy to use for deploying. |
| shibboleth-idp.image.pullSecrets | list | `[]` | Image Pull Secrets |
| shibboleth-idp.image.repository | string | `"ghcr.io/janssenproject/jans/shibboleth"` | Image to use for deploying. |
| shibboleth-idp.image.tag | string | `"2.4.0"` | Image tag to use for deploying. |
| shibboleth-idp.lifecycle | object | `{}` | Actions on lifecycle events |
| shibboleth-idp.livenessProbe | object | `{"httpGet":{"path":"/idp/status","port":8080},"initialDelaySeconds":60,"periodSeconds":30,"timeoutSeconds":5}` | Configure the liveness healthcheck |
| shibboleth-idp.nodeSelector | object | `{}` | Add nodeSelector |
| shibboleth-idp.pdb | object | `{"enabled":true,"maxUnavailable":"90%"}` | Configure the PodDisruptionBudget |
| shibboleth-idp.readinessProbe | object | `{"httpGet":{"path":"/idp/status","port":8080},"initialDelaySeconds":30,"periodSeconds":10,"timeoutSeconds":5}` | Configure the readiness healthcheck |
| shibboleth-idp.replicaCount | int | `1` | Service replica number. |
| shibboleth-idp.resources | object | `{"limits":{"cpu":"2000m","memory":"1024Mi"},"requests":{"cpu":"500m","memory":"512Mi"}}` | Resource specs. |
| shibboleth-idp.shibboleth | object | `{"encryptionKeyAlias":"idp-encryption","entityId":"","jansAuth":{"clientId":"","enabled":true,"redirectUri":"","scopes":"openid,profile,email"},"scope":"","signingKeyAlias":"idp-signing"}` | Shibboleth IDP specific configuration |
| shibboleth-idp.shibboleth.encryptionKeyAlias | string | `"idp-encryption"` | Encryption key alias in keystore |
| shibboleth-idp.shibboleth.entityId | string | `""` | IDP entity ID (defaults to https://<hostname>/idp/shibboleth) |
| shibboleth-idp.shibboleth.jansAuth | object | `{"clientId":"","enabled":true,"redirectUri":"","scopes":"openid,profile,email"}` | Janssen Auth Server integration |
| shibboleth-idp.shibboleth.jansAuth.clientId | string | `""` | OAuth client ID for Shibboleth IDP |
| shibboleth-idp.shibboleth.jansAuth.enabled | bool | `true` | Enable Janssen Auth integration for authentication |
| shibboleth-idp.shibboleth.jansAuth.redirectUri | string | `""` | OAuth redirect URI |
| shibboleth-idp.shibboleth.jansAuth.scopes | string | `"openid,profile,email"` | OAuth scopes to request |
| shibboleth-idp.shibboleth.scope | string | `""` | IDP scope for attribute release |
| shibboleth-idp.shibboleth.signingKeyAlias | string | `"idp-signing"` | Signing key alias in keystore |
| shibboleth-idp.tolerations | list | `[]` | Add tolerations for the pods |
| shibboleth-idp.topologySpreadConstraints | object | `{}` | Configure the topology spread constraints |
| shibboleth-idp.usrEnvs | object | `{"normal":{},"secret":{}}` | Add custom normal and secret envs to the service |
| shibboleth-idp.volumeMounts | list | `[]` | Configure any additional volumesMounts |
| shibboleth-idp.volumes | list | `[]` | Configure any additional volumes |
