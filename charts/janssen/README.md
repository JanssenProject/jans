...
|------------|------|---------|
|  | auth-server | 1.0.2 |
|  | auth-server-key-rotation | 1.0.2 |
|  | client-api | 1.0.2 |
|  | config | 1.0.2 |
|  | config-api | 1.0.2 |
|  | fido2 | 1.0.2 |
