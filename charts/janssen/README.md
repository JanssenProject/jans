...
![Version: 1.0.12-dev](https://img.shields.io/badge/Version-1.0.12--dev-informational?style=flat-square) ![AppVersion: 1.0.12-dev](https://img.shields.io/badge/AppVersion-1.0.12--dev-informational?style=flat-square)
...
|------------|------|---------|
|  | auth-server | 1.0.12-dev |
|  | auth-server-key-rotation | 1.0.12-dev |
|  | config | 1.0.12-dev |
|  | config-api | 1.0.12-dev |
|  | fido2 | 1.0.12-dev |
|  | nginx-ingress | 1.0.12-dev |
|  | opendj | 1.0.12-dev |
|  | persistence | 1.0.12-dev |
|  | scim | 1.0.12-dev |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.0.12_dev"},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Janssen Server persistence layer. |
