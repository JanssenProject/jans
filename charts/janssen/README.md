...
|------------|------|---------|
|  | auth-server | 1.0.23-dev |
|  | auth-server-key-rotation | 1.0.23-dev |
|  | casa | 1.0.23-dev |
|  | config | 1.0.23-dev |
|  | config-api | 1.0.23-dev |
|  | fido2 | 1.0.23-dev |
|  | link | 1.0.23-dev |
|  | nginx-ingress | 1.0.23-dev |
|  | opendj | 1.0.23-dev |
|  | persistence | 1.0.23-dev |
|  | saml | 1.0.23-dev |
|  | scim | 1.0.23-dev |
...
| auth-server-key-rotation.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| link.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.0.23_dev"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Janssen Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| saml.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.23_dev"` | Image  tag to use for deploying. |
