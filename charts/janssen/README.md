...
|------------|------|---------|
|  | auth-server | 1.0.20-dev |
|  | auth-server-key-rotation | 1.0.20-dev |
|  | casa | 1.0.20-dev |
|  | config | 1.0.20-dev |
|  | config-api | 1.0.20-dev |
|  | fido2 | 1.0.20-dev |
|  | link | 1.0.20-dev |
|  | nginx-ingress | 1.0.20-dev |
|  | opendj | 1.0.20-dev |
|  | persistence | 1.0.20-dev |
|  | scim | 1.0.20-dev |
...
| auth-server-key-rotation | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/certmanager","tag":"1.0.20_dev"},"keysLife":48,"keysPushDelay":0,"keysPushStrategy":"NEWER","keysStrategy":"NEWER","lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Responsible for regenerating auth-keys per x hours |
...
| link.image.tag | string | `"1.0.20_dev"` | Image  tag to use for deploying. |
