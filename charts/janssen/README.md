...
![Version: 1.0.21](https://img.shields.io/badge/Version-1.0.21-informational?style=flat-square) ![AppVersion: 1.0.21](https://img.shields.io/badge/AppVersion-1.0.21-informational?style=flat-square)
...
|------------|------|---------|
|  | auth-server | 1.0.21 |
|  | auth-server-key-rotation | 1.0.21 |
|  | casa | 1.0.21 |
|  | config | 1.0.21 |
|  | config-api | 1.0.21 |
|  | fido2 | 1.0.21 |
|  | link | 1.0.21 |
|  | nginx-ingress | 1.0.21 |
|  | opendj | 1.0.21 |
|  | persistence | 1.0.21 |
|  | scim | 1.0.21 |
...
| auth-server-key-rotation.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
...
| link.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.0.21-4"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Janssen Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.21-4"` | Image  tag to use for deploying. |
