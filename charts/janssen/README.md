...
![Version: 1.0.3-dev](https://img.shields.io/badge/Version-1.0.3--dev-informational?style=flat-square)
...
| client-api.image.tag | string | `"1.0.3_dev"` | Image  tag to use for deploying. |
