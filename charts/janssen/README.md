...
|------------|------|---------|
|  | auth-server | 1.0.20 |
|  | auth-server-key-rotation | 1.0.20 |
|  | casa | 1.0.20 |
|  | config | 1.0.20 |
|  | config-api | 1.0.20 |
|  | fido2 | 1.0.20 |
|  | link | 1.0.20 |
|  | nginx-ingress | 1.0.20 |
|  | opendj | 1.0.20 |
|  | persistence | 1.0.20 |
|  | scim | 1.0.20 |
...
| auth-server.image.tag | string | `"1.0.20-1"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.0.20-1"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.20-1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.0.20-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.20-1"` | Image  tag to use for deploying. |
...
| link.image.tag | string | `"1.0.20-1"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.0.20-1"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Janssen Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.20-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.20-1"` | Image  tag to use for deploying. |
