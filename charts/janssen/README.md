...
|------------|------|---------|
|  | auth-server | 1.0.8 |
|  | auth-server-key-rotation | 1.0.8 |
|  | config | 1.0.8 |
|  | config-api | 1.0.8 |
|  | fido2 | 1.0.8 |
|  | nginx-ingress | 1.0.8 |
