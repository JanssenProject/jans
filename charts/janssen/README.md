...
|------------|------|---------|
|  | auth-server | 2.3.0 |
|  | auth-server-key-rotation | 2.3.0 |
|  | casa | 2.3.0 |
|  | cleanup | 2.3.0 |
|  | cn-istio-ingress | 2.3.0 |
|  | config | 2.3.0 |
|  | config-api | 2.3.0 |
|  | fido2 | 2.3.0 |
|  | gateway-api | 2.3.0 |
...
| auth-server-key-rotation.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"2.3.0"},"interval":60,"lifecycle":{},"limit":1000,"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| cleanup.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"2.3.0"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Janssen Server persistence layer. |
...
| persistence.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"2.3.0"` | Image  tag to use for deploying. |
...
| shibboleth-idp.image.tag | string | `"2.3.0"` | Image tag to use for deploying. |
