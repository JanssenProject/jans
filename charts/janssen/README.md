...
| global.link.appLoggers.linkLogLevel | string | `"INFO"` | jans-link.log level |
| global.link.appLoggers.linkLogTarget | string | `"STDOUT"` | jans-link.log target |
| global.link.appLoggers.persistenceDurationLogLevel | string | `"INFO"` | jans-link_persistence_duration.log level |
| global.link.appLoggers.persistenceDurationLogTarget | string | `"FILE"` | jans-link_persistence_duration.log target |
| global.link.appLoggers.persistenceLogLevel | string | `"INFO"` | jans-link_persistence.log level |
| global.link.appLoggers.persistenceLogTarget | string | `"FILE"` | jans-link_persistence.log target |
| global.link.appLoggers.scriptLogLevel | string | `"INFO"` | jans-link_script.log level |
| global.link.appLoggers.scriptLogTarget | string | `"FILE"` | jans-link_script.log target |
...
| keycloak-link.image.tag | string | `"1.6.0-1"` | Image  tag to use for deploying. |
