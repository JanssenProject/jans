...
| kc-scheduler.tolerations | list | `[{"effect":"NoExecute","key":"some_key","operator":"Equal","value":"some_value"}]` | Add tolerations for the pods |
