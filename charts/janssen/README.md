...
|------------|------|---------|
|  | auth-server | 1.0.4 |
|  | auth-server-key-rotation | 1.0.4 |
|  | config | 1.0.4 |
|  | config-api | 1.0.4 |
|  | fido2 | 1.0.4 |
|  | nginx-ingress | 1.0.4 |
