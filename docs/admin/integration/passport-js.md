...
1. You can add as many as possible passport strategies in your passport project. Above steps and configuration process are little complex, use [this sample code file](../../assets/sample-code-passport-js.js) to build your passport application.
