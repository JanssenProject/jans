...
10. Create [finish]() blocks
     ...
     The `Finish` block represents the [Flow finish](../../developer/agama/dsl-full.md#flow-finish) instruction of Agama DSL.
...
11. Check Generated code
    ...
    Agama Lab flow gets translated in [Agama DSL](../../developer/agama/dsl.md). Click the `Code` button to see the code
