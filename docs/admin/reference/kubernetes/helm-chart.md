...
|------------|------|---------|
|  | auth-server | 1.0.13 |
|  | auth-server-key-rotation | 1.0.13 |
|  | config | 1.0.13 |
|  | config-api | 1.0.13 |
|  | fido2 | 1.0.13 |
|  | nginx-ingress | 1.0.13 |
|  | opendj | 1.0.13 |
|  | persistence | 1.0.13 |
|  | scim | 1.0.13 |
