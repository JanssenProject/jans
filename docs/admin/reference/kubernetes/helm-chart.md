...
|------------|------|---------|
|  | auth-server | 1.0.12 |
|  | auth-server-key-rotation | 1.0.12 |
|  | config | 1.0.12 |
|  | config-api | 1.0.12 |
|  | fido2 | 1.0.12 |
|  | nginx-ingress | 1.0.12 |
|  | opendj | 1.0.12 |
|  | persistence | 1.0.12 |
|  | scim | 1.0.12 |
