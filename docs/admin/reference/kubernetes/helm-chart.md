...
|------------|------|---------|
|  | auth-server | 1.0.14 |
|  | auth-server-key-rotation | 1.0.14 |
|  | config | 1.0.14 |
|  | config-api | 1.0.14 |
|  | fido2 | 1.0.14 |
|  | nginx-ingress | 1.0.14 |
|  | opendj | 1.0.14 |
|  | persistence | 1.0.14 |
|  | scim | 1.0.14 |
