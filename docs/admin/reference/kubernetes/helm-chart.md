...
|------------|------|---------|
|  | auth-server | 1.0.17 |
|  | auth-server-key-rotation | 1.0.17 |
|  | config | 1.0.17 |
|  | config-api | 1.0.17 |
|  | fido2 | 1.0.17 |
|  | link | 1.0.17 |
|  | nginx-ingress | 1.0.17 |
|  | opendj | 1.0.17 |
|  | persistence | 1.0.17 |
|  | scim | 1.0.17 |
...
| auth-server-key-rotation | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/certmanager","tag":"1.0.17-1"},"keysLife":48,"keysPushDelay":0,"keysPushStrategy":"NEWER","keysStrategy":"NEWER","lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Responsible for regenerating auth-keys per x hours |
...
| auth-server-key-rotation.image.tag | string | `"1.0.17-1"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.0.17-1"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.17-1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.0.17-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.17-1"` | Image  tag to use for deploying. |
...
| link.image.tag | string | `"1.0.17-1"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.0.17-1"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Janssen Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.17-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.17-1"` | Image  tag to use for deploying. |
