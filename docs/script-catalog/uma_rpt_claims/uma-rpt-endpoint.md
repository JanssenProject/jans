...
* **Property Name:** [`umaRptLifetime`](https://docs.jans.io/v1.8.0/janssen-server/auth-server/uma-features/)
* **Description:** Defines the lifetime of the generated Requesting Party Token in seconds.
* **Recommended Value:** `3600` (1 hour)

* **Property Name:** [`umaRptAsJwt`](https://docs.jans.io/v1.8.0/janssen-server/auth-server/uma-features/)
...
Administrators can modify these configurations using the [Janssen Text User Interface (TUI)](https://docs.jans.io/v1.8.0/janssen-server/logs/tui-text-based-ui/) or the [command-line utility](https://docs.jans.io/v1.8.0/janssen-server/logs/cli-command-line/).
