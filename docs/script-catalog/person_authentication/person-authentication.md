...
1. [FIDO2](../../script-catalog/person_authentication/passkey/README.md) : Authentications using platform authenticators embedded into a person's device or physical USB, NFC or Bluetooth security keys that are inserted into a USB slot of a computer
