...
* **[Passkey Interception Script](../../script-catalog/person_authentication/passkey/README.md)**: Custom authentication interception logic for MFA and passwordless flows.
