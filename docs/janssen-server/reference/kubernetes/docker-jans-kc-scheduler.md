...
Docker image packaging for jans-kc-scheduler

## Versions

See [Packages](https://github.com/orgs/JanssenProject/packages/container/package/jans%2Fkc%2Fscheduler) for available versions.
