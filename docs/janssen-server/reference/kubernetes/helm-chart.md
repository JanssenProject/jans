...
![version: 0.0.0-nightly](https://img.shields.io/badge/Version-1.1.6--dev-informational?style=flat-square) ![Appversion: 0.0.0-nightly](https://img.shields.io/badge/AppVersion-1.1.6--dev-informational?style=flat-square)
...
| global.cnPersistenceType | string | `"sql"` | Persistence backend to run Janssen with couchbase|hybrid|sql |
