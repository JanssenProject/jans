...
# FIDO2 Container Configuration

Docker image packaging for Fido2.

## Versions

See [Packages](https://github.com/orgs/JanssenProject/packages/container/package/jans%2Ffido2) for available versions.
...
```
{"fido2_log_target":"STDOUT","persistence_log_target":"STDOUT","enable_stdout_log_prefix":true}
```
