...
1. `jans-auth_script.log`: - contains [custom interception scripts](../../janssen-server/developer/scripts/README.md) related log messages. Use `scriptLogger` inside custom script to log messages to this log file.
