...
| [Link Interception (Cache Refresh)](../../../script-catalog/link.md)          | Allows implementing custom business logic in existing cache refresh script.                                                                                                                                                                                |
...
| [Persistence Type](../../../script-catalog/persistence_extension/persistence.md)                    |                                                                                                                                                                                                                                                            |
