...
| [Link Interception (Cache Refresh)](./link.md)          | Allows implementing custom business logic in existing cache refresh script.                                                                                                                                                                                |
...
| [Access Evaluation](./access-evaluation.md)             | Access Evaluation custom script for Access Evaluation Endpoint (AuthZEN)                                                                                                                                                                                                                                                            |
