...
How to check this log depends on the concrete engine used. For the case of Janssen, find more details [here](../running.md#logs-location).

**Note**: It is recommended to see this example in [action](../running.md), however, logging in Agama is simple enough to follow just by reading the code.
