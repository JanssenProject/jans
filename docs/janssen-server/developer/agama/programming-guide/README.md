...
- [Flow configuration, inputs, and metadata](./config-inputs-metadata/README.md)
- [Decomposition and reuse](./decomposition-reuse/README.md)
- [Controlling flow access](./access-control/README.md)
- [Onboarding custom code](./custom-code/README.md)

## How to run/play the examples

Find all details related to projects deployment, configuration and testing [here](./running.md).
  
<!--
projects in this programming guide only depend on Java Standard Edition APIs - no external libraries. This avoids distractions and results in very compact projects.
-->
