...
1. [Enable authentication mechanisms](../developer/scripts/person-authentication.md#enabling-an-authentication-mechanism) in Jan-auth server like `otp`, `fido2`, `email_otp`.
