...
_Last updated: 2026-08-20 10:27 UTC (commit 539ef1e)._
...
- Exact host, OS, and compiler/runtime versions for this run are recorded
  in the immutable workflow logs: [https://github.com/JanssenProject/jans/actions/runs/32357494739/attempts/1](https://github.com/JanssenProject/jans/actions/runs/32357494739/attempts/1).
