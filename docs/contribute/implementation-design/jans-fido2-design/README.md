...
Response:
 ...
 7. **Interception script** : In the Janssen ecosystem, the authentication flow that comprises of the calls to WebAuthn API and the FIDO server is achieved using an interception script, details of it can be found in the [Passkey Interception Script guide](../../../script-catalog/person_authentication/passkey/README.md).
