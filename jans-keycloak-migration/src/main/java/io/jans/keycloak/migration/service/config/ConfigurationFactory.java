...
package io.jans.keycloak.migration.service.config;
...
import io.jans.keycloak.migration.model.config.BaseDnConfiguration;
import io.jans.keycloak.migration.model.config.Conf;
import io.jans.keycloak.migration.model.config.Configuration;
import io.jans.keycloak.migration.model.config.StaticConfiguration;
...
public class ConfigurationFactory {
	...
	private Conf loadConfigurationFromLdap(String... returnAttributes) {
		...
		final String dn = this.baseConfiguration.getString("keycloakMigration_ConfigurationEntryDN");
		try {
