 ...
 *
 * @author Javier Rojas Blum Date: 08.17.2013
 */
public class SupportsReturningClaimsInIdToken extends BaseTest {

    @Parameters({"userId", "userSecret", "redirectUri", "redirectUris"})
    @Test
    public void supportsReturningClaimsInIdToken(final String userId, final String userSecret, final String redirectUri,
