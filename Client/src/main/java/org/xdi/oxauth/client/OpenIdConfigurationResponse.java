...
public class OpenIdConfigurationResponse extends BaseResponse {
    ...
    public static Map<String, List<String>> parseScopeToClaimsMapping(JSONArray p_jsonArray) throws JSONException {
        ...
        if (p_jsonArray != null) {
            for (int i = 0; i < p_jsonArray.length(); i++) {
                ...
                final String scope = obj.getString(ConfigurationResponseClaim.SCOPE_KEY);
                final JSONArray claimsArray = obj.getJSONArray(ConfigurationResponseClaim.CLAIMS_KEY);
     ...
     *
     * @return A list of the OAuth 2.0 grant type values that this server supports.
     */
     ...
     *
     * @param grantTypesSupported A list of the OAuth 2.0 grant type values that this server supports.
     */
     ...
     * Valid types include pairwise and public.
     *
     * @param subjectTypesSupported A list of the subject identifier types that this server supports.
     */
    ...
    /**
     * Returns a list of the JWS signing algorithms (alg values JWA) supported by the UserInfo Endpoint to encode the
     * claims in a JWT
     *
    ...
    /**
     * Sets a list of the JWS signing algorithms (alg values JWA) supported by the UserInfo Endpoint to encode the
     * claims in a JWT
     *
    ...
    /**
     * Returns a list of the JWE encryption algorithms (alg values JWA) supported by the UserInfo Endpoint to encode
     * the claims in a JWT.
     *
    ...
    /**
     * Sets a list of the JWE encryption algorithms (alg values JWA) supported by the UserInfo Endpoint to encode
     * the claims in a JWT.
     *
    ...
    /**
     * Returns a list of the JWE encryption algorithms (enc values JWA) supported by the UserInfo Endpoint to encode
     * the claims in a JWT.
     *
     * @return A list of the JWE encryption algorithms.
     */
    ...
    /**
     * Sets a list of the JWE encryption algorithms (enc values JWA) supported by the UserInfo Endpoint to encode  the
     * claims in a JWT.
     *
    ...
    /**
     * Returns a list of the JWS signing algorithms (alg values) supported by the Authorization Server for the ID Token
    ...
    /**
     * Sets a list of the JWS signing algorithms (alg values) supported by the Authorization Server for the ID Token to
    ...
    /**
     * Returns a list of the JWE encryption algorithms (alg values) supported by the Authorization Server for the
    ...
    /**
     * Sets a list of the JWE encryption algorithms (alg values) supported by the Authorization Server for the
     * ID Token to encode the claims in a JWT.
     *
    ...
    /**
     * Returns a list of the JWE encryption algorithms (enc values) supported by the Authorization Server for
    ...
    /**
     * Sets a list of the JWE encryption algorithms (enc values) supported by the Authorization Server for
     * the ID Token to encode the claims in a JWT.
     *
    ...
    /**
     * Returns a list of the JWS signing algorithms (alg values) supported by the Authorization Server for the
    ...
    /**
     * Sets a list of the JWS signing algorithms (alg values) supported by the Authorization Server for the
     * OpenID Request Object.
     *
    ...
    /**
     * Returns a list of the JWE encryption algorithms (enc values) supported by the Authorization Server for the
     * OpenID Request Object.
     *
     * @return A list of the JWE encryption algorithms.
     */
    ...
    /**
     * Sets a list of the JWE encryption algorithms (enc values) supported by the Authorization Server for the
     * OpenID Request Object.
     *
     ...
     * If unspecified or omitted, the default is client_secret_basic, the HTTP Basic Authentication Scheme.
     *
    ...
    /**
     * Returns a list of the JWS signing algorithms (alg values) supported by the Token Endpoint for the
     * private_key_jwt and client_secret_jwt methods to encode the JWT. Servers SHOULD support RS256.
     *
     * @return A list of the JWS signing algorithms.
     */
    ...
    /**
     * Sets a list of the JWS signing algorithms (alg values) supported by the Token Endpoint for the
     * private_key_jwt and client_secret_jwt methods to encode the JWT. Servers SHOULD support RS256.
     *
     ...
     * Note that for privacy or other reasons, this may not be an exhaustive list.
     *
    ...
    /**
     * Returns an URL of a page containing human-readable information that developers might want or need to know
     * when using the OpenID Provider.
     * In particular, if the OpenID Provider does not support dynamic client registration, then information on
     * how to register clients should be provided in this documentation.
     *
    ...
    /**
     * Sets an URL of a page containing human-readable information that developers might want or need to know
     * when using the OpenID Provider.
     * In particular, if the OpenID Provider does not support dynamic client registration, then information on
     * how to register clients should be provided in this documentation.
     *
     ...
     *
     * @return A list of languages and scripts supported for values in Claims being returned.
     */
     ...
     *
     * @param claimsLocalesSupported A list of languages and scripts supported for values in Claims being returned.
     */
     ...
     *
     * @param uiLocalesSupported A list of languages and scripts supported for the user interface.
     */
    ...
    /**
     * Returns a Boolean value specifying whether the OP supports use of the claims parameter,
     * with <code>true</code> indicating support. If omitted, the default value is <code>false</code>.
     *
     * @return A Boolean value specifying whether the OP supports use of the claims parameter.
     */
    ...
    /**
     * Sets a Boolean value specifying whether the OP supports use of the claims parameter,
     * with <code>true</code> indicating support. If omitted, the default value is <code>false</code>.
     *
     * @param claimsParameterSupported A Boolean value specifying whether the OP supports use of the claims parameter.
     */
    ...
    /**
     * Returns a Boolean value specifying whether the OP supports use of the request parameter,
     * with <code>true</code> indicating support. If omitted, the default value is <code>false</code>.
     *
     * @return A Boolean value specifying whether the OP supports use of the request parameter.
     */
    ...
    /**
     * Sets a Boolean value specifying whether the OP supports use of the request parameter,
     * with <code>true</code> indicating support. If omitted, the default value is <code>false</code>.
     *
     * @param requestParameterSupported A Boolean value specifying whether the OP supports use of the request parameter.
     */
    ...
    /**
     * Returns a Boolean value specifying whether the OP supports use of the request_uri parameter,
     * with <code>true</code> indicating support. If omitted, the default value is <code>true</code>.
     *
     * @return A Boolean value specifying whether the OP supports use of the request_uri parameter.
     */
    ...
    /**
     * Sets a Boolean value specifying whether the OP supports use of the request_uri parameter,
     * with <code>true</code> indicating support. If omitted, the default value is <code>true</code>.
     *
    ...
    /**
     * Returns a Boolean value specifying whether the OP requires any request_uri values used to be pre-registered
     * using the request_uris registration parameter. Pre-registration is required when the value is <code>true</code>.
     *
     * @return A Boolean value specifying whether the OP requires any request_uri values used to be pre-registered
    ...
    /**
     * Sets a Boolean value specifying whether the OP requires any request_uri values used to be pre-registered
     * using the request_uris registration parameter. Pre-registration is required when the value is <code>true</code>.
     *
     * @param requireRequestUriRegistration A Boolean value specifying whether the OP requires any request_uri values
    ...
    /**
     * Returns a URL that the OpenID Provider provides to the person registering the Client to read about the OP's
     * requirements on how the Relying Party may use the data provided by the OP.
     *
    ...
    /**
     * Sets a URL that the OpenID Provider provides to the person registering the Client to read about the OP's
     * requirements on how the Relying Party may use the data provided by the OP.
     *
    ...
    /**
     * Returns a URL that the OpenID Provider provides to the person registering the Client to read about OpenID
    ...
    /**
     * Sets a URL that the OpenID Provider provides to the person registering the Client to read about OpenID
     * Provider's terms of service.
     *
