...
class SearchApi(object):
    ...
    def search_resource(self, body, **kwargs):  # noqa: E501
        """search_resource  # noqa: E501

        Search (from system root) for one or more resource (see section 3.4.3 of RFC 7644)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_resource(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.search_resource_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.search_resource_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def search_resource_with_http_info(self, body, **kwargs):  # noqa: E501
        """search_resource  # noqa: E501

        Search (from system root) for one or more resource (see section 3.4.3 of RFC 7644)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_resource_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `search_resource`")  # noqa: E501
