...
class FidoDevicesApi(object):
    ...
    def search_fido_device(self, body, **kwargs):  # noqa: E501
        """search_fido_device  # noqa: E501

        Query Fido resources  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_fido_device(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_fido_device_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.search_fido_device_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def search_fido_device_with_http_info(self, body, **kwargs):  # noqa: E501
        """search_fido_device  # noqa: E501

        Query Fido resources  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_fido_device_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_fido_device" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `search_fido_device`")  # noqa: E501
    ...
    def update_fido_device_by_id(self, body, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_fido_device_by_id(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_fido_device_by_id_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_fido_device_by_id_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_fido_device_by_id_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """update_fido_device_by_id  # noqa: E501

        Updates a Fido resource. Update works in a replacement fashion&amp;#58; every attribute value found in the payload sent will replace the one in the existing resource representation. Attributes  not passed in the payload will be left intact.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_fido_device_by_id_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_fido_device_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_fido_device_by_id`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_fido_device_by_id`")  # noqa: E501
