...
class DiscoveryApi(object):
    ...
    def get_resource_type_by_id(self, resource, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_resource_type_by_id_with_http_info(resource, **kwargs)  # noqa: E501
        else:
            (data) = self.get_resource_type_by_id_with_http_info(resource, **kwargs)  # noqa: E501
            return data

    def get_resource_type_by_id_with_http_info(self, resource, **kwargs):  # noqa: E501
        """get_resource_type_by_id  # noqa: E501

        Describes the endpoint, schemas and extensions supported by a specific kind of resource. It returns a specific portion of the ouput of the more general /Resources endpoint     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_resource_type_by_id_with_http_info(resource, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_resource_type_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('resource' not in params or
            ...
            raise ValueError("Missing the required parameter `resource` when calling `get_resource_type_by_id`")  # noqa: E501
