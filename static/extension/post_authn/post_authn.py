...
from org.jans.model.custom.script.type.postauthn import PostAuthnType
...
class PostAuthn(PostAuthnType):
    ...
    # Note :
    # context is reference of org.jans.oxauth.service.external.context.ExternalPostAuthnContext(in https://github.com/JanssenFederation/oxauth project, )
