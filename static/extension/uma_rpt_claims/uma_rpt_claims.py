...
from org.gluu.model.custom.script.type.uma import UmaRptClaimsType
...
class UmaRptClaims(UmaRptClaimsType):
    ...
    # context is reference of org.gluu.oxauth.service.external.context.ExternalUmaRptClaimsContext (in https://github.com/GluuFederation/oxauth project, )
