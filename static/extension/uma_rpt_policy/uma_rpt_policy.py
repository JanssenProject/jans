...
class UmaRptPolicy(UmaRptPolicyType):
    ...
    def getRequiredClaims(self, context): # context is reference of org.jans.oxauth.uma.authorization.UmaAuthorizationContext
        json = """[
        {
            "issuer" : [ "%1$s" ],
            "name" : "country",
    ...
    def getClaimsGatheringScriptName(self, context): # context is reference of org.jans.oxauth.uma.authorization.UmaAuthorizationContext
