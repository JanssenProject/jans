...
from org.jans.model.custom.script.type.authz import ConsentGatheringType
...
class ConsentGathering(ConsentGatheringType):
    ...
    def authorize(self, step, context): # context is reference of org.jans.oxauth.service.external.context.ConsentGatheringContext
