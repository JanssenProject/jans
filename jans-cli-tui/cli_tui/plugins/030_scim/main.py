...
class Plugin(DialogUtils):
    ...
    def create_widgets(self) -> None:
        ...
        self.container = HSplit([
                                    ...
                                    self.app.getTitledCheckBox(_("Disable External Logger Configuration"), name='disableExternalLoggerConfiguration', checked=self.app_config.get('disableExternalLoggerConfiguration'), jans_help=self.app.get_help_from_schema(schema, 'disableExternalLoggerConfiguration'), style=cli_style.check_box, widget_style=cli_style.black_bg_widget),
                                    ...
                                    self.app.getTitledCheckBox(_("Disable Logger Timer"), name='disableLoggerTimer', checked=self.app_config.get('disableLoggerTimer'), jans_help=self.app.get_help_from_schema(schema, 'disableLoggerTimer'), style=cli_style.check_box, widget_style=cli_style.black_bg_widget),
                                    self.app.getTitledCheckBox(_("Skip Defined Password Validation"), name='skipDefinedPasswordValidation', checked=self.app_config.get('skipDefinedPasswordValidation'), jans_help=self.app.get_help_from_schema(schema, 'skipDefinedPasswordValidation'), style=cli_style.check_box, widget_style=cli_style.black_bg_widget),
