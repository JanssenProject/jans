 ...
 */
public class AuthorizationResponseModeQueryJwtResponseTypeCodeIdTokenTokenEncryptedHttpTest extends BaseTest {
    ...
    public void testAlgA128KWEncA128GCM(
        ...
        assertEquals(authorizationResponse.getResponseMode(), ResponseMode.QUERY_JWT);
