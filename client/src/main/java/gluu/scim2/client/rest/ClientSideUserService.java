...
import io.jans.oxtrust.ws.rs.scim2.PATCH;
...
public interface ClientSideUserService extends IUserWebService, CloseableClient {
     ...
     * @param jsonUser A String with the payload for the operation. It represents the User resource to create
     ...
     * operation instead. PUT is intended to do replacements using the (not-null) values supplied in <code>jsonUser</code>
     * parameter.</p>
     * <p>To learn more about how the update works, read the replacement rules found at method
     * <code>org.gluu.oxtrust.model.scim2.util.ScimResourceUtil#transferToResourceReplace.</code></p>
     * @param jsonUser A String with the payload for the operation. It represents an object that contains the data to
