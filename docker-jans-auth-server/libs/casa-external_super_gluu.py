...
from io.jans.as.model.config
import ConfigurationFactory
from io.jans.as.server.service
import AuthenticationService, UserService, SessionIdService
from io.jans.as.service.common
import EncryptionService
from io.jans.as.service.fido.u2f
import DeviceRegistrationService
from io.jans.as.service.net
import HttpService
from io.jans.as.server.util
import ServerUtil
from io.jans.util import StringHelper
from io.jans.service import MailService
from io.jans.as.service.push.sns
import PushPlatform, PushSnsService
...
class PersonAuthentication(PersonAuthenticationType):
    ...
    def init(self, customScript, configurationAttributes):
        ...
        if has_license_api and configurationAttributes.containsKey("license_file"):
            ...
            # Validate license
            try:
                self.license_content = LicenseValidator.validate(license["public-key"], license["public-password"],
                                                                 license["license-password"], license["license"],
