...
def test_get_wait_max_time(value, expected):
    ...
    os.environ["JANS_WAIT_MAX_TIME"] = str(value)
    assert get_wait_max_time() == expected
    os.environ.pop("JANS_WAIT_MAX_TIME", None)
...
def test_get_wait_interval(value, expected):
    ...
    os.environ["JANS_WAIT_SLEEP_DURATION"] = str(value)
    assert get_wait_interval() == expected
    os.environ.pop("JANS_WAIT_SLEEP_DURATION", None)
