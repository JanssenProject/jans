...
def gk8s_config():
    ...
    config.settings["JANS_CONFIG_KUBERNETES_USE_KUBE_CONFIG"] = True
    config.settings["JANS_CONFIG_KUBERNETES_NAMESPACE"] = "testing"
    config.settings["JANS_CONFIG_KUBERNETES_CONFIGMAP"] = "testing"
...
def gk8s_secret():
    ...
    secret.settings["JANS_SECRET_KUBERNETES_USE_KUBE_CONFIG"] = True
    secret.settings["JANS_SECRET_KUBERNETES_NAMESPACE"] = "testing"
    secret.settings["JANS_SECRET_KUBERNETES_SECRET"] = "testing"
