...
public enum ErrorResponseCode {
    ...
    REQUEST_OBJECT_NOT_FOUND(404, "failed_to_get_request_uri", "Request object not found. The `request_uri` has either expired or it does not exist."),
    BAD_REQUEST_NO_OXD_HOST(400, "bad_request_no_oxd_host", "'oxd_host_url' is empty or not specified."),
    MISSING_PATH_PARAMETER(400, "missing_path_parameter", "Missing path parameter in request."),
