...
public enum ErrorResponseCode {
    ...
    INVALID_AUTHORIZATION_OXD_ID(400, "invalid_authorization_oxd_id", "`oxd_id` in `AuthorizationOxdId` header is invalid. The `AuthorizationOxdId` header should cointain`oxd_id` from `protect_commands_with_oxd_id` field in oxd-server.yml."),
