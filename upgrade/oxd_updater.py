...
conf_yaml_template = '/opt/oxd-server/conf/oxd-server.yml.temp'
...
if update_required:
    ...
    print "An old isntance of oxd-server detected."
    ...
    if answer and answer.lower()[0] == 'y':
        ...
        print "You can do upgrade later by running: python /opt/oxd-server/bin/oxd_updater.py"
