 ...
 * UpdateSiteParams
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-11-04T10:13:38.535Z")
public class UpdateSiteParams {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(oxdId, authorizationRedirectUri, postLogoutRedirectUri, responseTypes, grantTypes, scope, acrValues, clientJwksUri, clientTokenEndpointAuthMethod, clientRequestUris, clientSectorIdentifierUri, clientSecretExpiresAt, contacts, uiLocales, claimsLocales, accessTokenAsJwt, accessTokenSigningAlg);
  }
