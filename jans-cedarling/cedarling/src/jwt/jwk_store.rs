...
impl JwkStore {
    ...
    pub fn new_from_jwks_value(store_id: Rc<str>, jwks: Value) -> Result<Self, JwkStoreError> {
    ...
    fn new_from_jwks(store_id: Rc<str>, jwks: IntermediateJwks) -> Result<Self, JwkStoreError> {
