...
#[derive(Deserialize)]
pub struct PolicyStoreSourceJson {
...
impl TryFrom<PolicyStoreSourceJson> for PolicyStoreSource {
    type Error = LoadFromJsonError;

    fn try_from(json_store: PolicyStoreSourceJson) -> Result<Self, Self::Error> {
