...
mod tests {
    ...
    fn test_max_entries() {
        ...
        let store =
            DataStore::new(config, Arc::new(MetricsCollector::new())).expect("should create store");
    ...
    fn test_config_validation() {
        ...
        assert!(
            DataStore::new(valid_config, Arc::new(MetricsCollector::new())).is_ok(),
        ...
        assert!(
            matches!(
                DataStore::new(invalid_config, Arc::new(MetricsCollector::new())),
