...
|            | amd64                                        | arm64                                        |
| ---------- | -------------------------------------------- | -------------------------------------------- |
| Docker     | `amd64-builder-2.9.0-2.4.0.so`               | `arm64-builder-2.9.0-2.4.0.so`               |
| On-premise | `amd64-builder-2.9.0-linux-generic-2.4.0.so` | `arm64-builder-2.9.0-linux-generic-2.4.0.so` |
...
- Download the dynamic shared object file(s) for the `cedarling_go` binding, compiled for your platform:
  - Windows:
    - [cedarling_go.dll](https://github.com/JanssenProject/jans/releases/download/v2.4.0/cedarling_go-2.4.0.dll)
    - [cedarling_go.lib](https://github.com/JanssenProject/jans/releases/download/v2.4.0/cedarling_go-2.4.0.lib)
  - Mac OS: [cedarling_go.dylib](https://github.com/JanssenProject/jans/releases/download/v2.4.0/libcedarling_go-2.4.0.dylib)
  - Linux: [libcedarling_go.so](https://github.com/JanssenProject/jans/releases/download/v2.4.0/libcedarling_go-2.4.0.so)
