...
import { LOG_KIND_SET, LOG_LEVEL_SET } from "../helpers/constants.js";
...
const LOG_ENVELOPE_FIELD_SET: ReadonlySet<string> = new Set([
  "id",
  "request_id",
  "timestamp",
  "log_kind",
...
export function normalizeGeneratedLog(
  ...
  try {
    snapshot = snapshotJsonObject(value, operation);
  } catch {
