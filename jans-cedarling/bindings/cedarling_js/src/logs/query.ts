import { INPUT_FIELDS, LOG_TAG_SET } from "../helpers/constants.js";
import {
...
export function snapshotLogQuery(value?: LogQuery): LogQuery | undefined {
  ...
  if (
    ...
    invalid(errorCode.inputUnsupported, ["tag"]);
  }
