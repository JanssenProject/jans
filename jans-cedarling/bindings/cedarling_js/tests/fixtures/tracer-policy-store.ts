export const tracerPolicyStore = `cedar_version: v4.0.0
policy_stores:
  tracer:
    ...
    policies:
      ...
      public:
        ...
        policy_content:
          encoding: none
          content_type: cedar
          body: 'permit(principal, action == Tracer::Action::"Public", resource);'
      residual:
        ...
        policy_content:
          encoding: none
          content_type: cedar
          body: 'permit(principal, action == Tracer::Action::"Protected", resource) when { principal.is_ok };'
      entity_attributes:
        ...
        policy_content:
          encoding: none
          content_type: cedar
          body: 'permit(principal, action == Tracer::Action::"Edit", resource) when { principal.role == "editor" && principal.labels.contains("stable") && resource.owner == "alice" };'
      default_entity:
        ...
        policy_content:
          encoding: none
          content_type: cedar
          body: 'permit(principal, action == Tracer::Action::"UseDefault", resource) when { resource.owner == "trusted" };'
    schema:
      encoding: none
      content_type: cedar
      body: |
    ...
    default_entities:
      default: eyJ1aWQiOnsidHlwZSI6IlRyYWNlcjo6UmVzb3VyY2UiLCJpZCI6ImRlZmF1bHQifSwiYXR0cnMiOnsib3duZXIiOiJ0cnVzdGVkIn0sInBhcmVudHMiOltdfQ==
`;

export const tracerExtensionPolicyStore = `cedar_version: v4.0.0
policy_stores:
  tracer_extensions:
    cedar_version: v4.0.0
    ...
    policies:
      network:
        ...
        policy_content:
          encoding: none
          content_type: cedar
          body: 'permit(principal, action == Tracer::Action::"Connect", resource) when { context.network.isInRange(ip("192.0.2.0/24")) };'
`;
