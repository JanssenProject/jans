...
void GeneratedCedarling.newFromMap;
void generatedInit;
void edgeInitWasm;
edgeInitWasm();
...
void cedarling.authorizeUnsignedBatch;
void cedarling.authorizeMultiIssuerBatch;
void cedarling.annotationsMap;
void cedarling.annotationValues;
void cedarling.annotationsByPolicy;
void cedarling.popLogs;
void cedarling.getLogById;
void cedarling.getLogIds;
void cedarling.getLogsByTag;
void cedarling.getLogsByRequestId;
void cedarling.getLogsByRequestIdAndTag;
void cedarling.pushDataCtx;
void cedarling.getDataCtx;
void cedarling.getDataEntryCtx;
void cedarling.removeDataCtx;
void cedarling.clearDataCtx;
void cedarling.listDataCtx;
void cedarling.getStatsCtx;
void cedarling.isTrustedIssuerLoadedByName;
void cedarling.isTrustedIssuerLoadedByIss;
void cedarling.totalIssuers;
void cedarling.loadedTrustedIssuersCount;
void cedarling.loadedTrustedIssuerIds;
void cedarling.failedTrustedIssuerIds;
