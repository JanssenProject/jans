...
test_cases_err = [
    ...
    ("policy-store_schema_err.yaml",
     "Could not load policy: failed to parse the policy store from policy_store yaml: unable to parse cedar policy schema: error parsing schema: unexpected end of input at line 2 column 1"),
    ("policy-store_schema_err_cedar_mistake.yaml",
     "Could not load policy: failed to parse the policy store from policy_store yaml: unable to parse cedar policy schema: failed to resolve type: User_TypeNotExist at line 2 column 1"),
]
