...
public class IntrospectAccessTokenResponse {
  ...
  **/
   ...
   * @return username
  **/
  @Schema(example = "John Black", required = true, description = "")
  ...
  **/
   ...
   * @return sub
  **/
  @Schema(example = "jblack", required = true, description = "")
   ...
   * @return aud
  **/
  @Schema(example = "l238j323ds-23ij4", required = true, description = "")
   ...
   * @return iss
  **/
  @Schema(example = "https://as.gluu.org/", required = true, description = "")
  ...
  **/
   ...
   * @return jti
  **/
  @Schema(required = true, description = "a unique identifier for the JWT")
  ...
  **/
  @Schema(example = "twenty-seven", required = true, description = "")
