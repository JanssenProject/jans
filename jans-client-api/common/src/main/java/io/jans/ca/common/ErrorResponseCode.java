...
public enum ErrorResponseCode {
    ...
    ERROR_AUTHORIZATION_CODE(500, "error_authorization_code", "Error Authorization code - Check keystorePath, keystorePassword, signatureAlgorithms, jansConfWebKeys, and credentials."),
