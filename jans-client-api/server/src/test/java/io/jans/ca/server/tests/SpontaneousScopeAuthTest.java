...
public class SpontaneousScopeAuthTest extends BaseTest {
    ...
    public void spontaneousScope(String host, String opHost, String paramRedirectUrl, String userId, String userSecret) throws Exception {
        ...
        RegisterSiteResponse registerResponse = registerClient(hostTargetURL, opHost, paramRedirectUrl, scopes, responseTypes, spontaneousScopes);
    ...
    private RegisterSiteResponse registerClient(String hostTargetURL, String opHost, String redirectUrls, List<String> scopes, List<String> responseTypes, List<String> spontaneousScopes) {
