INSERT INTO jansAppConf (doc_id,objectClass,dn,ou,jansEmail,jansSmtpConf,jansDbAuth,jansConfDyn,jansRevision)
  ...
  "addClientCredentialsGrantTypeAutomaticallyDuringClientRegistration":false,
  "uma2AutoRegisterClaimsGatheringEndpointAsRedirectUriOfClient": false,
  "supportGoogleLogout": true,
  "fapiEnabled": false,
  "dbCleanupIntervalInHours": 1,
  "stateExpirationInMinutes": 10,
  "nonceExpirationInMinutes": 10,
  "encodeStateFromRequestParameter": false,
  "encodeNonceFromRequestParameter": false,
  "rpCacheExpirationInMinutes": 60,
  "idTokenValidationCHashRequired": true,
  "idTokenValidationAtHashRequired": true,
  "acceptIdTokenWithoutSignature": true,
  "validateUserInfoWithIdToken": true,
  "encodeClientIdInAuthorizationUrl": true,
  "defaultSiteConfig":{
