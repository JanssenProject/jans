...
class ElevenInstaller(JettyInstaller):
    ...
    def __init__(self):
        ...
        self.source_files = [
                (os.path.join(Config.distJansFolder, 'jans-eleven.war'), 'https://jenkins.jans.io/maven/io/jans/jans-eleven-server/{0}/jans-eleven-server-{0}.war'.format(Config.oxVersion))
                ]
