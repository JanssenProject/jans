...
public final class TrustAllTrustManager implements X509TrustManager, Serializable {
	 ...
	 * any certificate, including certificates that are expired or not yet
	 * valid.
	 */
	...
	/**
	 * Creates a new instance of this trust all trust manager that will trust
	 * any certificate, potentially excluding certificates that are expired or
	 * not yet valid.
	 * 
	 * @param examineValidityDates
	 *            Indicates whether to reject certificates if the current time
	 *            is outside the validity window for the certificate.
	 */
	...
	/**
	 * Indicate whether to reject certificates if the current time is outside
	 * the validity window for the certificate.
	 * 
	...
	/**
	 * Checks to determine whether the provided client certificate chain should
	 * be trusted. A certificate will only be rejected (by throwing a
	 ...
	 *             If the provided client certificate chain should not be
	 *             trusted.
	 */
	...
	/**
	 * Checks to determine whether the provided server certificate chain should
	 * be trusted. A certificate will only be rejected (by throwing a
	 * {@link CertificateException}) if certificate validity dates should be
	 * examined and the certificate or any of its issuers is outside of the
	 * validity window.
	 ...
	 * 
	 * @throws CertificateException
	 *             If the provided server certificate chain should not be
	 *             trusted.
	 */
