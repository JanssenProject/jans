"""This module contains lock adapter class to interact with Google Secret."""
...
class GoogleLock(BaseLock):
    ...
    - `CN_GOOGLE_SECRET_NAME_PREFIX`: Prefix for Janssen secret in Google Secret Manager. Defaults to `jans`. If left `jans-lock` secret will be created.
    """
    ...
    def __init__(self) -> None:
        ...
        self.google_secret_name = f"{prefix}-lock"
    ...
    def set_all(self, data: dict[str, _t.Any]) -> bool:
        ...
        Args:
            data: full dictionary to push. Used in initial creation of locks.
