"""This module contains lock adapter class to interact with AWS Secrets Manager."""
...
class AwsLock(BaseLock):
    ...
    def set(self, key: str, value: _t.Any) -> bool:
        ...
        Returns:
            A boolean to mark whether locks is set or not.
        """
        data = self.get_all()
    ...
    def _prepare_secret(self) -> None:
        ...
        try:
            ...
            create_secret = partial(
                ...
                Description="Non-sensitive secrets (locks) for Janssen cluster",
            )
