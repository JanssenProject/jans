...
Next, configure an [*interception script*](https://docs.jans.io/nightly/janssen-server/developer/scripts/index.md) to automatically add the required scopes when a Cedarling client registers.
...
> Note:
>
> If you want to learn more about configuring the example interception script, see the [reference](https://docs.jans.io/nightly/janssen-server/developer/scripts/index.md).

______________________________________________________________________

## Client Setup

To enable Lock Server integration in the Cedarling client, configure the appropriate [bootstrap properties](https://docs.jans.io/nightly/cedarling/reference/cedarling-properties/index.md).
