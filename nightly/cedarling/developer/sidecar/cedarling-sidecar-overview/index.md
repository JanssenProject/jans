...
Cedarling requires OpenID tokens from one or more trusted issuers to perform authorization, as described [here](https://docs.jans.io/nightly/cedarling/reference/cedarling-authz/index.md). These values are sent in the subject field's properties. A more detailed example of creating an AuthZen request can be seen in the [gateway example](https://docs.jans.io/nightly/cedarling/developer/sidecar/cedarling-sidecar-tutorial/#setup-test-gateway).
