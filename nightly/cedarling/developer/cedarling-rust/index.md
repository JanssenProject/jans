...
To build an executable library for Cedarling, follow the instructions [here](https://docs.jans.io/nightly/cedarling/tutorials/rust/#building-from-source).
...
Cedarling can be configured using bootstrap properties. See the [bootstrap properties documentation](https://docs.jans.io/nightly/cedarling/reference/cedarling-properties/index.md) for complete configuration options.
...
- [Getting Started with Cedarling Rust](https://docs.jans.io/nightly/cedarling/tutorials/rust/index.md)
...
- [Cedarling Properties](https://docs.jans.io/nightly/cedarling/reference/cedarling-properties/index.md)
