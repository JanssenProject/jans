...
Python bindings support all policy store source types. See [Cedarling Properties](https://docs.jans.io/nightly/cedarling/reference/cedarling-properties/index.md) for the full list of configuration options.
...
- [Multi-Issuer Authorization Details](https://docs.jans.io/nightly/cedarling/reference/cedarling-authz/#multi-issuer-authorization-authorize_multi_issuer-recommended)
