...
This document explains how to use the Janssen Auth Server's built-in [Passkey Interception Script](https://github.com/JanssenProject/jans/blob/nightly/docs/script-catalog/person_authentication/passkey/PasskeyInterceptionScript.py) to implement a two-step, two-factor authentication (2FA) with username / password as the first step, and any FIDO2 device as the second step.

## Prerequisites

- A Janssen Server ([installation instructions](https://github.com/JanssenProject/jans#installation))
- [Passkey Interception Script](https://github.com/JanssenProject/jans/blob/nightly/docs/script-catalog/person_authentication/passkey/PasskeyInterceptionScript.py) (included in the default Janssen Server distribution);
