...
- A Gluu Server (installation instructions [here](https://docs.jans.io/nightly/janssen-server/install/index.md)) which will play the role of RADIUS client
...
- [Restart](https://docs.jans.io/nightly/janssen-server/vm-ops/restarting-services/#restart) the `oxauth` service
