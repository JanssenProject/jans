...
[BioID Web Service](https://www.bioid.com) is a "Biometrics as a service" provider. This document will explain how to use Janssen Server [BioID interception script](https://docs.jans.io/nightly/script-catalog/person_authentication/other/bioid/BioIDExternalAuthenticator.py) along with a Plugin in Casa to enroll a user's biometric traits and use it is as a method for 2FA.
...
- A Janssen Server
- [BioID interception script](https://docs.jans.io/nightly/script-catalog/person_authentication/other/bioid/BioIDExternalAuthenticator.py).
...
1. Upon registration, you will recieve an email with the instance name (listed as STORAGE in Janssen Server's BioID authentication script), partition number(listed as PARTITION in Janssen Server's BioID authentication script).
1. As the owner of this instance, you are entitled to access BWS Portal at https://bwsportal.bioid.com using the account associated with your email. With the BWS Portal, you can do the following:\
...
1. Lots of useful information about BWS is available at https://developer.bioid.com/blog.
1. For liveness detection, you will find information about motion trigger helpful: https://developer.bioid.com/app-developer-guide/bioid-motion-detection
...
Download this [file](https://docs.jans.io/nightly/script-catalog/person_authentication/other/bioid/BioIDExternalAuthenticator.py) and copy its contents in the `Script` form field.
