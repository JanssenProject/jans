...
| `def modifyResponse(self, responseAsJsonObject, context)`        | This method is called after the introspection response is ready. This method can modify the introspection response. `responseAsJsonObject` is `org.codehaus.jettison.json.JSONObject` `context` is `io.jans.as.service.external.context.ExternalIntrospectionContext` |
...
### [Retrieve Grant, Session and User Details from Access Token](https://docs.jans.io/nightly/script-catalog/introspection/introspection-custom-parameters/introspection_custom_params.py)

The sample code snippet shows how to work backwards from an AccessToken to Grant, Session and User information.

## Script Type: Java

### [Retrieve Grant, Session and User Details from Access Token](https://docs.jans.io/nightly/script-catalog/introspection/introspection-custom-parameters/introspection_custom_params.java)
