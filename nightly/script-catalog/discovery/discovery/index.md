...
### [Add a value (Client IP Address) and Filter out a value from Discovery Response](https://docs.jans.io/nightly/script-catalog/discovery/discovery/scripts/Custom_OpenID_Config.py)

The sample code snippet shows how to add and filter out a value from Discovery Response.

## Script Type: Java

### [Add a value (Client IP Address) and Filter out a value from Discovery Response](https://docs.jans.io/nightly/script-catalog/discovery/discovery/scripts/Custom_OpenID_Config.java)
