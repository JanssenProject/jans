...
- [Dynamic Permission](https://docs.jans.io/nightly/script-catalog/dynamic_scope/dynamic-permission/dynamic_permission.py)
- [MemberOf Attribute](https://docs.jans.io/nightly/script-catalog/dynamic_scope/memberof-attribute/memberof_attribute.py)
- [Organization Name](https://docs.jans.io/nightly/script-catalog/dynamic_scope/org-name/org_name.py)
- [Session Parameter](https://docs.jans.io/nightly/script-catalog/dynamic_scope/session-parameter/session_parameter.py)
- [Work Phone](https://docs.jans.io/nightly/script-catalog/dynamic_scope/work-phone/work_phone.py)
