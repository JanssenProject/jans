...
This page covers customizations available through the [custom branding plugin](https://docs.jans.io/nightly/casa/plugins/custom-branding/index.md). It is assumed you have already added it to your Casa installation.
