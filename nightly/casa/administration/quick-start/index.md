...
This step is optional. Check [this](https://docs.jans.io/nightly/casa/plugins/2fa-settings/index.md) page for more information. Use this plugin if you need to exercise an advanced control on how 2FA behaves in your Casa deployment.
...
- Ensure at least two credentials have been added. In the home page, [turn on](https://docs.jans.io/nightly/casa/user-guide/#turn-2fa-onoff) 2FA
- Log off and log back in. From now on, besides username and password, one credential has to be presented to get access

Click [here](https://docs.jans.io/nightly/casa/administration/2fa-basics/index.md) to learn more about 2FA in Casa.

## Finish configuration

Once you are done with testing, you may use casa as the default authentication method of Janssen Server using [TUI](https://docs.jans.io/nightly/janssen-server/config-guide/config-tools/jans-tui/index.md) to log in users via Casa for all applications the server protects.
...
Browse our [catalog of plugins](https://docs.jans.io/nightly/casa/#existing-plugins) to add features and expand Casa!.
