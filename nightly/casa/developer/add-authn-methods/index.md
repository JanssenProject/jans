...
Acquaintance with Agama [framework](https://docs.jans.io/nightly/agama/introduction/index.md) and Agama project [management](https://docs.jans.io/nightly/janssen-server/config-guide/auth-server-config/agama-project-configuration/index.md) is required
...
Alternatively, a pointer to a localized message can be used instead of `text`. This is the recommended practice if [localization/internationalization](https://docs.jans.io/nightly/janssen-server/developer/agama/advanced-usages/#localization-and-internationalization) is relevant. In this case, something like the below will work:
...
Ensure to go through [this](https://docs.jans.io/nightly/janssen-server/developer/agama/agama-best-practices/index.md) page before proceeding
