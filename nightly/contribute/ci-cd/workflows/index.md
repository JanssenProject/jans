...
One row per workflow under `.github/workflows/`. See [CI/CD Architecture](https://docs.jans.io/nightly/contribute/ci-cd/architecture/index.md) for the chain and [Security Scanning](https://docs.jans.io/nightly/contribute/ci-cd/security-scanning/index.md) for scan detail.
