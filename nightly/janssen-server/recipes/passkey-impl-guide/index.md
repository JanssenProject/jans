...
- **Script Integration**: Refer to the Python code inside [PasskeyInterceptionScript.py](https://docs.jans.io/nightly/script-catalog/person_authentication/passkey/PasskeyInterceptionScript.py) which handles reading and parsing the `allowList` cookie during authorization.
