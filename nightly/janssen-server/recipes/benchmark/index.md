...
As mentioned in the overview we recommend using the same Kubernetes cluster as planned in production. More guides to install on different clouds can be found [here](https://docs.jans.io/nightly/janssen-server/install/helm-install/index.md).
