...
1. **During Registraion**: At the time of Credential registration, a cookie called 'allowList' should be added. Content of the allowList is as follows, note that we are not storing usernames or email ids:
...
1. In the **login web page**, here is an .xhtml sample
   ...
   on submit, do the following: javascript code :
