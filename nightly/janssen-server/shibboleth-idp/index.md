...
- [Installation Guide](https://docs.jans.io/nightly/janssen-server/shibboleth-idp/installation/index.md) - Detailed installation instructions
- [Configuration](https://docs.jans.io/nightly/janssen-server/shibboleth-idp/configuration/index.md) - IDP and authentication configuration
- [Helm Deployment](https://docs.jans.io/nightly/janssen-server/shibboleth-idp/helm-deployment/index.md) - Kubernetes deployment guide
- [Config API](https://docs.jans.io/nightly/janssen-server/shibboleth-idp/config-api/index.md) - REST API for configuration management
- [Terraform](https://docs.jans.io/nightly/janssen-server/shibboleth-idp/terraform/index.md) - Infrastructure as Code deployment

## Related Documentation

- [SAML Recipes](https://docs.jans.io/nightly/janssen-server/recipes/saml/index.md) - SAML integration recipes
- [Auth Server](https://docs.jans.io/nightly/janssen-server/auth-server/index.md) - Janssen Auth Server documentation
- [Kubernetes Operations](https://docs.jans.io/nightly/janssen-server/kubernetes-ops/index.md) - Kubernetes deployment guide
