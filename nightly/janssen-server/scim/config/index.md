...
| loggingLevel                  | `INFO`                                                 | The logging [level](https://docs.jans.io/nightly/janssen-server/scim/logs/index.md)                                             |
...
SCIM operations support mutiple options. Please check out this [documentation](https://docs.jans.io/nightly/janssen-server/config-guide/scim-config/user-config/index.md) for guidelines of scim operations.
