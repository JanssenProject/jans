...
AS under the hood is using `log4j2` and `slf4j`. AS is configured by [log4j2.xml](https://github.com/JanssenProject/jans/blob/main/jans-auth-server/server/src/main/resources/log4j2.xml)

Main structure of which defines [standard logs](https://docs.jans.io/nightly/janssen-server/auth-server/logging/standard-logs/index.md) and which can be overwritten by specifying own custom [log4j2.xml](https://docs.jans.io/nightly/janssen-server/auth-server/logging/custom-logs/index.md).
