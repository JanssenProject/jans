...
Token revocation endpoint can be further configured using Janssen Server configuration properties listed below. When using [Janssen Text-based UI(TUI)](https://docs.jans.io/nightly/janssen-server/config-guide/config-tools/jans-tui/index.md) to configure the properties, navigate via `Auth Server`->`Properties`.

- [mtlstokenrevocationendpoint](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#mtlstokenrevocationendpoint)
- [tokenRevocationEndpoint](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#tokenrevocationendpoint)
- [allowRevokeForOtherClients](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#allowrevokeforotherclients)
...
Endpoint can provide custom behavior via implementing Revoke Token interception [script](https://docs.jans.io/nightly/script-catalog/revoke_token/revoke-token/index.md) .
