...
URL to access authorization challenge endpoint on Janssen Server is listed in the response of Janssen Server's well-known [configuration endpoint](https://docs.jans.io/nightly/janssen-server/auth-server/endpoints/configuration/index.md) given below.
...
More details in [Authorization Challenge Custom Script Page](https://docs.jans.io/nightly/script-catalog/authorization_challenge/authorization-challenge/index.md)

Full sample script can be found [here](https://docs.jans.io/nightly/script-catalog/authorization_challenge/AuthorizationChallenge.java)
...
Full multi-step sample script can be found [here](https://docs.jans.io/nightly/script-catalog/authorization_challenge/multi_step/AuthorizationChallenge.java)
