...
URL to access end session endpoint on Janssen Server is listed in the response of Janssen Server's well-known [configuration endpoint](https://docs.jans.io/nightly/janssen-server/auth-server/endpoints/configuration/index.md) given below.
...
More information about request and response of the end session endpoint can be found in the OpenAPI specification of [jans-auth-server module](https://gluu.org/swagger-ui/?url=https://raw.githubusercontent.com/JanssenProject/jans/nightly/jans-auth-server/docs/swagger.yaml).

## Disabling The Endpoint Using Feature Flag

`/end_session` endpoint can be enabled or disable using [END_SESSION feature flag](https://docs.jans.io/nightly/janssen-server/reference/json/feature-flags/janssenauthserver-feature-flags/#end_session). Use [Janssen Text-based UI(TUI)](https://docs.jans.io/nightly/janssen-server/config-guide/config-tools/jans-tui/index.md) or [Janssen command-line interface](https://docs.jans.io/nightly/janssen-server/config-guide/config-tools/jans-cli/index.md) to perform this task.
...
- [allowEndSessionWithUnmatchedSid](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#allowendsessionwithunmatchedsid)
- [endSessionEndpoint](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#endsessionendpoint)
- [endSessionWithAccessToken](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#endsessionwithaccesstoken)
- [mtlsEndSessionEndpoint](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#mtlsendsessionendpoint)
- [rejectEndSessionIfIdTokenExpired](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#rejectendsessionifidtokenexpired)
...
- [forceIdTokenHintPresence](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#forceidtokenhintpresence)
...
Response from end session endpoint can be further customized using [end session](https://docs.jans.io/nightly/script-catalog/end_session/end-session/index.md) interception script.
...
For more details, see [Global Token Revocation](https://docs.jans.io/nightly/janssen-server/auth-server/endpoints/global-token-revocation/index.md).
