...
URL to access PAR endpoint on Janssen Server is listed in the response of Janssen Server's well-known [configuration endpoint](https://docs.jans.io/nightly/janssen-server/auth-server/endpoints/configuration/index.md) given below.
...
- [mtlsParEndpoint](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#mtlsparendpoint) - Mutual TLS (mTLS) Pushed Authorization Requests (PAR) endpoint URL
- [parEndpoint](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#parendpoint) - Pushed Authorization Requests (PAR) Endpoint location
- [requirePar](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#requirepar) - Boolean value to indicate whether Pushed Authorisation Request (PAR) endpoint is required
- [requestUriParameterSupported](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#requesturiparametersupported) - Boolean value specifying whether the OP supports use of the request_uri parameter
