...
The URL for the Global Token Revocation endpoint is specified in the Janssen Server's well-known [configuration endpoint](https://docs.jans.io/nightly/janssen-server/auth-server/endpoints/configuration/index.md) response:
...
- View full sample execution log [here](https://docs.jans.io/nightly/assets/log/global-token-revocation-run-log.txt)
...
For more details, see [End Session](https://docs.jans.io/nightly/janssen-server/auth-server/endpoints/end-session/index.md).
