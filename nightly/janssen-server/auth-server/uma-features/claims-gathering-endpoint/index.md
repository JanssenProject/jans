...
- To enable or disable the UMA feature, see the [UMA Feature Flag](https://docs.jans.io/nightly/janssen-server/reference/json/feature-flags/janssenauthserver-feature-flags/#uma).
- To configure UMA authorization policies, see [UMA RPT Policy](https://docs.jans.io/nightly/script-catalog/uma_rpt_policy/uma-rpt/index.md).
- To implement and configure a Claims Gathering script, see [UMA Claims Gathering (Web Flow)](https://docs.jans.io/nightly/script-catalog/uma_claims_gathering/uma-claims-web/index.md).
...
- For information about configuring UMA resources using the Jans CLI, see [Using Command Line](https://docs.jans.io/nightly/janssen-server/config-guide/auth-server-config/oauth-umaresources-config/#using-command-line).
...
For instructions on configuring client properties using the Jans TUI, see [Client Management - TUI](https://docs.jans.io/nightly/janssen-server/auth-server/client-management/#c-tui).

For instructions on configuring client properties using the Jans CLI, see [Client Management - Jans CLI](https://docs.jans.io/nightly/janssen-server/auth-server/client-management/#b-jans-cli).
