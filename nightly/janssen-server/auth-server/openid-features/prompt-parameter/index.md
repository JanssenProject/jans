...
If more or custom fields have to be shown then custom page should be added and ["CreateUser" custom script](https://docs.jans.io/nightly/script-catalog/create_user/create-user/index.md) should redirect to that custom page.
...
- ["CreateUser" custom script](https://docs.jans.io/nightly/script-catalog/create_user/create-user/index.md)
