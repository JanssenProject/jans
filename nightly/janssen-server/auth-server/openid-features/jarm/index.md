...
- [responseModesSupported](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#responsemodessupported)
- [authorizationSigningAlgValuesSupported](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#authorizationsigningalgvaluessupported)
- [authorizationEncryptionAlgValuesSupported](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#authorizationencryptionalgvaluessupported)
- [authorizationEncryptionEncValuesSupported](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#authorizationencryptionencvaluessupported)

You can configure them using the [Janssen TUI](https://docs.jans.io/nightly/janssen-server/config-guide/config-tools/jans-tui/index.md) by navigating to `Auth Server` -> `Properties`, or through Config API/JSON configuration management.
...
You can configure them using the [Janssen TUI](https://docs.jans.io/nightly/janssen-server/config-guide/config-tools/jans-tui/index.md).
...
When [fapiCompatibility](https://docs.jans.io/nightly/janssen-server/reference/json/properties/janssenauthserver-properties/#fapicompatibility) is enabled, Janssen applies stricter checks. In this mode:
