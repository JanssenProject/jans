...
For more information and implementation details please check [PAR Endpoint documentation](https://docs.jans.io/nightly/janssen-server/auth-server/endpoints/par/index.md)
