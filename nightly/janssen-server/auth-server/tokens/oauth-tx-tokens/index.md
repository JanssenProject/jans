...
- View full obtain execution log [here](https://docs.jans.io/nightly/assets/log/tx-token-request-run-log.txt)
- View full replace execution log [here](https://docs.jans.io/nightly/assets/log/tx-token-replace-run-log.txt)
