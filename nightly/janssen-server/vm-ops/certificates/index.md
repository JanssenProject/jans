...
- Install python package for apache: For Ubuntu:
...
- [Restart](https://docs.jans.io/nightly/janssen-server/vm-ops/restarting-services/#restart) the `httpd/apache2` service
