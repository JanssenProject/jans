...
- Restart the ConfgiApi [service](https://docs.jans.io/nightly/janssen-server/vm-ops/restarting-services/#restart). If you are using kubernetes please restart the [deployment](https://kubernetes.io/docs/reference/kubectl/generated/kubectl_rollout/kubectl_rollout_restart/).
