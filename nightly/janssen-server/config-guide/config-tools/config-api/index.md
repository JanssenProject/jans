...
Config API endpoints are OAuth 2.0 protected. It supports simple bearer and JWT token. Learn more API endpoint protection using [here](https://docs.jans.io/nightly/janssen-server/config-guide/config-tools/config-api/authorization/index.md).

## Monitoring

Config API module monitoring related details [here](https://docs.jans.io/nightly/janssen-server/config-guide/config-tools/config-api/authorization/index.md).
