...
Support additional hashing methods can be added with [Persistence Extension](https://docs.jans.io/nightly/script-catalog/persistence_extension/persistence/#persistence-script) script.
...
1. Override default setting with file `/etc/jans/conf/jans-sql.properties`
