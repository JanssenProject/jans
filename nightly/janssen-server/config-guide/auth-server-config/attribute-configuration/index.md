...
Close and reopen the TUI. The new custom user claim can now be added to any user from [user management](https://docs.jans.io/nightly/janssen-server/usermgmt/usermgmt-cli-tui/index.md).
...
Janssen Server Configuration REST API exposes relevant endpoints for managing and configuring the user claim. Endpoint details are published in the [Swagger document](https://docs.jans.io/nightly/janssen-server/reference/openapi/index.md).
