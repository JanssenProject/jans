...
For next step in manual setup, proceed to [Ingress Setup](https://docs.jans.io/nightly/janssen-server/install/helm-install/ingress-setup/index.md) to configure traffic routing.
