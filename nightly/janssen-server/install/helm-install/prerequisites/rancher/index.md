...
Follow this [guide](https://docs.jans.io/nightly/janssen-server/install/helm-install/ingress-setup/index.md) to choose between the modern Gateway API (recommended) or the legacy Kubernetes Ingress.
...
After installation, proceed to [Post-Installation](https://docs.jans.io/nightly/janssen-server/install/helm-install/post-install/index.md) for configuration.
