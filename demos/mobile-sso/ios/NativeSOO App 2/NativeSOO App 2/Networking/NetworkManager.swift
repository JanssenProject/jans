...
final class NetworkManager: NSObject {
    ...
    func getToken(callback: ((Token) -> Void)?) {
        let baseURL = Configuration.host
        let endpoint = Configuration.path + "/token"
        ...
        let idToken = KeychainManager.shared.idToken ?? ""
        ...
        requestBodyComponents.queryItems = [
            ...
            URLQueryItem(name: "scope", value: "openid+profile+device_sso+email"),
            URLQueryItem(name: "audience", value: "https://\(Configuration.domain)"),
            URLQueryItem(name: "subject_token", value: idToken),
            URLQueryItem(name: "subject_token_type", value: "urn:ietf:params:oauth:token-type:id_token"),
            URLQueryItem(name: "actor_token", value: deviceToken),
            URLQueryItem(name: "actor_token_type", value: "urn:x-oath:params:oauth:token-type:device-secret")
        ]
