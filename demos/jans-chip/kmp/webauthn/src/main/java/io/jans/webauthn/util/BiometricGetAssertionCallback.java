...
public class BiometricGetAssertionCallback extends BiometricPrompt.AuthenticationCallback {
    ...
    public void onAuthenticationSucceeded(BiometricPrompt.AuthenticationResult result) {
        ...
        try {
            ...
            Log.w(TAG, "Failed getInternalAssertion: " + exception);
        ...
        try {
            ...
            Log.w(TAG, "Could not send assertionResult from BiometricPrompt: " + exception);
            return;
        }
    }
    ...
    public void onAuthenticationError(int errorCode, CharSequence errString) {
        ...
        try {
            ...
            Log.w(TAG, "Could not send null (failed) from BiometricPrompt: " + exception);
        }
    }
