...
public class Authenticator {
     ...
     */
    public Authenticator(Context ctx, boolean authenticationRequired, boolean strongboxRequired) {
   ...
   // 7. Generate a new credential
     ...
     **/
    public Signature generateSignature(PublicKeyCredentialSource credentialSource) {
     ...
     */
    public AttestationObject makeCredential(AuthenticatorMakeCredentialOptions options, PublicKeyCredentialSource credentialSource, Context ctx, CancellationSignal cancellationSignal) {
        ...
        if (credentialSafe.supportsUserVerification()) {
            if (ctx == null) {
                Log.d("Authenticator", "User Verification requires passing a context to makeCredential");
            }
            ...
            try {
                ...
                Log.d("Authenticator", "Could not retrieve attestationObject from BiometricPrompt: " + exception.toString());
            }
        ...
        return new BiometricPrompt.AuthenticationCallback() {
            ...
            public void onAuthenticationSucceeded(@NonNull BiometricPrompt.AuthenticationResult result) {
                ...
                try {
                    ...
                    Log.w(TAG, "Failed makeInternalCredential: " + exception);
     ...
     * @return an AttestationObject containing the new credential and attestation information
     */
    public AttestationObject makeInternalCredential(AuthenticatorMakeCredentialOptions options, PublicKeyCredentialSource credentialSource) {
     ...
     * @return an AttestationObject containing the new credential and attestation information
     */
    public AttestationObject makeInternalCredential(AuthenticatorMakeCredentialOptions options, PublicKeyCredentialSource credentialSource, Signature signature) {
     ...
     */
    public AuthenticatorGetAssertionResult getAssertion(AuthenticatorGetAssertionOptions options, PublicKeyCredentialSource selectedCredential, CredentialSelector credentialSelector) {
    ...
    public PublicKeyCredentialSource selectPublicKeyCredentialSource(CredentialSelector credentialSelector, AuthenticatorGetAssertionOptions options) {
        ...
        if (credentials.size() == 1) {
            ...
            if (selectedCredential == null) {
                Log.d("Authenticator", "User did not select credential");
            }
        }
     ...
     * @return a record class containing the output of the authenticatorGetAssertion operation.
     */
    public AuthenticatorGetAssertionResult getAssertion(AuthenticatorGetAssertionOptions options, PublicKeyCredentialSource selectedCredential, CredentialSelector credentialSelector, Context ctx, CancellationSignal cancellationSignal) {
        ...
        AuthenticatorGetAssertionResult result = null;
        ...
        if (options.requireUserVerification || keyNeedsUnlocking) {
            if (ctx == null) {
                Log.d("Authenticator", "User Verification requires passing a context to getAssertion");
            }
     ...
     */
    public AuthenticatorGetAssertionResult getInternalAssertion(AuthenticatorGetAssertionOptions options, PublicKeyCredentialSource selectedCredential) {
     ...
     * @return the credential assertion
     */
    public AuthenticatorGetAssertionResult getInternalAssertion(AuthenticatorGetAssertionOptions options, PublicKeyCredentialSource selectedCredential, Signature signature) {
     ...
     */
    private byte[] constructAttestedCredentialData(PublicKeyCredentialSource credentialSource) {
     ...
     */
    private byte[] constructAuthenticatorData(byte[] rpIdHash, byte[] attestedCredentialData, int authCounter) {
        if (rpIdHash.length != 32) {
            Log.d("Authenticator", "rpIdHash must be a 32-byte SHA-256 hash");
        }
