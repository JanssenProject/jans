...
public class CredentialSafe {
     ...
     */
    public CredentialSafe(Context ctx, boolean authenticationRequired, boolean strongboxRequired) {
        try {
            keyStore = KeyStore.getInstance(KEYSTORE_TYPE);
            keyStore.load(null);
        } catch (KeyStoreException | CertificateException |
                NoSuchAlgorithmException | IOException e) {
            Log.d("CredentialSafe", "couldn't access keystore");
        }
     ...
     */
    private KeyPair generateNewES256KeyPair(String alias) {
        ...
        try {
            ...
            Log.d("CredentialSafe", "couldn't generate key pair: " + e);
            return null;
        }
    }
     ...
     */
    public PublicKeyCredentialSource generateCredential(@NonNull String rpEntityId, byte[] userHandle, String userDisplayName) {
     ...
     * not accessible.
     */
    public KeyPair getKeyPairByAlias(@NonNull String alias) {
        ...
        try {
            ...
            Log.d("CredentialSafe","couldn't get key by alias", e);
            return null;
        }
    }
     ...
     */
    public boolean keyRequiresVerification(@NonNull String alias) {
        ...
        try {
            ...
            Log.d("CredentialSafe", "Couldn't build key factory: " + exception);
        }

        try {
            keyInfo = factory.getKeySpec(privateKey, KeyInfo.class);
        } catch (InvalidKeySpecException exception) {
            Log.d("CredentialSafe", "Not an android keystore key: " + exception);
        }
    ...
    public static byte[] coseEncodePublicKey(PublicKey publicKey) {
        ...
        try {
            ...
            Log.d("CredentialSafe", "couldn't serialize to cbor", e);
        }
