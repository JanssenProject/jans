...
public class SubjectConfigurationResource extends BaseResource {
	...
	public Response getSubjectConfiguration() {
		try {
			log.debug("SubjectConfigurationResource::getOpenIdConfigurationResource() - Retrieve Subject configuration properties.");
	...
	public Response updateSubjectConfiguration(@Valid SubjectConfiguration subjectConfiguration) {
		try {
			log.debug("SubjectConfigurationResource::updateSubjectConfiguration() - Retrieve Subject configuration properties.");
