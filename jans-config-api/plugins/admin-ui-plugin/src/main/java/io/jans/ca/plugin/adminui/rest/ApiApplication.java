...
@OAuthScope(name = "https://jans.io/oauth/jans-auth-server/config/adminui/security.write", description = "Edit Admin UI security related information"),
@OAuthScope(name = "https://jans.io/oauth/jans-auth-server/config/adminui/security.delete", description = "Delete Admin UI security related information"),
