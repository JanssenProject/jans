...
@OAuthScope(name = "https://jans.io/oauth/config/adminui/role.admin", description = "Manage admin user role related information"),
@OAuthScope(name = "https://jans.io/oauth/config/adminui/permission.admin", description = "Manage admin permission related information"),
@OAuthScope(name = "https://jans.io/oauth/config/adminui/rolePermissionMapping.admin", description = "Manage admin role-permission related information")
}
)))
