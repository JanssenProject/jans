package io.jans.configapi.plugin.lock.model.config;
...
@ApplicationScoped
public class LockConfigSource implements ConfigSource {

    private static Logger log = LoggerFactory.getLogger(LockConfigSource.class);

    private static final String FILE_CONFIG = "lock.properties";
    private Properties properties = null;
    Map<String, String> propertiesMap = new HashMap<>();

    public LockConfigSource() {
        this.loadProperties();
    }
    ...
    public String getValue(String name) {
        log.debug("LockConfigSource()::getValue() - name:{}", name);
        try {
