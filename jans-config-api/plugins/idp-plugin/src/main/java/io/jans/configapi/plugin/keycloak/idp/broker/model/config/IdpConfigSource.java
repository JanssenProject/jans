...
@ApplicationScoped
public class IdpConfigSource implements ConfigSource {

    private static Logger log = LoggerFactory.getLogger(IdpConfigSource.class);
    private static final String FILE_CONFIG = "idp.properties";
    private Properties properties = null;
    Map<String, String> propertiesMap = new HashMap<>();

    public IdpConfigSource() {
        this.loadProperties();
    }
    ...
    public String getValue(String name) {
        log.debug("IdpConfigSource()::getValue() - name:{}", name);
        try {
