...
public class ShibbolethService {
    ...
    private final TrustRelationshipRepositoryImpl trustRelationshipRepository =
            new TrustRelationshipRepositoryImpl(persistenceEntryManager, BASE_DN);
    ...
    public TrustRelationship addTrustRelationship(CreateTrustRelationshipRequest request) {
        ...
        TrustRelationship trustRelationship = readShibbolethObject(result, "CreateTrustRelationshipRequest");
        
        result = trustRelationshipRepository.save(trustRelationship);
        
        trustRelationship = readShibbolethObject(result, "Created TrustRelationship");
        
        trustRelationship = result.getValue();
        logger.error("trustRelationship :{}", trustRelationship);
        return trustRelationship;
        
    }
    
    private <T> T readShibbolethObject(Result<T> result, String message) {
