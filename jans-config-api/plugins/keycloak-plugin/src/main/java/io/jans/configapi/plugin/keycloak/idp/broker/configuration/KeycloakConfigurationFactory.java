...
import io.jans.configapi.plugin.keycloak.idp.broker.model.config.KeycloakConf;
import io.jans.configapi.plugin.keycloak.idp.broker.model.config.KeycloakConfiguration;
import io.jans.configapi.plugin.keycloak.idp.broker.model.config.KeycloakConfiguration;
...
public class SamlConfigurationFactory {
    ...
    public static final String JANS_KC_CONFIGURATION_ENTRY_DN = "keycloak_ConfigurationEntryDN";
    ...
    public static final String SAML_BASE_CONFIGURATION_RELOAD_EVENT_TYPE = "keycloak_baseConfigurationReloadEvent";
    ...
    // keycloak config
    public static final String KEYCLOAK_CONFIGURATION_ENTRY = "keycloak_ConfigurationEntryDN";
    private KeycloakAppConfiguration samlAppConfiguration;
