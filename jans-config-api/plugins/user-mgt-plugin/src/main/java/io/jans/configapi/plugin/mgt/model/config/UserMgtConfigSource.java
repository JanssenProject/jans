package io.jans.configapi.plugin.mgt.model.config;
...
@ApplicationScoped
public class UserMgtConfigSource implements ConfigSource {

    private static Logger log = LoggerFactory.getLogger(UserMgtConfigSource.class);
    private static final String FILE_CONFIG = "mgt.properties";
    private Properties properties = null;
    Map<String, String> propertiesMap = new HashMap<>();

    public UserMgtConfigSource() {
        this.loadProperties();
    }
