...
public class TrustRelationshipResource extends BaseResource {
    ...
    public Response getTrustRelationshipById(
        ...
        if (trustrelationship != null) {
            ...
            ApiError error = new ApiError.ErrorBuilder()
                    ...
                    .andDescription(String.format("The TrustRelationship with id '%s' was not found", id)).build();
    ...
    public Response updateTrustRelationship(@MultipartForm TrustRelationshipForm trustRelationshipForm,
        ...
        try {
            ...
            if (trustRelationshipList != null && !trustRelationshipList.isEmpty()) {
                ...
                List<TrustRelationship> list = trustRelationshipList.stream()
                        .filter(e -> !e.getInum().equalsIgnoreCase(inum)).collect(Collectors.toList());
                ...
                if (list != null && !list.isEmpty()) {
                    throwBadRequestException(NAME_CONFLICT,
                            String.format(NAME_CONFLICT_MSG, trustRelationship.getName()));
                }
            }
    ...
    private void validateSpMetaDataSourceType(TrustRelationship trustRelationship, InputStream metaDataFile,
        ...
        logger.info("Validate SP MetaDataSourceType trustRelationship:{}, metaDataFile:{}, isUpdate:{}",
                trustRelationship, metaDataFile, isUpdate);
