...
public class KcLinkConfigService {
    ...
    public FileConfiguration getBaseConfiguration() {
        logger.info(" samlConfigurationFactory.getBaseConfiguration():{}", samlConfigurationFactory.getBaseConfiguration());
        return samlConfigurationFactory.getBaseConfiguration();
    }
    ...
    public io.jans.keycloak.link.model.config.AppConfiguration find() {
