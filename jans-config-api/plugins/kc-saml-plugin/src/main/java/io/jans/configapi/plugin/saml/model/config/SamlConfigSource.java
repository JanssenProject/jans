...
@ApplicationScoped
public class SamlConfigSource implements ConfigSource {

    private static Logger log = LoggerFactory.getLogger(SamlConfigSource.class);
    private static final String FILE_CONFIG = "saml.properties";
    private Properties properties = null;
    Map<String, String> propertiesMap = new HashMap<>();

    public SamlConfigSource() {
        this.loadProperties();
    }
    ...
    public String getValue(String name) {
        log.debug("SamlConfigSource()::getValue() - name:{}", name);
        try {
