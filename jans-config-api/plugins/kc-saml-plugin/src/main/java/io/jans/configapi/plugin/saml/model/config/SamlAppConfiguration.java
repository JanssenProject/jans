...
public class SamlAppConfiguration implements Configuration {
    ...
    private List<String> nonKcAttributes;
    ...
    public void setNonKcAttributes(List<String> nonKcAttributes) {
        this.nonKcAttributes = nonKcAttributes;
    }
    ...
    public String toString() {
        return "SamlAppConfiguration [applicationName=" + applicationName + ", samlTrustRelationshipDn="
                ...
                + idpMetadataMandatoryAttributes + ", nonKcAttributes=" + nonKcAttributes + ", kcSamlConfig="
                + kcSamlConfig + "]";
    }
}
