...
@OAuthScope(name = ApiAccessConstants.SAML_READ_ACCESS, description = "View SAML related information"),
@OAuthScope(name = ApiAccessConstants.SAML_WRITE_ACCESS, description = "Manage SAML configuration related information")}
)))
