package io.jans.configapi.plugin.metric.model.config;
...
@ApplicationScoped
public class MetricConfigSource implements ConfigSource {

    private static Logger log = LoggerFactory.getLogger(MetricConfigSource.class);
    private static final String FILE_CONFIG = "metric.properties";
    private Properties properties = null;
    Map<String, String> propertiesMap = new HashMap<>();

    public MetricConfigSource() {
        this.loadProperties();
    }
    ...
    public String getValue(String name) {
        log.debug("MetricConfigSource()::getValue() - name:{}", name);
        try {
