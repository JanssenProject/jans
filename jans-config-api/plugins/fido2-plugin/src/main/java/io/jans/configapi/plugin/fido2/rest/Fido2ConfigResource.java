...
public class Fido2ConfigResource extends BaseResource {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "InternalServerError") })
    @PUT
    @ProtectedApi(scopes = { Constants.FIDO2_CONFIG_WRITE_ACCESS }, groupScopes = {}, superScopes = {
            Constants.FIDO2_ADMIN_ACCESS, ApiAccessConstants.SUPER_ADMIN_WRITE_ACCESS })
