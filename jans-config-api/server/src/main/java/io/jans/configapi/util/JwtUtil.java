...
public class JwtUtil {
    ...
    public boolean isJwt(String token) throws InvalidJwtException {
        boolean isJwt = false;
        try {
            this.parse(token);
            isJwt = true;
    ...
    public JSONWebKeySet getJSONWebKeys(String jwksUri) {
        return AuthClientFactory.getJSONWebKeys(jwksUri);
    }
