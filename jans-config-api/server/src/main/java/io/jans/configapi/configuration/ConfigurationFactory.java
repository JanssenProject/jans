...
public class ConfigurationFactory {
    ...
    private boolean isAuthRevisionIncreased() {
        ...
        log.error("Auth Config - DB revision: {}, server revision: {}", persistenceConf.getRevision(),
                authLoadedRevision);
    ...
    private boolean isApiRevisionIncreased() {
        ...
        log.error("Api Config - DB revision: {}, server revision: {}", apiConf.getRevision(), apiLoadedRevision);
