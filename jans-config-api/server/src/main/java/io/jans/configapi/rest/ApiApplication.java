...
@SecurityScheme(name = "oauth2", type = SecuritySchemeType.OAUTH2, flows = @OAuthFlows(clientCredentials = @OAuthFlow(tokenUrl = "https://{op-hostname}/.../token", scopes = {
        @OAuthScope(name = ApiAccessConstants.AUTH_CONFIG_READ_ACCESS, description = "View Auth Server properties related information"),
        @OAuthScope(name = ApiAccessConstants.AUTH_CONFIG_WRITE_ACCESS, description = "Manage Auth Server properties related information"),
        ...
        @OAuthScope(name = ApiAccessConstants.AUTH_SESSION_READ_ACCESS, description = "View Session related information"),
        @OAuthScope(name = ApiAccessConstants.AUTH_SESSION_DELETE_ACCESS, description = "Delete Session information"),
        ...
        @OAuthScope(name = ApiAccessConstants.ASSET_READ_ACCESS, description = "View Jans Assets"),
        @OAuthScope(name = ApiAccessConstants.ASSET_WRITE_ACCESS, description = "Manage Jans Assets"),
        @OAuthScope(name = ApiAccessConstants.ASSET_DELETE_ACCESS, description = "Delete Jans Assets"),
        ...
        @OAuthScope(name = ApiAccessConstants.AUTH_CONFIG_ADMIN_ACCESS, description = "Admin scope for Auth Server properties"),
        @OAuthScope(name = ApiAccessConstants.ATTRIBUTES_ADMIN_ACCESS, description = "Admin for Attribute management"),
        ...
        @OAuthScope(name = ApiAccessConstants.JWKS_ADMIN_ACCESS, description = "Admin for JWKS management"),
        @OAuthScope(name = ApiAccessConstants.OPENID_CLIENTS_ADMIN_ACCESS, description = "Admin for clients management"),
        @OAuthScope(name = ApiAccessConstants.TOKEN_ADMIN_ACCESS, description = "Admin for Token management"),
        @OAuthScope(name = ApiAccessConstants.SCOPES_ADMIN_ACCESS, description = "Admin for scope management"),
        @OAuthScope(name = ApiAccessConstants.STATS_USER_ADMIN_ACCESS, description = "Admin for statistic management"),
        @OAuthScope(name = ApiAccessConstants.ORG_CONFIG_ADMIN_ACCESS, description = "Admin for organization configuration management"),
        @OAuthScope(name = ApiAccessConstants.AGAMA_ADMIN_ACCESS, description = "Admin for Agama flow management"),
        @OAuthScope(name = ApiAccessConstants.AUTH_SESSION_ADMIN_ACCESS, description = "Admin for Session management"),
        @OAuthScope(name = ApiAccessConstants.UMA_ADMIN_ACCESS, description = "Admin for UMA management"),
        @OAuthScope(name = ApiAccessConstants.PLUGIN_ADMIN_ACCESS, description = "Admin for Plugin management"),
        ...
        @OAuthScope(name = ApiAccessConstants.ASSET_ADMIN_ACCESS, description = "Admin for Jans Assets management"),
