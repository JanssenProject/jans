...
@SecurityScheme(name = "oauth2", type = SecuritySchemeType.OAUTH2, flows = @OAuthFlows(clientCredentials = @OAuthFlow(tokenUrl = "https://{op-hostname}/.../token", scopes = {
        ...
        @OAuthScope(name = ApiAccessConstants.JANS_AUTH_CONFIG_ADMIN_ACCESS, description = "Admin scope for Auth Server properties"),
        ...
        @OAuthScope(name = ApiAccessConstants.JANS_AUTH_SESSION_ADMIN_ACCESS, description = "Admin for Session management"),
