...
public class DataLogInterceptor {
    ...
    private static final Logger AUDIT_LOG = LoggerFactory.getLogger("audit-data");
    private static final Logger LOG = LoggerFactory.getLogger(DataLogInterceptor.class);
    ...
    private Map<String, String> getAuditHeaderAttributes(AuditLogConf auditLogConf, HttpHeaders httpHeaders) {
        LOG.info("DataLogInterceptor::getAuditHeaderAttributes() - auditLogConf:{}, httpHeaders:{}", auditLogConf,
                httpHeaders);
        if (auditLogConf == null) {
            return Collections.emptyMap();
        }
        List<String> attributes = auditLogConf.getHeaderAttributes();
        LOG.info("DataLogInterceptor::getAuditHeaderAttributes() - attributes:{}", attributes);
        ...
        LOG.info("DataLogInterceptor::getAuditHeaderAttributes() - attributeMap:{}", attributeMap);
        return attributeMap;
    }
