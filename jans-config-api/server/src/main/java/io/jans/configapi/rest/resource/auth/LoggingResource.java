...
public class LoggingResource {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Logging object", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = Logging.class))),
