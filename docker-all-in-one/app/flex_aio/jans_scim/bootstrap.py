...
from flex_aio.jans_scim.utils import parse_swagger_file
...
logger = logging.getLogger("jans_scim")
...
def configure_logging():
    ...
    src, dst = get_template_paths("/opt/jans/jetty/jans-scim/resources/log4j2.xml")
    with open(src) as f:
        txt = f.read()
