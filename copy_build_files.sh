...
SRC_FPATHS=(
    ...
    "${IN_BASE_DIR}/jans-scim/server/target/jans-scim-server-1.0.17-SNAPSHOT.war"
    ...
    "${IN_BASE_DIR}/jans-config-api/plugins/fido2-plugin/target/fido2-plugin-1.0.17-SNAPSHOT-distribution.jar"
    "${IN_BASE_DIR}/jans-config-api/plugins/scim-plugin/target/scim-plugin-1.0.17-SNAPSHOT-distribution.jar"
    "${IN_BASE_DIR}/jans-config-api/plugins/user-mgt-plugin/target/user-mgt-plugin-1.0.17-SNAPSHOT-distribution.jar"
    "${IN_BASE_DIR}/jans-orm/spanner-libs/target/jans-orm-spanner-libs-1.0.17-SNAPSHOT-distribution.zip"
    "${IN_BASE_DIR}/jans-link/server/target/jans-link-server-1.0.17-SNAPSHOT.war"
    "${IN_BASE_DIR}/jans-link/server-fips/target/jans-link-server-fips.war"
    "${IN_BASE_DIR}/jans-link/service/target/jans-link-service-1.0.17-SNAPSHOT.jar"
);
...
DST_FPATHS=(
    ...
    "${OUT_DIR}/jans-scim-server-1.0.17-SNAPSHOT.war"
    ...
    "${OUT_PLUGINS_DIR}/fido2-plugin-1.0.17-SNAPSHOT-distribution.jar"
    "${OUT_PLUGINS_DIR}/scim-plugin-1.0.17-SNAPSHOT-distribution.jar"
    "${OUT_PLUGINS_DIR}/user-mgt-plugin-1.0.17-SNAPSHOT-distribution.jar"
    "${OUT_DIR}/jans-orm-spanner-libs-1.0.17-SNAPSHOT-distribution.zip"
    "${OUT_DIR}/jans-link-server-1.0.17-SNAPSHOT.war"
    "${OUT_DIR}/jans-link-server-fips.war"
    "${OUT_DIR}/jans-link-service-1.0.17-SNAPSHOT.jar"
);
