...
AIO_IMAGE_TAG="${AIO_IMAGE_TAG:-ghcr.io/janssenproject/jans/all-in-one:2.4.0-1}"

# start_janssen_aio_demo.sh hardcodes the demo image as :2.4.0. Pull the chosen
...
DEMO_TAG="ghcr.io/janssenproject/jans/all-in-one:2.4.0-1"
