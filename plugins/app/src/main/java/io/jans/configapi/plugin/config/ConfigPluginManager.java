package io.jans.configapi.plugin.config;

import io.jans.configapi.plugin.config.util.PluginUtil;
...
public class ConfigPluginManager extends DefaultPluginManager {
