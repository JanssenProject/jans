For testing purpouses there is archive with CA/Intermidiate/User certs in [archive](https://docs.jans.io/v2.3.0/script-catalog/person_authentication/other/cert/sample/generated_certs.zip).
