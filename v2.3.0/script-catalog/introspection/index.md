...
### [Retrieve Grant, Session and User Details from Access Token](https://docs.jans.io/v2.3.0/script-catalog/introspection/introspection-custom-parameters/introspection_custom_params.py)

The sample code snippet shows how to work backwards from an AccessToken to Grant, Session and User information.

## Script Type: Java

### [Retrieve Grant, Session and User Details from Access Token](https://docs.jans.io/v2.3.0/script-catalog/introspection/introspection-custom-parameters/introspection_custom_params.java)
