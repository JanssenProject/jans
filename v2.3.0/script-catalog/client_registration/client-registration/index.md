...
class ClientRegistration(ClientRegistrationType):
    ...
    # context refers to io.jans.as.server.service.external.context.DynamicClientRegistrationContext - see https://github.com/JanssenProject/jans-auth-server/blob/v2.3.0/server/src/main/java/io/jans/as/server/service/external/context/DynamicClientRegistrationContext.java#L24
...
- [OpenBanking](https://docs.jans.io/v2.3.0/script-catalog/client_registration/OpenBanking/client-registration/index.md)
