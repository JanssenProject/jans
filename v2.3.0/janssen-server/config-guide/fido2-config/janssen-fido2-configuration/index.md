...
In the Janssen Server, you can manage FIDO2 Configuration using the [Text-Based UI](https://docs.jans.io/v2.3.0/janssen-server/config-guide/config-tools/jans-tui/index.md) also.
...
Janssen Server Configuration REST API exposes relevant endpoints for managing and configuring the FIDO2 Configuration. Endpoint details are published in the [Swagger document](https://docs.jans.io/v2.3.0/janssen-server/reference/openapi/index.md).
...
- [FIDO implementation Guide](https://docs.jans.io/v2.3.0/janssen-server/fido/index.md)
- [FIDO2 Server Configuration Properties](https://docs.jans.io/v2.3.0/janssen-server/fido/fido2-server-properties-config/index.md)
