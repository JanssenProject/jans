...
When you do a write operation (post/put/patch) with Jans TUI, it [logs](https://docs.jans.io/v2.3.0/janssen-server/config-guide/config-tools/jans-tui/#command-line-logs) activities to file `<log-dir>/cli_cmd.log`,default `log-dir` is home directory.
