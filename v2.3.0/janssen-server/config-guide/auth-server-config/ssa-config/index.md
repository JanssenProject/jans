...
Please see description of fields at [SSA field descriptions](https://docs.jans.io/v2.3.0/janssen-server/auth-server/endpoints/ssa/#request-body-description)
...
Janssen Server Configuration REST API exposes relevant endpoints for managing and configuring SSA. Endpoint details are published in the [Swagger document](https://docs.jans.io/v2.3.0/janssen-server/reference/openapi/index.md).
