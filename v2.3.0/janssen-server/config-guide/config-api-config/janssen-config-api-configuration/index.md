...
In the Janssen Server, you can manage Config-API Configuration using the [Text-Based UI](https://docs.jans.io/v2.3.0/janssen-server/config-guide/config-tools/jans-tui/index.md) also.
