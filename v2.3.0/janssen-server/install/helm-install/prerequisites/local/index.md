...
For next step in manual setup, proceed to [Ingress Setup](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/ingress-setup/index.md) to configure traffic routing.
