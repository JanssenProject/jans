...
```
wget https://raw.githubusercontent.com/JanssenProject/jans/v2.3.0/automation/mysql.yaml
kubectl apply -f mysql.yaml # adjust values as preferred
```

```
wget https://raw.githubusercontent.com/JanssenProject/jans/v2.3.0/automation/pgsql.yaml
...
Follow this [guide](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/ingress-setup/index.md) to choose between the modern Gateway API (recommended) or the legacy Kubernetes Ingress.
...
After installation, proceed to [Post-Installation](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/post-install/index.md) for configuration.
