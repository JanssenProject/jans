...
| Platform                  | Guide                                                                                                                                |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| Amazon EKS                | [Amazon EKS Setup](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/prerequisites/amazon-eks/index.md)                |
| Google GKE                | [Google GKE Setup](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/prerequisites/google-gke/index.md)                |
| Microsoft AKS             | [Microsoft AKS Setup](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/prerequisites/microsoft-aks/index.md)          |
| Local (Minikube/MicroK8s) | [Local Setup](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/prerequisites/local/index.md)                          |
| Rancher Marketplace       | [Rancher Setup](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/prerequisites/rancher/index.md) (includes all steps) |

## Step 2: Configure Ingress

After your cluster is ready, configure how traffic reaches Janssen:

[Ingress Setup Guide](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/ingress-setup/index.md) - Gateway API or Nginx Ingress

## Step 3: Set Up Database

Configure persistence storage:

[Database Setup Guide](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/database-setup/index.md) - PostgreSQL or MySQL

## Step 4: Install Janssen

Deploy the Helm chart:

[Install Janssen Guide](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/install-janssen/index.md)

## Step 5: Post-Installation

Verify and configure your deployment:

[Post-Installation Guide](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/post-install/index.md)
...
Releases of images are in style 2.3.0 or x.y-z-1

## Helm Chart Reference

For all configuration options, see the [Helm Chart Reference](https://docs.jans.io/v2.3.0/janssen-server/reference/kubernetes/#helm-chart-references).
