...
- Download the release package from the GitHub Janssen Project [Releases](https://github.com/JanssenProject/jans/releases/latest)
  ...
  ```
  wget https://github.com/JanssenProject/jans/releases/download/v2.3.0/jans_2.3.0-stable.debian13_amd64.deb -P /tmp
  ```
...
- Verify the cryptographic signature using cosign (primary verification):
  ...
  - Download the cosign bundle from the [Releases](https://github.com/JanssenProject/jans/releases/latest) page:
    ...
    ```
    wget https://github.com/JanssenProject/jans/releases/download/v2.3.0/jans-debian13-2.3.0-stable.bundle -P /tmp
    ```
...
- Optionally, verify integrity using the published checksum file (secondary check):
  ...
  ```
  echo 'paste-release-sha256sum jans_2.3.0-stable.debian13_amd64.deb' | sed 's/^sha256://' >jans_2.3.0-stable.debian13_amd64.deb.sha256sum && sha256sum -c jans_2.3.0-stable.debian13_amd64.deb.sha256sum
  ```
  ...
  ```
  jans_2.3.0-stable.debian13_amd64.deb: OK
  ```
...
```
sudo apt install ./jans_2.3.0-stable.debian13_amd64.deb
```
...
Removing jans (2.3.0~debian13_amd64) ...
