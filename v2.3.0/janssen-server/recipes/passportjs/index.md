...
- The [Passport Social authentication script](https://docs.jans.io/v2.3.0/script-catalog/person_authentication/passport/passport-social-jans-script.py)
...
[Diagram source file](https://docs.jans.io/v2.3.0/assets/sequence-source-passport-js-auth-flow.txt)
...
1. Janssen Auth server verifies the received JWT, decrypts data, add/update user into MySQL, and marks the user as authenticated. Check [Script](https://docs.jans.io/v2.3.0/script-catalog/person_authentication/passport/passport-social-jans-script.py) Code For details.

[Diagram source file](https://docs.jans.io/v2.3.0/assets/sequence-source-passport-js-data-flow.txt)
...
You need to use Salt File `/etc/jans/conf/salt` as a secret key. You will get this salt file after Jans intallation. Jans [interception script](https://docs.jans.io/v2.3.0/script-catalog/person_authentication/passport/passport-social-jans-script.py) uses this same file for decryption.
...
Download the script from [here](https://docs.jans.io/v2.3.0/script-catalog/person_authentication/passport/passport-social-jans-script.py) and add it to Janssen Server using `jans-cli`. After Janssen Server installation, you will get `jans-cli`.
