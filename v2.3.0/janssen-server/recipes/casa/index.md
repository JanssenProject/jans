...
1. [Enable authentication mechanisms](https://docs.jans.io/v2.3.0/script-catalog/person_authentication/person-authentication/#enabling-an-authentication-mechanism) in Jan-auth server like `otp`, `fido2`, `email_otp`.
...
At this point, users ([How to create users](https://docs.jans.io/v2.3.0/janssen-server/config-guide/scim-config/user-config/#creating-a-new-user) can log in to the Casa portal and [enable/configure one or more authentication methods](https://gluu.org/docs/casa/4.4/user-guide/) for their account.
