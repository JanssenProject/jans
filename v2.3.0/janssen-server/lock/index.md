...
1. **[Lock Server](https://docs.jans.io/v2.3.0/janssen-server/lock/lock-server/index.md)**: A Java Weld application that serves as the centralized Policy Retrieval Point (PRP)
1. **[Cedarling](https://docs.jans.io/v2.3.0/cedarling/index.md)**: An embedded Java PDP that runs the [Amazon Rust Cedar Engine](https://github.com/cedar-policy/cedar) and validates JWTs
...
- **[Standalone Deployment](https://docs.jans.io/v2.3.0/janssen-server/lock/lock-server/#standalone-deployment)**: Independent Lock Server instance
- **[Integrated Deployment](https://docs.jans.io/v2.3.0/janssen-server/lock/lock-server/#integrated-deployment)**: Embedded in Jans Auth Server
- **[High Availability Setup](https://docs.jans.io/v2.3.0/janssen-server/lock/lock-server/#high-availability-setup)**: Load-balanced multi-instance deployment

### Management Interfaces

- **[CLI Commands](https://docs.jans.io/v2.3.0/janssen-server/lock/lock-server/#cli-management)**: Command-line policy and client management
- **[TUI Interface](https://docs.jans.io/v2.3.0/janssen-server/lock/lock-server/#tui-interface)**: Text-based user interface for administration
- **[REST API](https://docs.jans.io/v2.3.0/janssen-server/lock/lock-server/#rest-api-endpoints)**: Programmatic access to Lock Server functionality
...
- **[Lock Server Configuration and Operation](https://docs.jans.io/v2.3.0/janssen-server/lock/lock-server/index.md)**: Detailed setup and management guide
- **[Cedarling Documentation](https://docs.jans.io/v2.3.0/cedarling/index.md)**: Client-side authorization engine
- **[Cedar Policy Language](https://docs.cedarpolicy.com/)**: Official Cedar documentation
- **[OAuth 2.0 Integration](https://docs.jans.io/v2.3.0/janssen-server/auth-server/oauth-features/index.md)**: OAuth implementation details
- **[Jans Auth Server](https://docs.jans.io/v2.3.0/janssen-server/index.md)**: Complete identity platform documentation
