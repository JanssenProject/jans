...
1. Create a configmap or secret depending on the if the ldif holds and secret data such as a client secret. Here, we will be creating a configmap.
...
1. Mount the created configmap or secret inside your `values.yaml`
...
1. Run helm upgrade to activate the persistence job.
