...
- **[FIDO2 Metrics API — OpenAPI/Swagger](https://gluu.org/swagger-ui/?url=https://raw.githubusercontent.com/JanssenProject/jans/v2.3.0/jans-fido2/docs/jansFido2Swagger.yaml)**
...
| `503` on `health`                | Database/persistence unreachable; check FIDO2 server logs (see [FIDO Logs](https://docs.jans.io/v2.3.0/janssen-server/fido/logs/index.md)).                                                                     |
...
- [FIDO2 Server Properties](https://docs.jans.io/v2.3.0/janssen-server/fido/fido2-server-properties-config/index.md) — reading/updating the `fido2Metrics*` properties
- [Passkeys Implementation Guide](https://docs.jans.io/v2.3.0/janssen-server/recipes/passkey-impl-guide/index.md) — deploying the passkey experience these metrics measure
- [FIDO Logs](https://docs.jans.io/v2.3.0/janssen-server/fido/logs/index.md) — server-side logging and diagnostics
