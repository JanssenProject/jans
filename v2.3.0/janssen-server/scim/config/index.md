...
| loggingLevel                  | `INFO`                                                 | The logging [level](https://docs.jans.io/v2.3.0/janssen-server/scim/logs/index.md)                                              |
...
SCIM operations support mutiple options. Please check out this [documentation](https://docs.jans.io/v2.3.0/janssen-server/config-guide/scim-config/user-config/index.md) for guidelines of scim operations.
