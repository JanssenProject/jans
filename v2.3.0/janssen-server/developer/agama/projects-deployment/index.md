...
The Agama framework defines a file [format](https://docs.jans.io/v2.3.0/agama/gama-format/index.md) to package and distribute Agama projects. Here we describe the process of deployment in the Jans Agama engine.
