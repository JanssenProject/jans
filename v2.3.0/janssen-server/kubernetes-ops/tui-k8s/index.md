...
[Using the TUI with a Janssen Kubernetes Setup - Watch Video](https://www.loom.com/share/36688669f0aa4c22be2eaf3f711fe488)
...
1. Download the `jans-cli-tui` from the [release](https://github.com/JanssenProject/jans/releases/latest) assets depending on your OS. For example:
   ...
   `wget https://github.com/JanssenProject/jans/releases/download/v2.3.0/jans-cli-tui-linux-ubuntu-X86-64.pyz`
