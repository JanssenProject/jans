...
More information about request and response of the revocation endpoint can be found in the OpenAPI specification of [jans-auth-server module](https://gluu.org/swagger-ui/?url=https://raw.githubusercontent.com/JanssenProject/jans/vreplace-janssen-version/jans-auth-server/docs/swagger.yaml#/SSA).

## Disabling The Endpoint Using Feature Flag

`/ssa` endpoint can be enabled or disable using [SSA feature flag](https://docs.jans.io/v2.3.0/janssen-server/reference/json/feature-flags/janssenauthserver-feature-flags/#ssa). Use [Janssen Text-based UI(TUI)](https://docs.jans.io/v2.3.0/janssen-server/config-guide/config-tools/jans-tui/index.md) or [Janssen command-line interface](https://docs.jans.io/v2.3.0/janssen-server/config-guide/config-tools/jans-cli/index.md) to perform this task.
