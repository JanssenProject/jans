...
- the response of Janssen Server's well-known [configuration endpoint](https://docs.jans.io/v2.3.0/janssen-server/auth-server/endpoints/configuration/index.md) given below.
...
More details in [Access Evaluation Custom Script Page](https://docs.jans.io/v2.3.0/script-catalog/access_evaluation/access-evaluation/index.md).

Full sample script can be found [here](https://docs.jans.io/v2.3.0/script-catalog/access_evaluation/AccessEvaluation.java)
