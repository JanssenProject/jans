...
We need to set the `clientAuthenticationFiltersEnabled` property to `false`, it defaults to `true`. We can use [TUI](https://docs.jans.io/v2.3.0/janssen-server/config-guide/config-tools/jans-tui/index.md) to change this configuration as shown below:
