...
Janssen Server also provides [SSA endpoint](https://docs.jans.io/v2.3.0/janssen-server/auth-server/endpoints/ssa/index.md) to create and manage SSAs on the server.

Please see SSA Creation with TUI at [Create SSA with TUI](https://docs.jans.io/v2.3.0/janssen-server/config-guide/auth-server-config/ssa-config/#ssa-screen)
