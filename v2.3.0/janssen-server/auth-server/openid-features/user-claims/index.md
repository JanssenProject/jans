...
Refer to [claims configuration document](https://docs.jans.io/v2.3.0/janssen-server/config-guide/auth-server-config/attribute-configuration/index.md) for more details on custom claims configuration.
