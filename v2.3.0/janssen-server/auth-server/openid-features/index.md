...
- Client Initiated Backchannel Authentication ([CIBA Core 1.0](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html)) — see [the CIBA feature page](https://docs.jans.io/v2.3.0/janssen-server/auth-server/openid-features/ciba/index.md)
