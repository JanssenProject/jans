...
[Get Started](https://docs.jans.io/v2.3.0/janssen-server) [View on GitHub](https://github.com/JanssenProject/jans)
...
[Learn more](https://docs.jans.io/v2.3.0/janssen-server/index.md)
...
[Explore Casa](https://docs.jans.io/v2.3.0/casa/index.md)
...
[Start with Agama](https://docs.jans.io/v2.3.0/agama/introduction/index.md)
...
[Discover Cedarling](https://docs.jans.io/v2.3.0/cedarling/index.md)
...
```
wget https://raw.githubusercontent.com/JanssenProject/jans/v2.3.0/automation/startjanssendemo.sh && chmod u+x startjanssendemo.sh && ./startjanssendemo.sh
```

[Complete Kubernetes Setup Guide](https://docs.jans.io/v2.3.0/janssen-server/install/helm-install/index.md)

**For Testing and Development Only**

```
wget https://raw.githubusercontent.com/JanssenProject/jans/v2.3.0/automation/start_janssen_aio_demo.sh && chmod u+x start_janssen_aio_demo.sh && sudo bash start_janssen_aio_demo.sh demoexample.jans.io MYSQL "" <VM_IP>
```

[Complete Docker Setup Guide](https://docs.jans.io/v2.3.0/janssen-server/install/docker-install/quick-start/index.md)
...
[Complete VM Setup Guide](https://docs.jans.io/v2.3.0/janssen-server/install/vm-install/index.md)
