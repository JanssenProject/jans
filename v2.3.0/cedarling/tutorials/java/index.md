...
Refer to the following [guide](https://docs.jans.io/v2.3.0/cedarling/developer/cedarling-kotlin/#building-from-source) for steps to build the Java binding from source.
