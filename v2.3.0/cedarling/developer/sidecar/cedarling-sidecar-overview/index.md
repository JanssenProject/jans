...
- Pull the docker image:
  ...
  ```
  docker pull ghcr.io/janssenproject/jans/cedarling-flask-sidecar:2.3.0-1
  ```
...
- Run the docker image, replacing `</absolute/path/to/bootstrap.json>` with the absolute path to your bootstrap file:
  ...
  docker run -d \
    ...
    -p 5000:5000\
    ghcr.io/janssenproject/jans/cedarling-flask-sidecar:2.3.0-1
  ```
