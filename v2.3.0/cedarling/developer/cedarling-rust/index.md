...
To build an executable library for Cedarling, follow the instructions [here](https://docs.jans.io/v2.3.0/cedarling/tutorials/rust/#building-from-source).
...
Cedarling can be configured using bootstrap properties. See the [bootstrap properties documentation](https://docs.jans.io/v2.3.0/cedarling/reference/cedarling-properties/index.md) for complete configuration options.
...
- [Getting Started with Cedarling Rust](https://docs.jans.io/v2.3.0/cedarling/tutorials/rust/index.md)
...
- [Cedarling Properties](https://docs.jans.io/v2.3.0/cedarling/reference/cedarling-properties/index.md)
