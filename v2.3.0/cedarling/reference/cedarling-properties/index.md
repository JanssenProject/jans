...
Not sure which authorization method to use? See the [decision guide](https://docs.jans.io/v2.3.0/cedarling/reference/cedarling-authz/#which-authorization-method-should-i-use).
...
- **`CEDARLING_LOG_LEVEL`** : System Log Level [See here](https://docs.jans.io/v2.3.0/cedarling/reference/cedarling-logs/index.md). Default to `WARN`
