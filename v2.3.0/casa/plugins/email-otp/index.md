...
1. Download the plugin [jar](https://github.com/JanssenProject/jans/releases/download/v2.3.0/email_2fa-2.3.0-jar-with-dependencies.jar) file
...
1. Download the project [archive](https://github.com/JanssenProject/jans/releases/download/v2.3.0/email_2fa-agama-2.3.0-project.zip)
