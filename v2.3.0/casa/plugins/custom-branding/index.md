...
1. [Download the plugin](https://github.com/JanssenProject/jans/releases/download/v2.3.0/custom-branding-2.3.0-jar-with-dependencies.jar)
...
See the [custom branding page](https://docs.jans.io/v2.3.0/casa/administration/custom-branding/index.md) for full instructions.
