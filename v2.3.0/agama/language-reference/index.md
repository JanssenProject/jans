...
- If no `Finish` statement is found in a flow's execution, this will degenerate in flow [crash](https://docs.jans.io/v2.3.0/agama/execution-rules/#crashed-flows)
...
- Learn more about flows lifecycle [here](https://docs.jans.io/v2.3.0/agama/execution-rules/#flows-lifecycle)
...
- Where and how to store templates is an engine-specific detail as well as the file formats supported. See [Assets management](https://docs.jans.io/v2.3.0/agama/execution-rules/#assets-management).
