...
| `description`    |                                                                                                                                                                                                                                                   | *string*      |
| `configs`        | Object containing exemplifying [configuration properties](https://docs.jans.io/v2.3.0/agama/language-reference/#header-basics) for flows that may need them. The keys of this field, if any, are qualified flow names already part of the project | *json object* |
